...
func NewGetAvailableExtensionPropertiesRequestBuilderInternal(
	...
	m.urlTemplate = "{+baseurl}/groups/getAvailableExtensionProperties"
...
func (m *GetAvailableExtensionPropertiesRequestBuilder) Post(
	ctx context.Context,
	body GetAvailableExtensionPropertiesPostRequestBodyable,
	requestConfiguration *GetAvailableExtensionPropertiesRequestBuilderPostRequestConfiguration,
) (GetAvailableExtensionPropertiesResponseable, error) {
	...
	res, err := m.requestAdapter.Send(
		ctx,
		requestInfo,
		CreateGetAvailableExtensionPropertiesResponseFromDiscriminatorValue,
		errorMapping,
	)
	if err != nil {
		return nil, err
...
func (m *GetAvailableExtensionPropertiesRequestBuilder) ToPostRequestInformation(
	ctx context.Context,
	body GetAvailableExtensionPropertiesPostRequestBodyable,
	requestConfiguration *GetAvailableExtensionPropertiesRequestBuilderPostRequestConfiguration,

...
// NewItemCalendarCalendarViewItemForwardRequestBuilderInternal instantiates a new ForwardRequestBuilder and sets the default values.
func NewItemCalendarCalendarViewItemForwardRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarCalendarViewItemForwardRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/forward";
...
// NewItemCalendarCalendarViewItemForwardRequestBuilder instantiates a new ForwardRequestBuilder and sets the default values.

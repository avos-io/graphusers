...
func NewItemCalendarEventsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarEventsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/calendar/events{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
...
func (m *ItemCalendarEventsRequestBuilder) Count()(*ItemCalendarEventsCountRequestBuilder) {
    return NewItemCalendarEventsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Delta provides operations to call the delta method.
func (m *ItemCalendarEventsRequestBuilder) Delta()(*ItemCalendarEventsDeltaRequestBuilder) {
    return NewItemCalendarEventsDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemCalendarEventsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCalendarEventsRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.EventCollectionResponseable, error) {
...
func (m *ItemCalendarEventsRequestBuilder) Post(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Eventable, requestConfiguration *ItemCalendarEventsRequestBuilderPostRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Eventable, error) {

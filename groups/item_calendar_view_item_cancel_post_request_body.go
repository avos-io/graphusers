...
// ItemCalendarViewItemCancelPostRequestBody 
type ItemCalendarViewItemCancelPostRequestBody struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]any
    // The Comment property
    comment *string
}
// NewItemCalendarViewItemCancelPostRequestBody instantiates a new ItemCalendarViewItemCancelPostRequestBody and sets the default values.
func NewItemCalendarViewItemCancelPostRequestBody()(*ItemCalendarViewItemCancelPostRequestBody) {
    m := &ItemCalendarViewItemCancelPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarViewItemCancelPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
type ItemCalendarViewItemCancelPostRequestBodyable interface {

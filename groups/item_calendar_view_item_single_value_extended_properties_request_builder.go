...
func NewItemCalendarViewItemSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarViewItemSingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ItemCalendarViewItemSingleValueExtendedPropertiesRequestBuilder) Count()(*ItemCalendarViewItemSingleValueExtendedPropertiesCountRequestBuilder) {
    return NewItemCalendarViewItemSingleValueExtendedPropertiesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get the collection of single-value extended properties defined for the event. Read-only. Nullable.
func (m *ItemCalendarViewItemSingleValueExtendedPropertiesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCalendarViewItemSingleValueExtendedPropertiesRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.SingleValueLegacyExtendedPropertyCollectionResponseable, error) {

...
// ItemExtensionsExtensionItemRequestBuilder provides operations to manage the extensions property of the microsoft.graph.group entity.
...
// ItemExtensionsExtensionItemRequestBuilderGetQueryParameters the collection of open extensions defined for the group. Read-only. Nullable.
...
func NewItemExtensionsExtensionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemExtensionsExtensionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/extensions/{extension%2Did}{?%24select,%24expand}";

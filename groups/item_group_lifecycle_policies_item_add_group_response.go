...
// ItemGroupLifecyclePoliciesItemAddGroupResponse 
...
func (m *ItemGroupLifecyclePoliciesItemAddGroupResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ItemGroupLifecyclePoliciesItemAddGroupResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemGroupLifecyclePoliciesItemAddGroupResponse) GetValue()(*bool) {
    return m.value
}
// Serialize serializes information the current object
func (m *ItemGroupLifecyclePoliciesItemAddGroupResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemGroupLifecyclePoliciesItemAddGroupResponse) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetValue sets the value property value. The value property
func (m *ItemGroupLifecyclePoliciesItemAddGroupResponse) SetValue(value *bool)() {
    m.value = value
}
// ItemGroupLifecyclePoliciesItemAddGroupResponseable 

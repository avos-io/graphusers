...
func (m *ItemGroupLifecyclePoliciesItemRemoveGroupResponse) GetAdditionalData()(map[string]any) {
...
func (m *ItemGroupLifecyclePoliciesItemRemoveGroupResponse) SetAdditionalData(value map[string]any)() {

...
func NewItemMembersItemGraphApplicationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersItemGraphApplicationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/members/{directoryObject%2Did}/graph.application{?%24select,%24expand}";
...
func (m *ItemMembersItemGraphApplicationRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMembersItemGraphApplicationRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Applicationable, error) {

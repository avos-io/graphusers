...
// NewItemMembersWithLicenseErrorsGraphGroupCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemMembersWithLicenseErrorsGraphGroupCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersWithLicenseErrorsGraphGroupCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/graph.group/$count{?%24search,%24filter}";
...
// NewItemMembersWithLicenseErrorsGraphGroupCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.

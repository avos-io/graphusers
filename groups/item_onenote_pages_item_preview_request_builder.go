...
// NewItemOnenotePagesItemPreviewRequestBuilderInternal instantiates a new PreviewRequestBuilder and sets the default values.
func NewItemOnenotePagesItemPreviewRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnenotePagesItemPreviewRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/onenote/pages/{onenotePage%2Did}/preview()";
...
// NewItemOnenotePagesItemPreviewRequestBuilder instantiates a new PreviewRequestBuilder and sets the default values.
...
func (m *ItemOnenotePagesItemPreviewRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOnenotePagesItemPreviewRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.OnenotePagePreviewable, error) {

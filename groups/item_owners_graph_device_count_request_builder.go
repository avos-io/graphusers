...
// NewItemOwnersGraphDeviceCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemOwnersGraphDeviceCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersGraphDeviceCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/owners/graph.device/$count{?%24search,%24filter}";
...
// NewItemOwnersGraphDeviceCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.

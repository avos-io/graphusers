...
// ItemOwnersItemRefRequestBuilderDeleteQueryParameters delete ref of navigation property owners for groups
...
func NewItemOwnersItemRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersItemRefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/$ref{?%40id*}";
...
// Delete delete ref of navigation property owners for groups
...
// ToDeleteRequestInformation delete ref of navigation property owners for groups

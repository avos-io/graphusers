...
// ItemPlannerPlansRequestBuilder provides operations to manage the plans property of the microsoft.graph.plannerGroup entity.
...
// ItemPlannerPlansRequestBuilderGetQueryParameters retrieve a list of **plannerPlan** objects owned by a group object.
...
func (m *ItemPlannerPlansRequestBuilder) Count()(*ItemPlannerPlansCountRequestBuilder) {
    return NewItemPlannerPlansCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get retrieve a list of **plannerPlan** objects owned by a group object.
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/plannergroup-list-plans?view=graph-rest-1.0
func (m *ItemPlannerPlansRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemPlannerPlansRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.PlannerPlanCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.CreatePlannerPlanCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.PlannerPlanCollectionResponseable), nil
}
// Post create new navigation property to plans for groups
func (m *ItemPlannerPlansRequestBuilder) Post(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.PlannerPlanable, requestConfiguration *ItemPlannerPlansRequestBuilderPostRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.PlannerPlanable, error) {
...
// ToGetRequestInformation retrieve a list of **plannerPlan** objects owned by a group object.

...
// ItemSitesItemItemsCountRequestBuilder provides operations to count the resources in the collection.
type ItemSitesItemItemsCountRequestBuilder struct {
...
// ItemSitesItemItemsCountRequestBuilderGetQueryParameters get the number of the resource
type ItemSitesItemItemsCountRequestBuilderGetQueryParameters struct {
    // Filter items by property values
    Filter *string `uriparametername:"%24filter"`
    // Search items by search phrases
    Search *string `uriparametername:"%24search"`
}
// ItemSitesItemItemsCountRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemSitesItemItemsCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
func NewItemSitesItemItemsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemItemsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/items/$count{?%24search,%24filter}";

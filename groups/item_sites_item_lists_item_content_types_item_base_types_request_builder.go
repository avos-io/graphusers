...
func NewItemSitesItemListsItemContentTypesItemBaseTypesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemListsItemContentTypesItemBaseTypesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/baseTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemSitesItemListsItemContentTypesItemBaseTypesRequestBuilder instantiates a new BaseTypesRequestBuilder and sets the default values.
...
func (m *ItemSitesItemListsItemContentTypesItemBaseTypesRequestBuilder) Count()(*ItemSitesItemListsItemContentTypesItemBaseTypesCountRequestBuilder) {
    return NewItemSitesItemListsItemContentTypesItemBaseTypesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}

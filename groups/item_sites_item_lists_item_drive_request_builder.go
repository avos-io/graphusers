...
// NewItemSitesItemListsItemDriveRequestBuilderInternal instantiates a new DriveRequestBuilder and sets the default values.
func NewItemSitesItemListsItemDriveRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemListsItemDriveRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/drive{?%24select,%24expand}";
...
// NewItemSitesItemListsItemDriveRequestBuilder instantiates a new DriveRequestBuilder and sets the default values.
...
func (m *ItemSitesItemListsItemDriveRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemListsItemDriveRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Driveable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.CreateDriveFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Driveable), nil
}

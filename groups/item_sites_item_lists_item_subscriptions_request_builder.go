...
// NewItemSitesItemListsItemSubscriptionsRequestBuilderInternal instantiates a new SubscriptionsRequestBuilder and sets the default values.
func NewItemSitesItemListsItemSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemListsItemSubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemSitesItemListsItemSubscriptionsRequestBuilder instantiates a new SubscriptionsRequestBuilder and sets the default values.
...
func (m *ItemSitesItemListsItemSubscriptionsRequestBuilder) Count()(*ItemSitesItemListsItemSubscriptionsCountRequestBuilder) {
    return NewItemSitesItemListsItemSubscriptionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get the set of subscriptions on the list.
func (m *ItemSitesItemListsItemSubscriptionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemListsItemSubscriptionsRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.SubscriptionCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.CreateSubscriptionCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.SubscriptionCollectionResponseable), nil
}
// Post create new navigation property to subscriptions for groups
func (m *ItemSitesItemListsItemSubscriptionsRequestBuilder) Post(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Subscriptionable, requestConfiguration *ItemSitesItemListsItemSubscriptionsRequestBuilderPostRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Subscriptionable, error) {

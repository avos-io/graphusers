...
// ItemSitesItemOperationsRequestBuilderGetQueryParameters get a list of rich long-running operations associated with a site.
...
// NewItemSitesItemOperationsRequestBuilderInternal instantiates a new OperationsRequestBuilder and sets the default values.
func NewItemSitesItemOperationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemOperationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemSitesItemOperationsRequestBuilder instantiates a new OperationsRequestBuilder and sets the default values.
...
func (m *ItemSitesItemOperationsRequestBuilder) Count()(*ItemSitesItemOperationsCountRequestBuilder) {
    return NewItemSitesItemOperationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get get a list of rich long-running operations associated with a site.
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/site-list-operations?view=graph-rest-1.0
func (m *ItemSitesItemOperationsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemOperationsRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.RichLongRunningOperationCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.CreateRichLongRunningOperationCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.RichLongRunningOperationCollectionResponseable), nil
}
// Post create new navigation property to operations for groups
func (m *ItemSitesItemOperationsRequestBuilder) Post(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.RichLongRunningOperationable, requestConfiguration *ItemSitesItemOperationsRequestBuilderPostRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.RichLongRunningOperationable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.CreateRichLongRunningOperationFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.RichLongRunningOperationable), nil
}

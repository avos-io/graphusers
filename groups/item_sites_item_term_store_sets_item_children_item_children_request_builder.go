...
func NewItemSitesItemTermStoreSetsItemChildrenItemChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemTermStoreSetsItemChildrenItemChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ItemSitesItemTermStoreSetsItemChildrenItemChildrenRequestBuilder) Count()(*ItemSitesItemTermStoreSetsItemChildrenItemChildrenCountRequestBuilder) {
    return NewItemSitesItemTermStoreSetsItemChildrenItemChildrenCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get children of current term.
func (m *ItemSitesItemTermStoreSetsItemChildrenItemChildrenRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemTermStoreSetsItemChildrenItemChildrenRequestBuilderGetRequestConfiguration)(i1c6ae1291e6b78186b51838b365482c969557ded4a1e546b08b36a68fcb4c237.TermCollectionResponseable, error) {
...
func (m *ItemSitesItemTermStoreSetsItemChildrenItemChildrenRequestBuilder) Post(ctx context.Context, body i1c6ae1291e6b78186b51838b365482c969557ded4a1e546b08b36a68fcb4c237.Termable, requestConfiguration *ItemSitesItemTermStoreSetsItemChildrenItemChildrenRequestBuilderPostRequestConfiguration)(i1c6ae1291e6b78186b51838b365482c969557ded4a1e546b08b36a68fcb4c237.Termable, error) {
...
func (m *ItemSitesItemTermStoreSetsItemChildrenItemChildrenRequestBuilder) ToPostRequestInformation(ctx context.Context, body i1c6ae1291e6b78186b51838b365482c969557ded4a1e546b08b36a68fcb4c237.Termable, requestConfiguration *ItemSitesItemTermStoreSetsItemChildrenItemChildrenRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters

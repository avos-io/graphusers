...
// ItemSitesItemTermStoreSetsItemParentGroupSetsRequestBuilderGetQueryParameters get a list of the set objects and their properties.
...
// NewItemSitesItemTermStoreSetsItemParentGroupSetsRequestBuilderInternal instantiates a new SetsRequestBuilder and sets the default values.
func NewItemSitesItemTermStoreSetsItemParentGroupSetsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemTermStoreSetsItemParentGroupSetsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemSitesItemTermStoreSetsItemParentGroupSetsRequestBuilder instantiates a new SetsRequestBuilder and sets the default values.
...
func (m *ItemSitesItemTermStoreSetsItemParentGroupSetsRequestBuilder) Count()(*ItemSitesItemTermStoreSetsItemParentGroupSetsCountRequestBuilder) {
    return NewItemSitesItemTermStoreSetsItemParentGroupSetsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemSitesItemTermStoreSetsItemParentGroupSetsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemTermStoreSetsItemParentGroupSetsRequestBuilderGetRequestConfiguration)(i1c6ae1291e6b78186b51838b365482c969557ded4a1e546b08b36a68fcb4c237.SetCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, i1c6ae1291e6b78186b51838b365482c969557ded4a1e546b08b36a68fcb4c237.CreateSetCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i1c6ae1291e6b78186b51838b365482c969557ded4a1e546b08b36a68fcb4c237.SetCollectionResponseable), nil
}

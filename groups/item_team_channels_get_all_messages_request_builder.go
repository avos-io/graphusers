...
// ItemTeamChannelsGetAllMessagesRequestBuilderGetQueryParameters invoke function getAllMessages
...
// NewItemTeamChannelsGetAllMessagesRequestBuilderInternal instantiates a new GetAllMessagesRequestBuilder and sets the default values.
func NewItemTeamChannelsGetAllMessagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamChannelsGetAllMessagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/team/channels/getAllMessages(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
...
// NewItemTeamChannelsGetAllMessagesRequestBuilder instantiates a new GetAllMessagesRequestBuilder and sets the default values.
...
func (m *ItemTeamChannelsGetAllMessagesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamChannelsGetAllMessagesRequestBuilderGetRequestConfiguration)(ItemTeamChannelsGetAllMessagesResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateItemTeamChannelsGetAllMessagesResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {

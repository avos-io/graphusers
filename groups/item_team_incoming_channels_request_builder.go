...
// ItemTeamIncomingChannelsRequestBuilderGetQueryParameters get the list of incoming channels (channels shared with a team).
...
// NewItemTeamIncomingChannelsRequestBuilderInternal instantiates a new IncomingChannelsRequestBuilder and sets the default values.
func NewItemTeamIncomingChannelsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamIncomingChannelsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/team/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemTeamIncomingChannelsRequestBuilder instantiates a new IncomingChannelsRequestBuilder and sets the default values.
...
func (m *ItemTeamIncomingChannelsRequestBuilder) Count()(*ItemTeamIncomingChannelsCountRequestBuilder) {
    return NewItemTeamIncomingChannelsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemTeamIncomingChannelsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamIncomingChannelsRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ChannelCollectionResponseable, error) {

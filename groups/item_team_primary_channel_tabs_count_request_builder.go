...
// NewItemTeamPrimaryChannelTabsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemTeamPrimaryChannelTabsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamPrimaryChannelTabsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/tabs/$count{?%24search,%24filter}";
...
// NewItemTeamPrimaryChannelTabsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.

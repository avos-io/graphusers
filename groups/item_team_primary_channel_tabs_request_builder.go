...
// NewItemTeamPrimaryChannelTabsRequestBuilderInternal instantiates a new TabsRequestBuilder and sets the default values.
func NewItemTeamPrimaryChannelTabsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamPrimaryChannelTabsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/tabs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemTeamPrimaryChannelTabsRequestBuilder instantiates a new TabsRequestBuilder and sets the default values.
...
func (m *ItemTeamPrimaryChannelTabsRequestBuilder) Count()(*ItemTeamPrimaryChannelTabsCountRequestBuilder) {
    return NewItemTeamPrimaryChannelTabsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemTeamPrimaryChannelTabsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamPrimaryChannelTabsRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TeamsTabCollectionResponseable, error) {
...
func (m *ItemTeamPrimaryChannelTabsRequestBuilder) Post(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TeamsTabable, requestConfiguration *ItemTeamPrimaryChannelTabsRequestBuilderPostRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TeamsTabable, error) {
...
func (m *ItemTeamPrimaryChannelTabsRequestBuilder) ToPostRequestInformation(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TeamsTabable, requestConfiguration *ItemTeamPrimaryChannelTabsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters

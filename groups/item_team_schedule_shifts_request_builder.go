...
// ItemTeamScheduleShiftsRequestBuilderGetQueryParameters get the list of shift instances in a schedule.
...
// NewItemTeamScheduleShiftsRequestBuilder instantiates a new ShiftsRequestBuilder and sets the default values.
...
func (m *ItemTeamScheduleShiftsRequestBuilder) Count()(*ItemTeamScheduleShiftsCountRequestBuilder) {
    return NewItemTeamScheduleShiftsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemTeamScheduleShiftsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamScheduleShiftsRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ShiftCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.CreateShiftCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ShiftCollectionResponseable), nil
}

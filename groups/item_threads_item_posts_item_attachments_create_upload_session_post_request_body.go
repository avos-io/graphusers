...
// ItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBody 
type ItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBody struct {
...
// NewItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBody instantiates a new ItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBody and sets the default values.
func NewItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBody()(*ItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBody) {
    m := &ItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBody) GetAttachmentItem()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.AttachmentItemable) {
...
func (m *ItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBody) SetAttachmentItem(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.AttachmentItemable)() {
    m.attachmentItem = value
}
// ItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBodyable 
type ItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBodyable interface {

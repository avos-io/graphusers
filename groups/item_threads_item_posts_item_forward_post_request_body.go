...
// ItemThreadsItemPostsItemForwardPostRequestBody 
type ItemThreadsItemPostsItemForwardPostRequestBody struct {
...
// NewItemThreadsItemPostsItemForwardPostRequestBody instantiates a new ItemThreadsItemPostsItemForwardPostRequestBody and sets the default values.
func NewItemThreadsItemPostsItemForwardPostRequestBody()(*ItemThreadsItemPostsItemForwardPostRequestBody) {
    m := &ItemThreadsItemPostsItemForwardPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemThreadsItemPostsItemForwardPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemThreadsItemPostsItemForwardPostRequestBody) GetToRecipients()([]i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Recipientable) {
...
func (m *ItemThreadsItemPostsItemForwardPostRequestBody) SetToRecipients(value []i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Recipientable)() {
    m.toRecipients = value
}
// ItemThreadsItemPostsItemForwardPostRequestBodyable 
type ItemThreadsItemPostsItemForwardPostRequestBodyable interface {

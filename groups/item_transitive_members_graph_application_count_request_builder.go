...
// ItemTransitiveMembersGraphApplicationCountRequestBuilder provides operations to count the resources in the collection.
type ItemTransitiveMembersGraphApplicationCountRequestBuilder struct {
...
// ItemTransitiveMembersGraphApplicationCountRequestBuilderGetQueryParameters get the number of the resource
type ItemTransitiveMembersGraphApplicationCountRequestBuilderGetQueryParameters struct {
    // Filter items by property values
    Filter *string `uriparametername:"%24filter"`
    // Search items by search phrases
    Search *string `uriparametername:"%24search"`
}
// ItemTransitiveMembersGraphApplicationCountRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemTransitiveMembersGraphApplicationCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
func NewItemTransitiveMembersGraphApplicationCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTransitiveMembersGraphApplicationCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers/graph.application/$count{?%24search,%24filter}";

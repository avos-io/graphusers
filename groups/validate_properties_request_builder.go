...
func NewValidatePropertiesRequestBuilderInternal(
	...
	m.urlTemplate = "{+baseurl}/groups/validateProperties"
...
func (m *ValidatePropertiesRequestBuilder) Post(
	ctx context.Context,
	body ValidatePropertiesPostRequestBodyable,
	requestConfiguration *ValidatePropertiesRequestBuilderPostRequestConfiguration,
) error {
...
func (m *ValidatePropertiesRequestBuilder) ToPostRequestInformation(
	ctx context.Context,
	body ValidatePropertiesPostRequestBodyable,
	requestConfiguration *ValidatePropertiesRequestBuilderPostRequestConfiguration,

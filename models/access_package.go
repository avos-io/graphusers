...
func CreateAccessPackageFromDiscriminatorValue(
...
func (m *AccessPackage) Serialize(
	...
	if m.GetAccessPackagesIncompatibleWith() != nil {
		cast := make(
			...
			len(m.GetAccessPackagesIncompatibleWith()),
		)
	...
	if m.GetIncompatibleAccessPackages() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetIncompatibleAccessPackages()),
		)
...
func (m *AccessPackage) SetCreatedDateTime(
...
func (m *AccessPackage) SetModifiedDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

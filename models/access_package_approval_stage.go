...
func CreateAccessPackageApprovalStageFromDiscriminatorValue(
...
func (m *AccessPackageApprovalStage) Serialize(
	...
	if m.GetFallbackEscalationApprovers() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetFallbackEscalationApprovers()),
		)
	...
	if m.GetFallbackPrimaryApprovers() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetFallbackPrimaryApprovers()),
		)
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetIsApproverJustificationRequired(),
		)
		if err != nil {
			return err
		}
...
func (m *AccessPackageApprovalStage) SetDurationBeforeAutomaticDenial(
...
func (m *AccessPackageApprovalStage) SetDurationBeforeEscalation(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {

...
func CreateAccessPackageApprovalStageCollectionResponseFromDiscriminatorValue(
...
func (m *AccessPackageApprovalStageCollectionResponse) Serialize(
...
func (m *AccessPackageApprovalStageCollectionResponse) SetValue(
	value []AccessPackageApprovalStageable,
) {
	m.value = value
}

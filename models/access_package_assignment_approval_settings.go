...
func CreateAccessPackageAssignmentApprovalSettingsFromDiscriminatorValue(
...
func (m *AccessPackageAssignmentApprovalSettings) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["stages"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateAccessPackageApprovalStageFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *AccessPackageAssignmentApprovalSettings) Serialize(
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetIsApprovalRequiredForUpdate(),
		)
		if err != nil {
			return err
		}
...
func (m *AccessPackageAssignmentApprovalSettings) SetStages(

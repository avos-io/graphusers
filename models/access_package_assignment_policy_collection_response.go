...
func CreateAccessPackageAssignmentPolicyCollectionResponseFromDiscriminatorValue(
...
func (m *AccessPackageAssignmentPolicyCollectionResponse) Serialize(
...
func (m *AccessPackageAssignmentPolicyCollectionResponse) SetValue(
	value []AccessPackageAssignmentPolicyable,
) {
	m.value = value
}

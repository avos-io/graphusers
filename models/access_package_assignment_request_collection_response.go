...
func CreateAccessPackageAssignmentRequestCollectionResponseFromDiscriminatorValue(
...
func (m *AccessPackageAssignmentRequestCollectionResponse) Serialize(
...
func (m *AccessPackageAssignmentRequestCollectionResponse) SetValue(
	value []AccessPackageAssignmentRequestable,
) {
	m.value = value
}

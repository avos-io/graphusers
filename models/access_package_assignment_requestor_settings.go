...
func CreateAccessPackageAssignmentRequestorSettingsFromDiscriminatorValue(
...
func (m *AccessPackageAssignmentRequestorSettings) Serialize(
	writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter,
) error {
	{
		err := writer.WriteBoolValue(
			"allowCustomAssignmentSchedule",
			m.GetAllowCustomAssignmentSchedule(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetEnableOnBehalfRequestorsToAddAccess(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetEnableOnBehalfRequestorsToRemoveAccess(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetEnableOnBehalfRequestorsToUpdateAccess(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetEnableTargetsToSelfAddAccess(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetEnableTargetsToSelfRemoveAccess(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetEnableTargetsToSelfUpdateAccess(),
		)
		if err != nil {
			return err
		}
...
func (m *AccessPackageAssignmentRequestorSettings) SetEnableOnBehalfRequestorsToAddAccess(
	value *bool,
) {
...
func (m *AccessPackageAssignmentRequestorSettings) SetEnableOnBehalfRequestorsToRemoveAccess(
	value *bool,
) {
...
func (m *AccessPackageAssignmentRequestorSettings) SetEnableOnBehalfRequestorsToUpdateAccess(
	value *bool,
) {

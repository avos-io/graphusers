...
func CreateAccessPackageAssignmentReviewSettingsFromDiscriminatorValue(
...
func (m *AccessPackageAssignmentReviewSettings) Serialize(
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetIsReviewerJustificationRequired(),
		)
		if err != nil {
			return err
		}
...
func (m *AccessPackageAssignmentReviewSettings) SetExpirationBehavior(
	value *AccessReviewExpirationBehavior,
) {
...
func (m *AccessPackageAssignmentReviewSettings) SetSchedule(
	value EntitlementManagementScheduleable,
) {
	m.schedule = value
}

...
func CreateAccessPackageAutomaticRequestSettingsFromDiscriminatorValue(
...
func (m *AccessPackageAutomaticRequestSettings) Serialize(
	writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter,
) error {
	{
		err := writer.WriteISODurationValue(
			"gracePeriodBeforeAccessRemoval",
			m.GetGracePeriodBeforeAccessRemoval(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetRemoveAccessWhenTargetLeavesAllowedTargets(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetRequestAccessForAllowedTargets(),
		)
		if err != nil {
			return err
		}
...
func (m *AccessPackageAutomaticRequestSettings) SetGracePeriodBeforeAccessRemoval(
...
func (m *AccessPackageAutomaticRequestSettings) SetRemoveAccessWhenTargetLeavesAllowedTargets(
	value *bool,
) {
...
// AccessPackageAutomaticRequestSettingsable

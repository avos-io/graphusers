...
func CreateAccessReviewHistoryDefinitionFromDiscriminatorValue(
...
func (m *AccessReviewHistoryDefinition) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["scheduleSettings"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateAccessReviewHistoryScheduleSettingsFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *AccessReviewHistoryDefinition) Serialize(
	...
	if m.GetDecisions() != nil {
		err = writer.WriteCollectionOfStringValues(
			"decisions",
			SerializeAccessReviewHistoryDecisionFilter(m.GetDecisions()),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetReviewHistoryPeriodEndDateTime(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetReviewHistoryPeriodStartDateTime(),
		)
		if err != nil {
			return err
		}
...
func (m *AccessReviewHistoryDefinition) SetCreatedDateTime(
...
func (m *AccessReviewHistoryDefinition) SetReviewHistoryPeriodEndDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {
...
func (m *AccessReviewHistoryDefinition) SetReviewHistoryPeriodStartDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {
...
func (m *AccessReviewHistoryDefinition) SetScheduleSettings(

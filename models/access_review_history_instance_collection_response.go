...
func CreateAccessReviewHistoryInstanceCollectionResponseFromDiscriminatorValue(
...
func (m *AccessReviewHistoryInstanceCollectionResponse) Serialize(
...
func (m *AccessReviewHistoryInstanceCollectionResponse) SetValue(
	value []AccessReviewHistoryInstanceable,
) {
	m.value = value
}

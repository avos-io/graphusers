...
func CreateAccessReviewHistoryScheduleSettingsFromDiscriminatorValue(
...
func (m *AccessReviewHistoryScheduleSettings) Serialize(
...
// AccessReviewHistoryScheduleSettingsable

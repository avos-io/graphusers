...
func CreateAccessReviewInactiveUsersQueryScopeFromDiscriminatorValue(
...
func (m *AccessReviewInactiveUsersQueryScope) Serialize(
...
func (m *AccessReviewInactiveUsersQueryScope) SetInactiveDuration(

...
func CreateAccessReviewInstanceDecisionItemAzureRoleResourceFromDiscriminatorValue(
...
func (m *AccessReviewInstanceDecisionItemAzureRoleResource) Serialize(
...
func (m *AccessReviewInstanceDecisionItemAzureRoleResource) SetScope(

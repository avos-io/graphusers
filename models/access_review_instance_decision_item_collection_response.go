...
func CreateAccessReviewInstanceDecisionItemCollectionResponseFromDiscriminatorValue(
...
func (m *AccessReviewInstanceDecisionItemCollectionResponse) Serialize(
...
func (m *AccessReviewInstanceDecisionItemCollectionResponse) SetValue(
	value []AccessReviewInstanceDecisionItemable,
) {
	m.value = value
}

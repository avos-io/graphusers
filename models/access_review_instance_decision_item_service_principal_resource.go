...
func CreateAccessReviewInstanceDecisionItemServicePrincipalResourceFromDiscriminatorValue(
...
func (m *AccessReviewInstanceDecisionItemServicePrincipalResource) Serialize(

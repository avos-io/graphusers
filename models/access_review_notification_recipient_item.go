...
func CreateAccessReviewNotificationRecipientItemFromDiscriminatorValue(
...
func (m *AccessReviewNotificationRecipientItem) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["notificationRecipientScope"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateAccessReviewNotificationRecipientScopeFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *AccessReviewNotificationRecipientItem) Serialize(
	writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter,
) error {
	{
		err := writer.WriteObjectValue(
			"notificationRecipientScope",
			m.GetNotificationRecipientScope(),
		)
		if err != nil {
			return err
		}
...
func (m *AccessReviewNotificationRecipientItem) SetNotificationRecipientScope(
	value AccessReviewNotificationRecipientScopeable,
) {

...
func CreateAccessReviewScheduleDefinitionFromDiscriminatorValue(
...
func (m *AccessReviewScheduleDefinition) Serialize(
	...
	if m.GetAdditionalNotificationRecipients() != nil {
		cast := make(
			...
			len(m.GetAdditionalNotificationRecipients()),
		)
...
func (m *AccessReviewScheduleDefinition) SetAdditionalNotificationRecipients(
...
func (m *AccessReviewScheduleDefinition) SetCreatedDateTime(
...
func (m *AccessReviewScheduleDefinition) SetFallbackReviewers(
...
func (m *AccessReviewScheduleDefinition) SetLastModifiedDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

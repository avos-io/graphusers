...
func CreateAccessReviewScheduleDefinitionCollectionResponseFromDiscriminatorValue(
...
func (m *AccessReviewScheduleDefinitionCollectionResponse) Serialize(
...
func (m *AccessReviewScheduleDefinitionCollectionResponse) SetValue(
	value []AccessReviewScheduleDefinitionable,
) {
	m.value = value
}
...
type AccessReviewScheduleDefinitionCollectionResponseable interface {
	...
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []AccessReviewScheduleDefinitionable
	SetValue(value []AccessReviewScheduleDefinitionable)
}

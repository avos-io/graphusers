...
func CreateAccessReviewScheduleSettingsFromDiscriminatorValue(
...
func (m *AccessReviewScheduleSettings) Serialize(
	writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter,
) error {
	if m.GetApplyActions() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetApplyActions()),
		)
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetDecisionHistoriesForReviewersEnabled(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetJustificationRequiredOnApproval(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetReminderNotificationsEnabled(),
		)
		if err != nil {
			return err
		}

...
func CreateActivityBasedTimeoutPolicyCollectionResponseFromDiscriminatorValue(
...
func (m *ActivityBasedTimeoutPolicyCollectionResponse) Serialize(
...
func (m *ActivityBasedTimeoutPolicyCollectionResponse) SetValue(
	value []ActivityBasedTimeoutPolicyable,
) {
	m.value = value
}

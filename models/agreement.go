...
func CreateAgreementFromDiscriminatorValue(
...
func (m *Agreement) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["files"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateAgreementFileLocalizationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *Agreement) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetIsPerDeviceAcceptanceRequired(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteISODurationValue(
			...
			m.GetUserReacceptRequiredFrequency(),
		)
		if err != nil {
			return err
		}
...
func (m *Agreement) SetUserReacceptRequiredFrequency(

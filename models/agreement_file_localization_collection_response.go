...
func CreateAgreementFileLocalizationCollectionResponseFromDiscriminatorValue(
...
func (m *AgreementFileLocalizationCollectionResponse) Serialize(
...
func (m *AgreementFileLocalizationCollectionResponse) SetValue(
	value []AgreementFileLocalizationable,
) {
	m.value = value
}

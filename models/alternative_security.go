...
func (m *AlternativeSecurity) GetAdditionalData()(map[string]any) {
...
func (m *AlternativeSecurity) SetAdditionalData(value map[string]any)() {
...
// AlternativeSecurityable 
type AlternativeSecurityable interface {

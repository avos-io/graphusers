...
func CreateAndroidCompliancePolicyFromDiscriminatorValue(
...
func (m *AndroidCompliancePolicy) Serialize(
...
func (m *AndroidCompliancePolicy) SetDeviceThreatProtectionRequiredSecurityLevel(
...
func (m *AndroidCompliancePolicy) SetSecurityRequireSafetyNetAttestationBasicIntegrity(
	value *bool,
) {

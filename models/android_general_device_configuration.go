...
func CreateAndroidGeneralDeviceConfigurationFromDiscriminatorValue(
...
func (m *AndroidGeneralDeviceConfiguration) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetStorageRequireRemovableStorageEncryption(),
		)
		if err != nil {
			return err
		}
...
func (m *AndroidGeneralDeviceConfiguration) SetPasswordMinutesOfInactivityBeforeScreenTimeout(
	value *int32,
) {
...
func (m *AndroidGeneralDeviceConfiguration) SetPasswordRequiredType(
...
func (m *AndroidGeneralDeviceConfiguration) SetPasswordSignInFailureCountBeforeFactoryReset(
	value *int32,
) {
...
func (m *AndroidGeneralDeviceConfiguration) SetStorageRequireRemovableStorageEncryption(
	value *bool,
) {
...
func (m *AndroidGeneralDeviceConfiguration) SetWebBrowserCookieSettings(
	value *WebBrowserCookieSettings,
) {

...
func CreateAndroidManagedAppProtectionFromDiscriminatorValue(
...
func (m *AndroidManagedAppProtection) Serialize(
...
func (m *AndroidManagedAppProtection) SetDeploymentSummary(
...
func (m *AndroidManagedAppProtection) SetDisableAppEncryptionIfDeviceEncryptionIsEnabled(
	value *bool,
) {

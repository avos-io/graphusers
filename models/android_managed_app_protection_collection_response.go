...
func CreateAndroidManagedAppProtectionCollectionResponseFromDiscriminatorValue(
...
func (m *AndroidManagedAppProtectionCollectionResponse) Serialize(
...
func (m *AndroidManagedAppProtectionCollectionResponse) SetValue(
	value []AndroidManagedAppProtectionable,
) {
	m.value = value
}

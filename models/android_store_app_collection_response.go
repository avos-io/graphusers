...
func CreateAndroidStoreAppCollectionResponseFromDiscriminatorValue(
...
func (m *AndroidStoreAppCollectionResponse) Serialize(
...
// AndroidStoreAppCollectionResponseable

...
func CreateAndroidWorkProfileCompliancePolicyFromDiscriminatorValue(
...
func (m *AndroidWorkProfileCompliancePolicy) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDeviceThreatProtectionEnabled(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetMinAndroidSecurityPatchLevel(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetPasswordMinutesOfInactivityBeforeLock(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSecurityBlockJailbrokenDevices(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSecurityDisableUsbDebugging(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSecurityPreventInstallAppsFromUnknownSources(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSecurityRequireCompanyPortalAppIntegrity(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSecurityRequireGooglePlayServices(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSecurityRequireSafetyNetAttestationBasicIntegrity(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSecurityRequireSafetyNetAttestationCertifiedDevice(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSecurityRequireUpToDateSecurityProviders(),
		)
		if err != nil {
			return err
		}
...
func (m *AndroidWorkProfileCompliancePolicy) SetDeviceThreatProtectionRequiredSecurityLevel(
...
func (m *AndroidWorkProfileCompliancePolicy) SetPasswordMinutesOfInactivityBeforeLock(
	value *int32,
) {
...
func (m *AndroidWorkProfileCompliancePolicy) SetPasswordRequiredType(
	value *AndroidRequiredPasswordType,
) {
...
func (m *AndroidWorkProfileCompliancePolicy) SetSecurityPreventInstallAppsFromUnknownSources(
	value *bool,
) {
...
func (m *AndroidWorkProfileCompliancePolicy) SetSecurityRequireCompanyPortalAppIntegrity(
	value *bool,
) {
...
func (m *AndroidWorkProfileCompliancePolicy) SetSecurityRequireSafetyNetAttestationBasicIntegrity(
	value *bool,
) {
...
func (m *AndroidWorkProfileCompliancePolicy) SetSecurityRequireUpToDateSecurityProviders(
	value *bool,
) {

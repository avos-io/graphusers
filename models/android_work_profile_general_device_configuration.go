...
func CreateAndroidWorkProfileGeneralDeviceConfigurationFromDiscriminatorValue(
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["workProfileDefaultAppPermissionPolicy"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		...
		if val != nil {
			m.SetWorkProfileDefaultAppPermissionPolicy(
				val.(*AndroidWorkProfileDefaultAppPermissionPolicyType),
			)
		}
		return nil
	}
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetPasswordBlockFingerprintUnlock(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWorkProfileBlockAddingAccounts(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWorkProfileBlockCrossProfileCallerId(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWorkProfileBlockCrossProfileContactsSearch(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWorkProfileBlockCrossProfileCopyPaste(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWorkProfileBlockNotificationsWhileDeviceLocked(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWorkProfileBlockScreenCapture(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWorkProfileBluetoothEnableContactSharing(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWorkProfilePasswordBlockFingerprintUnlock(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWorkProfilePasswordBlockTrustAgents(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetWorkProfilePasswordExpirationDays(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetWorkProfilePasswordMinimumLength(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetWorkProfilePasswordMinLetterCharacters(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetWorkProfilePasswordMinLowerCaseCharacters(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetWorkProfilePasswordMinNonLetterCharacters(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetWorkProfilePasswordMinNumericCharacters(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetWorkProfilePasswordMinSymbolCharacters(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetWorkProfilePasswordMinUpperCaseCharacters(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetWorkProfilePasswordMinutesOfInactivityBeforeScreenTimeout(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetWorkProfilePasswordPreviousPasswordBlockCount(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetWorkProfilePasswordSignInFailureCountBeforeFactoryReset(),
		)
		if err != nil {
			return err
		}
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetPasswordBlockFingerprintUnlock(
	value *bool,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetPasswordMinutesOfInactivityBeforeScreenTimeout(
	value *int32,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetPasswordPreviousPasswordBlockCount(
	value *int32,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetPasswordRequiredType(
	value *AndroidWorkProfileRequiredPasswordType,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetPasswordSignInFailureCountBeforeFactoryReset(
	value *int32,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfileBlockAddingAccounts(
	value *bool,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfileBlockCrossProfileCallerId(
	value *bool,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfileBlockCrossProfileContactsSearch(
	value *bool,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfileBlockCrossProfileCopyPaste(
	value *bool,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfileBlockNotificationsWhileDeviceLocked(
	value *bool,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfileBlockScreenCapture(
	value *bool,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfileBluetoothEnableContactSharing(
	value *bool,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfileDataSharingType(
	value *AndroidWorkProfileCrossProfileDataSharingType,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfileDefaultAppPermissionPolicy(
	value *AndroidWorkProfileDefaultAppPermissionPolicyType,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordBlockFingerprintUnlock(
	value *bool,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordBlockTrustAgents(
	value *bool,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordExpirationDays(
	value *int32,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordMinimumLength(
	value *int32,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordMinLetterCharacters(
	value *int32,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordMinLowerCaseCharacters(
	value *int32,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordMinNonLetterCharacters(
	value *int32,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordMinNumericCharacters(
	value *int32,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordMinSymbolCharacters(
	value *int32,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordMinUpperCaseCharacters(
	value *int32,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordMinutesOfInactivityBeforeScreenTimeout(
	value *int32,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordPreviousPasswordBlockCount(
	value *int32,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordRequiredType(
	value *AndroidWorkProfileRequiredPasswordType,
) {
...
func (m *AndroidWorkProfileGeneralDeviceConfiguration) SetWorkProfilePasswordSignInFailureCountBeforeFactoryReset(
	value *int32,
) {

...
func CreateApiApplicationFromDiscriminatorValue(
...
func (m *ApiApplication) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["knownClientApplications"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		...
		if val != nil {
			res := make(
				[]i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID,
				len(val),
			)
			for i, v := range val {
	...
	res["preAuthorizedApplications"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreatePreAuthorizedApplicationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *ApiApplication) Serialize(
	...
	if m.GetKnownClientApplications() != nil {
		err := writer.WriteCollectionOfUUIDValues(
			"knownClientApplications",
			m.GetKnownClientApplications(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetPreAuthorizedApplications() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetPreAuthorizedApplications()),
		)
	...
	}
	{
		err := writer.WriteInt32Value(
			...
			m.GetRequestedAccessTokenVersion(),
		)
		if err != nil {
			return err
		}
...
func (m *ApiApplication) SetKnownClientApplications(

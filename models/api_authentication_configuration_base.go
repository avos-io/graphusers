...
func CreateApiAuthenticationConfigurationBaseFromDiscriminatorValue(
...
func (m *ApiAuthenticationConfigurationBase) Serialize(
...
type ApiAuthenticationConfigurationBaseable interface {

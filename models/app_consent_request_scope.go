...
func CreateAppConsentRequestScopeFromDiscriminatorValue(
...
func (m *AppConsentRequestScope) Serialize(
...
// AppConsentRequestScopeable
type AppConsentRequestScopeable interface {

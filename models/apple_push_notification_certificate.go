...
func CreateApplePushNotificationCertificateFromDiscriminatorValue(
...
func (m *ApplePushNotificationCertificate) Serialize(
	...
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetCertificateUploadFailureReason(),
		)
		if err != nil {
			return err
		}
...
func (m *ApplePushNotificationCertificate) SetExpirationDateTime(
...
func (m *ApplePushNotificationCertificate) SetLastModifiedDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

...
func (m *Application) Serialize(
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetRequestSignatureVerification(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetRequiredResourceAccess() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetRequiredResourceAccess()),
		)
	...
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetServiceManagementReference(),
		)
		if err != nil {
			return err
		}
...
func (m *Application) SetCreatedDateTime(
...
func (m *Application) SetTokenEncryptionKeyId(

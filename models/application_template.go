...
func CreateApplicationTemplateFromDiscriminatorValue(
...
func (m *ApplicationTemplate) Serialize(
	...
	if m.GetSupportedProvisioningTypes() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetSupportedProvisioningTypes(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetSupportedSingleSignOnModes() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetSupportedSingleSignOnModes(),
		)
		if err != nil {
			return err
		}

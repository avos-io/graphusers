...
func CreateApprovalSettingsFromDiscriminatorValue(
...
func (m *ApprovalSettings) Serialize(
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetIsApprovalRequiredForExtension(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetIsRequestorJustificationRequired(),
		)
		if err != nil {
			return err
		}

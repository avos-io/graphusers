...
func CreateAuthenticationMethodConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *AuthenticationMethodConfigurationCollectionResponse) Serialize(
...
func (m *AuthenticationMethodConfigurationCollectionResponse) SetValue(
	value []AuthenticationMethodConfigurationable,
) {
	m.value = value
}

...
func CreateAuthenticationMethodTargetCollectionResponseFromDiscriminatorValue(
...
func (m *AuthenticationMethodTargetCollectionResponse) Serialize(
...
func (m *AuthenticationMethodTargetCollectionResponse) SetValue(
	value []AuthenticationMethodTargetable,
) {
	m.value = value
}

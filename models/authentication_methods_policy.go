...
func CreateAuthenticationMethodsPolicyFromDiscriminatorValue(
...
func (m *AuthenticationMethodsPolicy) Serialize(
	...
	if m.GetAuthenticationMethodConfigurations() != nil {
		cast := make(
			...
			len(m.GetAuthenticationMethodConfigurations()),
		)
...
func (m *AuthenticationMethodsPolicy) SetAuthenticationMethodConfigurations(
...
func (m *AuthenticationMethodsPolicy) SetLastModifiedDateTime(
...
func (m *AuthenticationMethodsPolicy) SetRegistrationEnforcement(
	value RegistrationEnforcementable,
) {

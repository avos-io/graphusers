...
func CreateAuthenticationMethodsRegistrationCampaignFromDiscriminatorValue(
...
func (m *AuthenticationMethodsRegistrationCampaign) Serialize(
	writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter,
) error {
	if m.GetExcludeTargets() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetExcludeTargets()),
		)
...
func (m *AuthenticationMethodsRegistrationCampaign) SetIncludeTargets(

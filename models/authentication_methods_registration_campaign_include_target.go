...
func CreateAuthenticationMethodsRegistrationCampaignIncludeTargetFromDiscriminatorValue(
...
func (m *AuthenticationMethodsRegistrationCampaignIncludeTarget) Serialize(
	...
	}
	{
		err := writer.WriteStringValue(
			...
			m.GetTargetedAuthenticationMethod(),
		)
		if err != nil {
			return err
		}
...
func (m *AuthenticationMethodsRegistrationCampaignIncludeTarget) SetAdditionalData(
...
func (m *AuthenticationMethodsRegistrationCampaignIncludeTarget) SetTargetedAuthenticationMethod(
	value *string,
) {
...
func (m *AuthenticationMethodsRegistrationCampaignIncludeTarget) SetTargetType(
	value *AuthenticationMethodTargetType,
) {
	m.targetType = value
}

...
func NewAuthenticationMethodsRegistrationCampaignIncludeTargetCollectionResponse() *AuthenticationMethodsRegistrationCampaignIncludeTargetCollectionResponse {
	m := &AuthenticationMethodsRegistrationCampaignIncludeTargetCollectionResponse{
		BaseCollectionPaginationCountResponse: *NewBaseCollectionPaginationCountResponse(),
	}
	return m
}

// CreateAuthenticationMethodsRegistrationCampaignIncludeTargetCollectionResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateAuthenticationMethodsRegistrationCampaignIncludeTargetCollectionResponseFromDiscriminatorValue(
	...
	return NewAuthenticationMethodsRegistrationCampaignIncludeTargetCollectionResponse(), nil
}

// GetFieldDeserializers the deserialization information for the current model
func (m *AuthenticationMethodsRegistrationCampaignIncludeTargetCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	res := m.BaseCollectionPaginationCountResponse.GetFieldDeserializers()
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateAuthenticationMethodsRegistrationCampaignIncludeTargetFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *AuthenticationMethodsRegistrationCampaignIncludeTargetCollectionResponse) Serialize(
...
func (m *AuthenticationMethodsRegistrationCampaignIncludeTargetCollectionResponse) SetValue(
	value []AuthenticationMethodsRegistrationCampaignIncludeTargetable,
) {
	m.value = value
}

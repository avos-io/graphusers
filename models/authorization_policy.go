...
func CreateAuthorizationPolicyFromDiscriminatorValue(
...
func (m *AuthorizationPolicy) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAllowedToSignUpEmailBasedSubscriptions(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAllowEmailVerifiedUsersToJoinOrganization(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetDefaultUserRolePermissions(),
		)
		if err != nil {
			return err
		}
...
func (m *AuthorizationPolicy) SetGuestUserRoleId(

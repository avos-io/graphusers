...
func CreateAzureCommunicationServicesUserConversationMemberFromDiscriminatorValue(
...
func (m *AzureCommunicationServicesUserConversationMember) Serialize(
	...
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetAzureCommunicationServicesId(),
		)
		if err != nil {
			return err
		}
...
func (m *AzureCommunicationServicesUserConversationMember) SetAzureCommunicationServicesId(
	value *string,
) {

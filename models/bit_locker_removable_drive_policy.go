...
func CreateBitLockerRemovableDrivePolicyFromDiscriminatorValue(
...
func (m *BitLockerRemovableDrivePolicy) Serialize(
	writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter,
) error {
	{
		err := writer.WriteBoolValue(
			"blockCrossOrganizationWriteAccess",
			m.GetBlockCrossOrganizationWriteAccess(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetRequireEncryptionForWriteAccess(),
		)
		if err != nil {
			return err
		}

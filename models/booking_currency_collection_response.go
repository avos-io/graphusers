...
func CreateBookingCurrencyCollectionResponseFromDiscriminatorValue(
...
func (m *BookingCurrencyCollectionResponse) Serialize(
...
// BookingCurrencyCollectionResponseable

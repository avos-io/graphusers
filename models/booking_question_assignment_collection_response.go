...
func CreateBookingQuestionAssignmentCollectionResponseFromDiscriminatorValue(
...
func (m *BookingQuestionAssignmentCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateBookingQuestionAssignmentFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *BookingQuestionAssignmentCollectionResponse) Serialize(
...
func (m *BookingQuestionAssignmentCollectionResponse) SetValue(
	value []BookingQuestionAssignmentable,
) {
	m.value = value
}

// BookingQuestionAssignmentCollectionResponseable
type BookingQuestionAssignmentCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []BookingQuestionAssignmentable
	SetValue(value []BookingQuestionAssignmentable)
}

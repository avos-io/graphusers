...
func CreateBookingServiceFromDiscriminatorValue(
...
func (m *BookingService) Serialize(
...
func (m *BookingService) SetDefaultDuration(
...
func (m *BookingService) SetPostBuffer(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {
	m.postBuffer = value
}
...
func (m *BookingService) SetPreBuffer(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {
	m.preBuffer = value
}

...
func CreateBookingStaffMemberFromDiscriminatorValue(
...
func (m *BookingStaffMember) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAvailabilityIsAffectedByPersonalCalendar(),
		)
		if err != nil {
			return err
		}

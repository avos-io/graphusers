...
type BookingStaffMemberBaseCollectionResponse struct {
	...
	// The value property
	value []BookingStaffMemberBaseable
}
...
func CreateBookingStaffMemberBaseCollectionResponseFromDiscriminatorValue(
...
func (m *BookingStaffMemberBaseCollectionResponse) Serialize(

...
func CreateBucketAggregationRangeFromDiscriminatorValue(
...
func (m *BucketAggregationRange) Serialize(
...
// BucketAggregationRangeable
type BucketAggregationRangeable interface {

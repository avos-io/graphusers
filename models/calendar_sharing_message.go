...
func CreateCalendarSharingMessageFromDiscriminatorValue(
...
func (m *CalendarSharingMessage) Serialize(
	...
	if m.GetSharingMessageActions() != nil {
		cast := make(
			...
			len(m.GetSharingMessageActions()),
		)
...
func (m *CalendarSharingMessage) SetSharingMessageActions(

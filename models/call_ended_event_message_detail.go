...
func CreateCallEndedEventMessageDetailFromDiscriminatorValue(
...
func (m *CallEndedEventMessageDetail) Serialize(
...
func (m *CallEndedEventMessageDetail) SetCallDuration(

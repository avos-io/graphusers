...
func CreateCallRecordingEventMessageDetailFromDiscriminatorValue(
...
func (m *CallRecordingEventMessageDetail) Serialize(
...
func (m *CallRecordingEventMessageDetail) SetCallRecordingDuration(

...
func CreateCallTranscriptionInfoFromDiscriminatorValue(
...
func (m *CallTranscriptionInfo) Serialize(
...
func (m *CallTranscriptionInfo) SetLastModifiedDateTime(

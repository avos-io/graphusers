...
func (m *DeviceInfo) Serialize(
	...
	}
	{
		err := writer.WriteFloat32Value(
			...
			m.GetInitialSignalLevelRootMeanSquare(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteFloat32Value(
			...
			m.GetLowSpeechToNoiseEventRatio(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteFloat32Value(
			...
			m.GetRenderNotFunctioningEventRatio(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteFloat32Value(
			...
			m.GetRenderZeroVolumeEventRatio(),
		)
		if err != nil {
			return err
		}

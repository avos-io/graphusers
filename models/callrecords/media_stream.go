...
func (m *MediaStream) Serialize(
	...
	}
	{
		err := writer.WriteISODurationValue(
			...
			m.GetAverageAudioNetworkJitter(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteFloat32Value(
			...
			m.GetAverageRatioOfConcealedSamples(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteFloat32Value(
			...
			m.GetAverageVideoFrameLossPercentage(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteFloat32Value(
			...
			m.GetAverageVideoPacketLossRate(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteFloat32Value(
			...
			m.GetLowVideoProcessingCapabilityRatio(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteFloat32Value(
			...
			m.GetPostForwardErrorCorrectionPacketLossRate(),
		)
		if err != nil {
			return err
		}
...
func (m *MediaStream) SetEndDateTime(
...
func (m *MediaStream) SetStartDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

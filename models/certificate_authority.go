...
func CreateCertificateAuthorityFromDiscriminatorValue(
...
func (m *CertificateAuthority) Serialize(
	...
	}
	{
		err := writer.WriteStringValue(
			...
			m.GetCertificateRevocationListUrl(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteStringValue(
			...
			m.GetDeltaCertificateRevocationListUrl(),
		)
		if err != nil {
			return err
		}

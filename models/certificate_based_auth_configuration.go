...
func CreateCertificateBasedAuthConfigurationFromDiscriminatorValue(
...
func (m *CertificateBasedAuthConfiguration) Serialize(
	...
	if m.GetCertificateAuthorities() != nil {
		cast := make(
			...
			len(m.GetCertificateAuthorities()),
		)
...
func (m *CertificateBasedAuthConfiguration) SetCertificateAuthorities(

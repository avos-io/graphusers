...
func CreateCertificateBasedAuthConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *CertificateBasedAuthConfigurationCollectionResponse) Serialize(
...
func (m *CertificateBasedAuthConfigurationCollectionResponse) SetValue(
	value []CertificateBasedAuthConfigurationable,
) {
	m.value = value
}

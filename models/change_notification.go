...
func CreateChangeNotificationFromDiscriminatorValue(
...
func (m *ChangeNotification) Serialize(
	...
	}
	{
		err := writer.WriteTimeValue(
			...
			m.GetSubscriptionExpirationDateTime(),
		)
		if err != nil {
			return err
		}
...
func (m *ChangeNotification) SetSubscriptionExpirationDateTime(
...
func (m *ChangeNotification) SetSubscriptionId(
...
func (m *ChangeNotification) SetTenantId(
	value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID,
) {
	m.tenantId = value
}
...
type ChangeNotificationable interface {
	...
	SetSubscriptionExpirationDateTime(
		value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
	)

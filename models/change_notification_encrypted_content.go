...
func CreateChangeNotificationEncryptedContentFromDiscriminatorValue(
...
func (m *ChangeNotificationEncryptedContent) Serialize(
	...
	}
	{
		err := writer.WriteStringValue(
			...
			m.GetEncryptionCertificateThumbprint(),
		)
		if err != nil {
			return err
		}

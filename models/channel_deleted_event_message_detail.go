...
func CreateChannelDeletedEventMessageDetailFromDiscriminatorValue(
...
func (m *ChannelDeletedEventMessageDetail) Serialize(
...
// ChannelDeletedEventMessageDetailable

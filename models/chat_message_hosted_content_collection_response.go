...
func CreateChatMessageHostedContentCollectionResponseFromDiscriminatorValue(
...
func (m *ChatMessageHostedContentCollectionResponse) Serialize(
...
func (m *ChatMessageHostedContentCollectionResponse) SetValue(
	value []ChatMessageHostedContentable,
) {
	m.value = value
}

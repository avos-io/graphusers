...
func CreateClientCertificateAuthenticationFromDiscriminatorValue(
...
func (m *ClientCertificateAuthentication) Serialize(
...
func (m *ClientCertificateAuthentication) SetCertificateList(

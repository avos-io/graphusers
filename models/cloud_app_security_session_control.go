...
func CreateCloudAppSecuritySessionControlFromDiscriminatorValue(
...
func (m *CloudAppSecuritySessionControl) Serialize(
...
func (m *CloudAppSecuritySessionControl) SetCloudAppSecurityType(
	value *CloudAppSecuritySessionControlType,
) {

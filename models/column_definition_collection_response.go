...
func CreateColumnDefinitionCollectionResponseFromDiscriminatorValue(
...
func (m *ColumnDefinitionCollectionResponse) Serialize(
...
// ColumnDefinitionCollectionResponseable

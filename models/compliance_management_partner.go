...
func CreateComplianceManagementPartnerFromDiscriminatorValue(
...
func (m *ComplianceManagementPartner) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["androidEnrollmentAssignments"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateComplianceManagementPartnerAssignmentFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *ComplianceManagementPartner) Serialize(
	...
	if m.GetAndroidEnrollmentAssignments() != nil {
		cast := make(
			...
			len(m.GetAndroidEnrollmentAssignments()),
		)
	...
	if m.GetIosEnrollmentAssignments() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetIosEnrollmentAssignments()),
		)
	...
	if m.GetMacOsEnrollmentAssignments() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetMacOsEnrollmentAssignments()),
		)
...
func (m *ComplianceManagementPartner) SetAndroidEnrollmentAssignments(
...
func (m *ComplianceManagementPartner) SetIosEnrollmentAssignments(
	value []ComplianceManagementPartnerAssignmentable,
) {
...
func (m *ComplianceManagementPartner) SetLastHeartbeatDateTime(
...
func (m *ComplianceManagementPartner) SetMacOsEnrollmentAssignments(
	value []ComplianceManagementPartnerAssignmentable,
) {

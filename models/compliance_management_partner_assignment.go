...
func CreateComplianceManagementPartnerAssignmentFromDiscriminatorValue(
...
func (m *ComplianceManagementPartnerAssignment) Serialize(
...
func (m *ComplianceManagementPartnerAssignment) SetTarget(

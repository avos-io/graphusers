...
func CreateComplianceManagementPartnerAssignmentCollectionResponseFromDiscriminatorValue(
...
func (m *ComplianceManagementPartnerAssignmentCollectionResponse) Serialize(
...
func (m *ComplianceManagementPartnerAssignmentCollectionResponse) SetValue(
	value []ComplianceManagementPartnerAssignmentable,
) {
	m.value = value
}

...
// ComplianceManagementPartnerCollectionResponse
...
func CreateComplianceManagementPartnerCollectionResponseFromDiscriminatorValue(
...
func (m *ComplianceManagementPartnerCollectionResponse) Serialize(
...
func (m *ComplianceManagementPartnerCollectionResponse) SetValue(
	value []ComplianceManagementPartnerable,
) {
	m.value = value
}

// ComplianceManagementPartnerCollectionResponseable

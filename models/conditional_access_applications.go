...
func CreateConditionalAccessApplicationsFromDiscriminatorValue(
...
func (m *ConditionalAccessApplications) Serialize(
	...
	if m.GetIncludeAuthenticationContextClassReferences() != nil {
		err := writer.WriteCollectionOfStringValues(
			...
			m.GetIncludeAuthenticationContextClassReferences(),
		)
		if err != nil {
			return err
		}
...
func (m *ConditionalAccessApplications) SetIncludeAuthenticationContextClassReferences(
	value []string,
) {

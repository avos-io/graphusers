...
func CreateConditionalAccessConditionSetFromDiscriminatorValue(
...
func (m *ConditionalAccessConditionSet) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["clientApplications"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateConditionalAccessClientApplicationsFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *ConditionalAccessConditionSet) Serialize(
	...
	if m.GetClientAppTypes() != nil {
		err := writer.WriteCollectionOfStringValues(
			"clientAppTypes",
			SerializeConditionalAccessClientApp(m.GetClientAppTypes()),
		)
		if err != nil {
			return err
		}
	...
	if m.GetServicePrincipalRiskLevels() != nil {
		err := writer.WriteCollectionOfStringValues(
			...
			SerializeRiskLevel(m.GetServicePrincipalRiskLevels()),
		)
		if err != nil {
			return err
		}
	...
	if m.GetSignInRiskLevels() != nil {
		err := writer.WriteCollectionOfStringValues(
			"signInRiskLevels",
			SerializeRiskLevel(m.GetSignInRiskLevels()),
		)
		if err != nil {
			return err
		}
	...
	if m.GetUserRiskLevels() != nil {
		err := writer.WriteCollectionOfStringValues(
			"userRiskLevels",
			SerializeRiskLevel(m.GetUserRiskLevels()),
		)
		if err != nil {
			return err
		}
...
func (m *ConditionalAccessConditionSet) SetClientApplications(
	value ConditionalAccessClientApplicationsable,
) {

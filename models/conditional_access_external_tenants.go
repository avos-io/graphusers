...
func CreateConditionalAccessExternalTenantsFromDiscriminatorValue(
...
func (m *ConditionalAccessExternalTenants) Serialize(
...
func (m *ConditionalAccessExternalTenants) SetMembershipKind(
	value *ConditionalAccessExternalTenantsMembershipKind,
) {

...
func CreateConditionalAccessGrantControlsFromDiscriminatorValue(
...
func (m *ConditionalAccessGrantControls) Serialize(
	writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter,
) error {
	if m.GetBuiltInControls() != nil {
		err := writer.WriteCollectionOfStringValues(
			"builtInControls",
			SerializeConditionalAccessGrantControl(m.GetBuiltInControls()),
		)
		if err != nil {
			return err
		}
	...
	if m.GetCustomAuthenticationFactors() != nil {
		err := writer.WriteCollectionOfStringValues(
			...
			m.GetCustomAuthenticationFactors(),
		)
		if err != nil {
			return err
		}

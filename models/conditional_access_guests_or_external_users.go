...
func CreateConditionalAccessGuestsOrExternalUsersFromDiscriminatorValue(
...
func (m *ConditionalAccessGuestsOrExternalUsers) Serialize(
...
func (m *ConditionalAccessGuestsOrExternalUsers) SetExternalTenants(
	value ConditionalAccessExternalTenantsable,
) {
...
func (m *ConditionalAccessGuestsOrExternalUsers) SetGuestOrExternalUserTypes(

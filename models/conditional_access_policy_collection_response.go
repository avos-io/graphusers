...
type ConditionalAccessPolicyCollectionResponse struct {
	...
	// The value property
	value []ConditionalAccessPolicyable
}
...
func CreateConditionalAccessPolicyCollectionResponseFromDiscriminatorValue(
...
func (m *ConditionalAccessPolicyCollectionResponse) Serialize(

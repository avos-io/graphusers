...
func CreateConditionalAccessPolicyDetailFromDiscriminatorValue(
...
func (m *ConditionalAccessPolicyDetail) Serialize(
...
func (m *ConditionalAccessPolicyDetail) SetSessionControls(

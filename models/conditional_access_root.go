...
func CreateConditionalAccessRootFromDiscriminatorValue(
...
func (m *ConditionalAccessRoot) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["templates"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateConditionalAccessTemplateFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *ConditionalAccessRoot) Serialize(
	...
	if m.GetAuthenticationContextClassReferences() != nil {
		cast := make(
			...
			len(m.GetAuthenticationContextClassReferences()),
		)
...
func (m *ConditionalAccessRoot) SetAuthenticationContextClassReferences(

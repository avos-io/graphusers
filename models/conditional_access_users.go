...
func CreateConditionalAccessUsersFromDiscriminatorValue(
...
func (m *ConditionalAccessUsers) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["excludeGuestsOrExternalUsers"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateConditionalAccessGuestsOrExternalUsersFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *ConditionalAccessUsers) Serialize(
	...
	}
	{
		err := writer.WriteObjectValue(
			...
			m.GetExcludeGuestsOrExternalUsers(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteObjectValue(
			...
			m.GetIncludeGuestsOrExternalUsers(),
		)
		if err != nil {
			return err
		}
...
func (m *ConditionalAccessUsers) SetExcludeGuestsOrExternalUsers(
	value ConditionalAccessGuestsOrExternalUsersable,
) {
...
func (m *ConditionalAccessUsers) SetIncludeGuestsOrExternalUsers(
	value ConditionalAccessGuestsOrExternalUsersable,
) {

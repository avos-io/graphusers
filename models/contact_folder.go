...
func (m *ContactFolder) Serialize(
...
func (m *ContactFolder) SetMultiValueExtendedProperties(
...
func (m *ContactFolder) SetSingleValueExtendedProperties(

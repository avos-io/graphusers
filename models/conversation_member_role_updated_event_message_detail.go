...
func CreateConversationMemberRoleUpdatedEventMessageDetailFromDiscriminatorValue(
...
func (m *ConversationMemberRoleUpdatedEventMessageDetail) Serialize(
...
func (m *ConversationMemberRoleUpdatedEventMessageDetail) SetConversationMemberRoles(
	value []string,
) {
...
func (m *ConversationMemberRoleUpdatedEventMessageDetail) SetConversationMemberUser(

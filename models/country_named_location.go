...
func CreateCountryNamedLocationFromDiscriminatorValue(
...
func (m *CountryNamedLocation) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetIncludeUnknownCountriesAndRegions(),
		)
		if err != nil {
			return err
		}

...
func CreateCrossTenantAccessPolicyConfigurationPartnerCollectionResponseFromDiscriminatorValue(
...
func (m *CrossTenantAccessPolicyConfigurationPartnerCollectionResponse) Serialize(
...
func (m *CrossTenantAccessPolicyConfigurationPartnerCollectionResponse) SetValue(
	value []CrossTenantAccessPolicyConfigurationPartnerable,
) {
	m.value = value
}

...
func CreateCrossTenantAccessPolicyInboundTrustFromDiscriminatorValue(
...
func (m *CrossTenantAccessPolicyInboundTrust) Serialize(
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetIsHybridAzureADJoinedDeviceAccepted(),
		)
		if err != nil {
			return err
		}

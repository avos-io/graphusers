...
func ParseCrossTenantAccessPolicyTargetConfigurationAccessType(v string) (any, error) {
	...
	default:
		return 0, errors.New(
			"Unknown CrossTenantAccessPolicyTargetConfigurationAccessType value: " + v,
		)
	}
	return &result, nil
}

func SerializeCrossTenantAccessPolicyTargetConfigurationAccessType(
	values []CrossTenantAccessPolicyTargetConfigurationAccessType,
) []string {

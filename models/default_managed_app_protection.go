...
func CreateDefaultManagedAppProtectionFromDiscriminatorValue(
...
func (m *DefaultManagedAppProtection) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDisableAppEncryptionIfDeviceEncryptionIsEnabled(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetMinimumRequiredPatchVersion(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetMinimumWarningPatchVersion(),
		)
		if err != nil {
			return err
		}
...
func (m *DefaultManagedAppProtection) SetAppDataEncryptionType(
	value *ManagedAppDataEncryptionType,
) {
...
func (m *DefaultManagedAppProtection) SetDeploymentSummary(
	value ManagedAppPolicyDeploymentSummaryable,
) {
...
func (m *DefaultManagedAppProtection) SetDisableAppEncryptionIfDeviceEncryptionIsEnabled(
	value *bool,
) {

...
func CreateDefaultManagedAppProtectionCollectionResponseFromDiscriminatorValue(
...
func (m *DefaultManagedAppProtectionCollectionResponse) Serialize(
...
func (m *DefaultManagedAppProtectionCollectionResponse) SetValue(
	value []DefaultManagedAppProtectionable,
) {
	m.value = value
}

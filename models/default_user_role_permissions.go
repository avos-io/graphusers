...
func CreateDefaultUserRolePermissionsFromDiscriminatorValue(
...
func (m *DefaultUserRolePermissions) Serialize(
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetAllowedToCreateSecurityGroups(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetPermissionGrantPoliciesAssigned() != nil {
		err := writer.WriteCollectionOfStringValues(
			...
			m.GetPermissionGrantPoliciesAssigned(),
		)
		if err != nil {
			return err
		}

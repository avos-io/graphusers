...
func CreateDelegatedAdminCustomerFromDiscriminatorValue(
...
func (m *DelegatedAdminCustomer) Serialize(
	...
	if m.GetServiceManagementDetails() != nil {
		cast := make(
			...
			len(m.GetServiceManagementDetails()),
		)
...
func (m *DelegatedAdminCustomer) SetServiceManagementDetails(

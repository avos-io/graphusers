...
func CreateDelegatedAdminRelationshipCollectionResponseFromDiscriminatorValue(
...
func (m *DelegatedAdminRelationshipCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateDelegatedAdminRelationshipFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *DelegatedAdminRelationshipCollectionResponse) Serialize(
...
func (m *DelegatedAdminRelationshipCollectionResponse) SetValue(
	value []DelegatedAdminRelationshipable,
) {
	m.value = value
}

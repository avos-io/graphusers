...
func CreateDelegatedAdminRelationshipOperationCollectionResponseFromDiscriminatorValue(
...
func (m *DelegatedAdminRelationshipOperationCollectionResponse) Serialize(
...
func (m *DelegatedAdminRelationshipOperationCollectionResponse) SetValue(
	value []DelegatedAdminRelationshipOperationable,
) {
	m.value = value
}

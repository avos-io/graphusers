...
func CreateDelegatedAdminRelationshipRequestFromDiscriminatorValue(
...
func (m *DelegatedAdminRelationshipRequest) Serialize(
...
func (m *DelegatedAdminRelationshipRequest) SetAction(
	value *DelegatedAdminRelationshipRequestAction,
) {
	m.action = value
}
...
func (m *DelegatedAdminRelationshipRequest) SetCreatedDateTime(
...
func (m *DelegatedAdminRelationshipRequest) SetLastModifiedDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {
...
func (m *DelegatedAdminRelationshipRequest) SetStatus(
	value *DelegatedAdminRelationshipRequestStatus,
) {
	m.status = value
}

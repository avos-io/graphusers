...
func CreateDelegatedAdminRelationshipRequestCollectionResponseFromDiscriminatorValue(
...
func (m *DelegatedAdminRelationshipRequestCollectionResponse) Serialize(
...
func (m *DelegatedAdminRelationshipRequestCollectionResponse) SetValue(
	value []DelegatedAdminRelationshipRequestable,
) {
	m.value = value
}

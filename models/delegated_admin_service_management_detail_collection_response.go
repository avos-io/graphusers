...
func CreateDelegatedAdminServiceManagementDetailCollectionResponseFromDiscriminatorValue(
...
func (m *DelegatedAdminServiceManagementDetailCollectionResponse) Serialize(
...
func (m *DelegatedAdminServiceManagementDetailCollectionResponse) SetValue(
	value []DelegatedAdminServiceManagementDetailable,
) {
	m.value = value
}

// DelegatedAdminServiceManagementDetailCollectionResponseable

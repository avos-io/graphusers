...
func CreateDelegatedPermissionClassificationCollectionResponseFromDiscriminatorValue(
...
func (m *DelegatedPermissionClassificationCollectionResponse) Serialize(
...
func (m *DelegatedPermissionClassificationCollectionResponse) SetValue(
	value []DelegatedPermissionClassificationable,
) {
	m.value = value
}

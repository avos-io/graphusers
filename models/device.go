...
func (m *Device) Serialize(
	...
	if m.GetAlternativeSecurityIds() != nil {
		cast := make(
			...
			len(m.GetAlternativeSecurityIds()),
		)
	...
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetApproximateLastSignInDateTime(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetComplianceExpirationDateTime(),
		)
		if err != nil {
			return err
		}
...
func (m *Device) SetApproximateLastSignInDateTime(
...
func (m *Device) SetComplianceExpirationDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {
...
func (m *Device) SetOnPremisesLastSyncDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

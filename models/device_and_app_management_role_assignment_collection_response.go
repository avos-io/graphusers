...
func CreateDeviceAndAppManagementRoleAssignmentCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceAndAppManagementRoleAssignmentCollectionResponse) Serialize(
...
func (m *DeviceAndAppManagementRoleAssignmentCollectionResponse) SetValue(
	value []DeviceAndAppManagementRoleAssignmentable,
) {
	m.value = value
}

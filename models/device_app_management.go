...
func CreateDeviceAppManagementFromDiscriminatorValue(
...
func (m *DeviceAppManagement) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["androidManagedAppProtections"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateAndroidManagedAppProtectionFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
	...
	res["defaultManagedAppProtections"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateDefaultManagedAppProtectionFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
	...
	res["iosManagedAppProtections"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateIosManagedAppProtectionFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
	...
	res["mdmWindowsInformationProtectionPolicies"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateMdmWindowsInformationProtectionPolicyFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
	...
	res["mobileAppConfigurations"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateManagedDeviceMobileAppConfigurationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
	...
	res["targetedManagedAppConfigurations"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateTargetedManagedAppConfigurationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
	...
	res["windowsInformationProtectionPolicies"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateWindowsInformationProtectionPolicyFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *DeviceAppManagement) Serialize(
	...
	if m.GetAndroidManagedAppProtections() != nil {
		cast := make(
			...
			len(m.GetAndroidManagedAppProtections()),
		)
	...
	if m.GetDefaultManagedAppProtections() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetDefaultManagedAppProtections()),
		)
	...
	if m.GetIosManagedAppProtections() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetIosManagedAppProtections()),
		)
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetIsEnabledForMicrosoftStoreForBusiness(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetMdmWindowsInformationProtectionPolicies() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetMdmWindowsInformationProtectionPolicies()),
		)
	...
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetMicrosoftStoreForBusinessLanguage(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetMicrosoftStoreForBusinessLastCompletedApplicationSyncTime(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetMicrosoftStoreForBusinessLastSuccessfulSyncDateTime(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetMobileAppConfigurations() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetMobileAppConfigurations()),
		)
	...
	if m.GetTargetedManagedAppConfigurations() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetTargetedManagedAppConfigurations()),
		)
	...
	if m.GetWindowsInformationProtectionPolicies() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetWindowsInformationProtectionPolicies()),
		)
...
func (m *DeviceAppManagement) SetAndroidManagedAppProtections(
...
func (m *DeviceAppManagement) SetDefaultManagedAppProtections(
...
func (m *DeviceAppManagement) SetMdmWindowsInformationProtectionPolicies(
...
func (m *DeviceAppManagement) SetMicrosoftStoreForBusinessLastCompletedApplicationSyncTime(
...
func (m *DeviceAppManagement) SetMicrosoftStoreForBusinessLastSuccessfulSyncDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {
...
func (m *DeviceAppManagement) SetMobileAppConfigurations(
...
func (m *DeviceAppManagement) SetWindowsInformationProtectionPolicies(

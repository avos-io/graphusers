...
func CreateDeviceComplianceActionItemCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceComplianceActionItemCollectionResponse) Serialize(
...
func (m *DeviceComplianceActionItemCollectionResponse) SetValue(
	value []DeviceComplianceActionItemable,
) {
	m.value = value
}

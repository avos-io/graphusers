...
func CreateDeviceComplianceDeviceOverviewFromDiscriminatorValue(
...
func (m *DeviceComplianceDeviceOverview) Serialize(
...
func (m *DeviceComplianceDeviceOverview) SetLastUpdateDateTime(

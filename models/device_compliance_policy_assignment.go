...
func CreateDeviceCompliancePolicyAssignmentFromDiscriminatorValue(
...
func (m *DeviceCompliancePolicyAssignment) Serialize(
...
func (m *DeviceCompliancePolicyAssignment) SetTarget(

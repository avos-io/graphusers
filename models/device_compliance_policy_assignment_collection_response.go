...
func CreateDeviceCompliancePolicyAssignmentCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceCompliancePolicyAssignmentCollectionResponse) Serialize(
...
func (m *DeviceCompliancePolicyAssignmentCollectionResponse) SetValue(
	value []DeviceCompliancePolicyAssignmentable,
) {
	m.value = value
}

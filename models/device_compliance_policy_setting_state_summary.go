...
func CreateDeviceCompliancePolicySettingStateSummaryFromDiscriminatorValue(
...
func (m *DeviceCompliancePolicySettingStateSummary) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["deviceComplianceSettingStates"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateDeviceComplianceSettingStateFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *DeviceCompliancePolicySettingStateSummary) Serialize(
	...
	if m.GetDeviceComplianceSettingStates() != nil {
		cast := make(
			...
			len(m.GetDeviceComplianceSettingStates()),
		)
...
func (m *DeviceCompliancePolicySettingStateSummary) SetDeviceComplianceSettingStates(

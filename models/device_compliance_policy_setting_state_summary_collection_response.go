...
func CreateDeviceCompliancePolicySettingStateSummaryCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceCompliancePolicySettingStateSummaryCollectionResponse) Serialize(
...
func (m *DeviceCompliancePolicySettingStateSummaryCollectionResponse) SetValue(
	value []DeviceCompliancePolicySettingStateSummaryable,
) {
	m.value = value
}

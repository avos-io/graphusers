...
func CreateDeviceCompliancePolicyStateCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceCompliancePolicyStateCollectionResponse) Serialize(
...
func (m *DeviceCompliancePolicyStateCollectionResponse) SetValue(
	value []DeviceCompliancePolicyStateable,
) {
	m.value = value
}

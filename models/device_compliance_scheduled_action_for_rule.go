...
func CreateDeviceComplianceScheduledActionForRuleFromDiscriminatorValue(
...
func (m *DeviceComplianceScheduledActionForRule) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["scheduledActionConfigurations"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateDeviceComplianceActionItemFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *DeviceComplianceScheduledActionForRule) Serialize(
	...
	if m.GetScheduledActionConfigurations() != nil {
		cast := make(
			...
			len(m.GetScheduledActionConfigurations()),
		)
...
func (m *DeviceComplianceScheduledActionForRule) SetScheduledActionConfigurations(

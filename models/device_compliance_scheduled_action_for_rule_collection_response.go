...
func CreateDeviceComplianceScheduledActionForRuleCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceComplianceScheduledActionForRuleCollectionResponse) Serialize(
...
func (m *DeviceComplianceScheduledActionForRuleCollectionResponse) SetValue(
	value []DeviceComplianceScheduledActionForRuleable,
) {
	m.value = value
}

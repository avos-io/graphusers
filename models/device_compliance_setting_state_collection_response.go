...
func CreateDeviceComplianceSettingStateCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceComplianceSettingStateCollectionResponse) Serialize(
...
func (m *DeviceComplianceSettingStateCollectionResponse) SetValue(
	value []DeviceComplianceSettingStateable,
) {
	m.value = value
}

...
func CreateDeviceComplianceUserStatusFromDiscriminatorValue(
...
func (m *DeviceComplianceUserStatus) Serialize(
...
func (m *DeviceComplianceUserStatus) SetLastReportedDateTime(

...
func CreateDeviceConfigurationAssignmentFromDiscriminatorValue(
...
func (m *DeviceConfigurationAssignment) Serialize(
...
func (m *DeviceConfigurationAssignment) SetTarget(

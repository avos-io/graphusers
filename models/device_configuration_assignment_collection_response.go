...
func CreateDeviceConfigurationAssignmentCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceConfigurationAssignmentCollectionResponse) Serialize(
...
func (m *DeviceConfigurationAssignmentCollectionResponse) SetValue(
	value []DeviceConfigurationAssignmentable,
) {
	m.value = value
}

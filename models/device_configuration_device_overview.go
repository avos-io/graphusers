...
func CreateDeviceConfigurationDeviceOverviewFromDiscriminatorValue(
...
func (m *DeviceConfigurationDeviceOverview) Serialize(
...
func (m *DeviceConfigurationDeviceOverview) SetLastUpdateDateTime(

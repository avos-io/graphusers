...
func CreateDeviceConfigurationDeviceStatusCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceConfigurationDeviceStatusCollectionResponse) Serialize(
...
func (m *DeviceConfigurationDeviceStatusCollectionResponse) SetValue(
	value []DeviceConfigurationDeviceStatusable,
) {
	m.value = value
}

...
func CreateDeviceConfigurationStateCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceConfigurationStateCollectionResponse) Serialize(
...
func (m *DeviceConfigurationStateCollectionResponse) SetValue(
	value []DeviceConfigurationStateable,
) {
	m.value = value
}

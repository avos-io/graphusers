...
func CreateDeviceConfigurationUserOverviewFromDiscriminatorValue(
...
func (m *DeviceConfigurationUserOverview) Serialize(
...
func (m *DeviceConfigurationUserOverview) SetLastUpdateDateTime(

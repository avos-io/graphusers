...
func CreateDeviceConfigurationUserStatusFromDiscriminatorValue(
...
func (m *DeviceConfigurationUserStatus) Serialize(
...
func (m *DeviceConfigurationUserStatus) SetLastReportedDateTime(

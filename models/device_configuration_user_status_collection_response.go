...
func CreateDeviceConfigurationUserStatusCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceConfigurationUserStatusCollectionResponse) Serialize(
...
func (m *DeviceConfigurationUserStatusCollectionResponse) SetValue(
	value []DeviceConfigurationUserStatusable,
) {
	m.value = value
}

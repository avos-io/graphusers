...
func CreateDeviceEnrollmentConfigurationFromDiscriminatorValue(
...
func (m *DeviceEnrollmentConfiguration) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["assignments"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateEnrollmentConfigurationAssignmentFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *DeviceEnrollmentConfiguration) Serialize(
...
func (m *DeviceEnrollmentConfiguration) SetAssignments(
...
func (m *DeviceEnrollmentConfiguration) SetCreatedDateTime(
...
func (m *DeviceEnrollmentConfiguration) SetLastModifiedDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

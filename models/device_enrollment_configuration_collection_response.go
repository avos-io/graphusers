...
func CreateDeviceEnrollmentConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceEnrollmentConfigurationCollectionResponse) Serialize(
...
func (m *DeviceEnrollmentConfigurationCollectionResponse) SetValue(
	value []DeviceEnrollmentConfigurationable,
) {
	m.value = value
}

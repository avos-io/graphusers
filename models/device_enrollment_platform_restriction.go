...
func CreateDeviceEnrollmentPlatformRestrictionFromDiscriminatorValue(
...
func (m *DeviceEnrollmentPlatformRestriction) Serialize(
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetPersonalDeviceEnrollmentBlocked(),
		)
		if err != nil {
			return err
		}

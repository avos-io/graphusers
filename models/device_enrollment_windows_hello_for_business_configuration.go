...
func CreateDeviceEnrollmentWindowsHelloForBusinessConfigurationFromDiscriminatorValue(
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetUnlockWithBiometricsEnabled(),
		)
		if err != nil {
			return err
		}
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) SetEnhancedBiometricsState(
	value *Enablement,
) {
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) SetPinExpirationInDays(
	value *int32,
) {
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) SetPinLowercaseCharactersUsage(
	value *WindowsHelloForBusinessPinUsage,
) {
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) SetPinPreviousBlockCount(
	value *int32,
) {
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) SetPinSpecialCharactersUsage(
	value *WindowsHelloForBusinessPinUsage,
) {
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) SetPinUppercaseCharactersUsage(
	value *WindowsHelloForBusinessPinUsage,
) {
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) SetRemotePassportEnabled(
	value *bool,
) {
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) SetSecurityDeviceRequired(
	value *bool,
) {
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) SetUnlockWithBiometricsEnabled(
	value *bool,
) {

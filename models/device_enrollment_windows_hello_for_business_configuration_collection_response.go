...
func CreateDeviceEnrollmentWindowsHelloForBusinessConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfigurationCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateDeviceEnrollmentWindowsHelloForBusinessConfigurationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfigurationCollectionResponse) Serialize(
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfigurationCollectionResponse) SetValue(
	value []DeviceEnrollmentWindowsHelloForBusinessConfigurationable,
) {
	m.value = value
}

...
func (m *DeviceHealthAttestationState) Serialize(
	...
	}
	{
		err := writer.WriteStringValue(
			...
			m.GetBootManagerSecurityVersion(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteStringValue(
			...
			m.GetCodeIntegrityCheckVersion(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteStringValue(
			...
			m.GetDeviceHealthAttestationStatus(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteStringValue(
			...
			m.GetEarlyLaunchAntiMalwareDriverProtection(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteStringValue(
			...
			m.GetHealthAttestationSupportedStatus(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteStringValue(
			...
			m.GetOperatingSystemKernelDebugging(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteStringValue(
			...
			m.GetOperatingSystemRevListInfo(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteStringValue(
			...
			m.GetSecureBootConfigurationPolicyFingerPrint(),
		)
		if err != nil {
			return err
		}
...
func (m *DeviceHealthAttestationState) SetIssuedDateTime(

...
func CreateDeviceManagementExchangeConnectorFromDiscriminatorValue(
...
func (m *DeviceManagementExchangeConnector) Serialize(
...
func (m *DeviceManagementExchangeConnector) SetExchangeConnectorType(
	value *DeviceManagementExchangeConnectorType,
) {
...
func (m *DeviceManagementExchangeConnector) SetLastSyncDateTime(
...
func (m *DeviceManagementExchangeConnector) SetStatus(
	value *DeviceManagementExchangeConnectorStatus,
) {
	m.status = value
}

...
func CreateDeviceManagementExchangeConnectorCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceManagementExchangeConnectorCollectionResponse) Serialize(
...
func (m *DeviceManagementExchangeConnectorCollectionResponse) SetValue(
	value []DeviceManagementExchangeConnectorable,
) {
	m.value = value
}

...
func CreateDeviceManagementPartnerFromDiscriminatorValue(
...
func (m *DeviceManagementPartner) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["groupsRequiringPartnerEnrollment"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateDeviceManagementPartnerAssignmentFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *DeviceManagementPartner) Serialize(
	...
	if m.GetGroupsRequiringPartnerEnrollment() != nil {
		cast := make(
			...
			len(m.GetGroupsRequiringPartnerEnrollment()),
		)
	...
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetWhenPartnerDevicesWillBeMarkedAsNonCompliantDateTime(),
		)
		if err != nil {
			return err
		}
...
func (m *DeviceManagementPartner) SetGroupsRequiringPartnerEnrollment(
...
func (m *DeviceManagementPartner) SetLastHeartbeatDateTime(
...
func (m *DeviceManagementPartner) SetWhenPartnerDevicesWillBeMarkedAsNonCompliantDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {
...
func (m *DeviceManagementPartner) SetWhenPartnerDevicesWillBeRemovedDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

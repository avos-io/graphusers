...
func CreateDeviceManagementPartnerAssignmentCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceManagementPartnerAssignmentCollectionResponse) Serialize(
...
func (m *DeviceManagementPartnerAssignmentCollectionResponse) SetValue(
	value []DeviceManagementPartnerAssignmentable,
) {
	m.value = value
}

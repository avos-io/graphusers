...
func CreateDeviceManagementTroubleshootingEventCollectionResponseFromDiscriminatorValue(
...
func (m *DeviceManagementTroubleshootingEventCollectionResponse) Serialize(
...
func (m *DeviceManagementTroubleshootingEventCollectionResponse) SetValue(
	value []DeviceManagementTroubleshootingEventable,
) {
	m.value = value
}

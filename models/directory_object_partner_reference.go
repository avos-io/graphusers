...
func CreateDirectoryObjectPartnerReferenceFromDiscriminatorValue(
...
func (m *DirectoryObjectPartnerReference) Serialize(
...
func (m *DirectoryObjectPartnerReference) SetExternalPartnerTenantId(

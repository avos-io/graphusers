...
func (m *DocumentSet) Serialize(
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetPropagateWelcomePageChanges(),
		)
		if err != nil {
			return err
		}

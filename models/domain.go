...
func CreateDomainFromDiscriminatorValue(
...
func (m *Domain) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["federationConfiguration"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateInternalDomainFederationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *Domain) Serialize(
	...
	if m.GetFederationConfiguration() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetFederationConfiguration()),
		)
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetPasswordNotificationWindowInDays(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetPasswordValidityPeriodInDays(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetServiceConfigurationRecords() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetServiceConfigurationRecords()),
		)
	...
	if m.GetVerificationDnsRecords() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetVerificationDnsRecords()),
		)

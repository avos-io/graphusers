...
func CreateEducationAssignmentResourceCollectionResponseFromDiscriminatorValue(
...
func (m *EducationAssignmentResourceCollectionResponse) Serialize(
...
func (m *EducationAssignmentResourceCollectionResponse) SetValue(
	value []EducationAssignmentResourceable,
) {
	m.value = value
}

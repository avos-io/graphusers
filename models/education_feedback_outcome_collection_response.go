...
func CreateEducationFeedbackOutcomeCollectionResponseFromDiscriminatorValue(
...
func (m *EducationFeedbackOutcomeCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateEducationFeedbackOutcomeFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]EducationFeedbackOutcomeable, len(val))
			for i, v := range val {
				res[i] = v.(EducationFeedbackOutcomeable)
			}
			m.SetValue(res)
		}
		return nil
...
func (m *EducationFeedbackOutcomeCollectionResponse) Serialize(
...
func (m *EducationFeedbackOutcomeCollectionResponse) SetValue(
	value []EducationFeedbackOutcomeable,
) {
	m.value = value
}

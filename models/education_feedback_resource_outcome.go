...
func CreateEducationFeedbackResourceOutcomeFromDiscriminatorValue(
...
func (m *EducationFeedbackResourceOutcome) Serialize(
...
func (m *EducationFeedbackResourceOutcome) SetResourceStatus(
	value *EducationFeedbackResourceOutcomeStatus,
) {

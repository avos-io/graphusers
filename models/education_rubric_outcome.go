...
func CreateEducationRubricOutcomeFromDiscriminatorValue(
...
func (m *EducationRubricOutcome) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["publishedRubricQualityFeedback"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateRubricQualityFeedbackModelFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
	...
	res["publishedRubricQualitySelectedLevels"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateRubricQualitySelectedColumnModelFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *EducationRubricOutcome) Serialize(
	...
	if m.GetPublishedRubricQualityFeedback() != nil {
		cast := make(
			...
			len(m.GetPublishedRubricQualityFeedback()),
		)
	...
	if m.GetPublishedRubricQualitySelectedLevels() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetPublishedRubricQualitySelectedLevels()),
		)
	...
	if m.GetRubricQualityFeedback() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetRubricQualityFeedback()),
		)
	...
	if m.GetRubricQualitySelectedLevels() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetRubricQualitySelectedLevels()),
		)
...
func (m *EducationRubricOutcome) SetPublishedRubricQualityFeedback(
...
func (m *EducationRubricOutcome) SetPublishedRubricQualitySelectedLevels(
...
func (m *EducationRubricOutcome) SetRubricQualitySelectedLevels(
	value []RubricQualitySelectedColumnModelable,
) {

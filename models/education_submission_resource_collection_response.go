...
func CreateEducationSubmissionResourceCollectionResponseFromDiscriminatorValue(
...
func (m *EducationSubmissionResourceCollectionResponse) Serialize(
...
func (m *EducationSubmissionResourceCollectionResponse) SetValue(
	value []EducationSubmissionResourceable,
) {
	m.value = value
}

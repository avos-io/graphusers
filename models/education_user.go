...
func CreateEducationUserFromDiscriminatorValue(
...
func (m *EducationUser) Serialize(
	...
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetRefreshTokensValidFromDateTime(),
		)
		if err != nil {
			return err
		}
...
func (m *EducationUser) SetRefreshTokensValidFromDateTime(

...
func CreateEmailAuthenticationMethodCollectionResponseFromDiscriminatorValue(
...
func (m *EmailAuthenticationMethodCollectionResponse) Serialize(
...
func (m *EmailAuthenticationMethodCollectionResponse) SetValue(
	value []EmailAuthenticationMethodable,
) {
	m.value = value
}

...
func CreateEmailAuthenticationMethodConfigurationFromDiscriminatorValue(
...
func (m *EmailAuthenticationMethodConfiguration) Serialize(
...
func (m *EmailAuthenticationMethodConfiguration) SetAllowExternalIdToUseEmailOtp(
	value *ExternalEmailOtpState,
) {
...
func (m *EmailAuthenticationMethodConfiguration) SetIncludeTargets(

...
func CreateEmailFileAssessmentRequestFromDiscriminatorValue(
...
func (m *EmailFileAssessmentRequest) Serialize(
...
func (m *EmailFileAssessmentRequest) SetDestinationRoutingReason(
	value *MailDestinationRoutingReason,
) {

...
func CreateEnrollmentConfigurationAssignmentFromDiscriminatorValue(
...
func (m *EnrollmentConfigurationAssignment) Serialize(
...
func (m *EnrollmentConfigurationAssignment) SetTarget(

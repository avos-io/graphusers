...
func CreateEnrollmentConfigurationAssignmentCollectionResponseFromDiscriminatorValue(
...
func (m *EnrollmentConfigurationAssignmentCollectionResponse) Serialize(
...
func (m *EnrollmentConfigurationAssignmentCollectionResponse) SetValue(
	value []EnrollmentConfigurationAssignmentable,
) {
	m.value = value
}

...
func CreateEntitlementManagementScheduleFromDiscriminatorValue(
...
func (m *EntitlementManagementSchedule) Serialize(
...
func (m *EntitlementManagementSchedule) SetStartDateTime(

...
func CreateEntitlementManagementSettingsFromDiscriminatorValue(
...
func (m *EntitlementManagementSettings) Serialize(
	...
	}
	{
		err = writer.WriteISODurationValue(
			...
			m.GetDurationUntilExternalUserDeletedAfterBlocked(),
		)
		if err != nil {
			return err
		}
...
func (m *EntitlementManagementSettings) SetDurationUntilExternalUserDeletedAfterBlocked(
...
func (m *EntitlementManagementSettings) SetExternalUserLifecycleAction(
	value *AccessPackageExternalUserLifecycleAction,
) {

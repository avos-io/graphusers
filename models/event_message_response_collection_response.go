...
func CreateEventMessageResponseCollectionResponseFromDiscriminatorValue(
...
func (m *EventMessageResponseCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateEventMessageResponseFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]EventMessageResponseable, len(val))
			for i, v := range val {
				res[i] = v.(EventMessageResponseable)
			}
			m.SetValue(res)
		}
		return nil
...
func (m *EventMessageResponseCollectionResponse) Serialize(
...
// EventMessageResponseCollectionResponseable
type EventMessageResponseCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []EventMessageResponseable
	SetValue(value []EventMessageResponseable)
}

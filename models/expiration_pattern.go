...
func CreateExpirationPatternFromDiscriminatorValue(
...
func (m *ExpirationPattern) Serialize(
...
func (m *ExpirationPattern) SetDuration(
...
func (m *ExpirationPattern) SetEndDateTime(

...
type DisplayTemplate struct {
    ...
    id *string
    // The layout property
    layout i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Jsonable
...
func (m *DisplayTemplate) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["layout"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.CreateJsonFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetLayout(val.(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Jsonable))
        }
        return nil
    }
...
func (m *DisplayTemplate) GetLayout()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Jsonable) {
    return m.layout
}
...
func (m *DisplayTemplate) SetLayout(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Jsonable)() {
    m.layout = value
}
...
type DisplayTemplateable interface {
    ...
    GetId()(*string)
    GetLayout()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Jsonable)
    GetOdataType()(*string)
    GetPriority()(*int32)
    GetRules()([]PropertyRuleable)
    SetId(value *string)()
    SetLayout(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Jsonable)()

...
type PropertyRule struct {
    ...
    valuesJoinedBy *i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.BinaryOperator
}
...
func (m *PropertyRule) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["valuesJoinedBy"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ParseBinaryOperator)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetValuesJoinedBy(val.(*i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.BinaryOperator))
        }
        return nil
    }
    return res
...
func (m *PropertyRule) GetValuesJoinedBy()(*i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.BinaryOperator) {
...
func (m *PropertyRule) SetValuesJoinedBy(value *i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.BinaryOperator)() {
...
type PropertyRuleable interface {
    ...
    GetProperty()(*string)
    GetValues()([]string)
    GetValuesJoinedBy()(*i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.BinaryOperator)
    SetOdataType(value *string)()
    SetOperation(value *RuleOperation)()
    SetProperty(value *string)()
    SetValues(value []string)()
    SetValuesJoinedBy(value *i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.BinaryOperator)()
}

...
func CreateFederatedIdentityCredentialCollectionResponseFromDiscriminatorValue(
...
func (m *FederatedIdentityCredentialCollectionResponse) Serialize(
...
func (m *FederatedIdentityCredentialCollectionResponse) SetValue(
	value []FederatedIdentityCredentialable,
) {
	m.value = value
}

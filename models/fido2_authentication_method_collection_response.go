...
func CreateFido2AuthenticationMethodCollectionResponseFromDiscriminatorValue(
...
func (m *Fido2AuthenticationMethodCollectionResponse) Serialize(
...
func (m *Fido2AuthenticationMethodCollectionResponse) SetValue(
	value []Fido2AuthenticationMethodable,
) {
	m.value = value
}

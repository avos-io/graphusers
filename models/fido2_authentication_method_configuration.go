...
func CreateFido2AuthenticationMethodConfigurationFromDiscriminatorValue(
...
func (m *Fido2AuthenticationMethodConfiguration) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetIsSelfServiceRegistrationAllowed(),
		)
		if err != nil {
			return err
		}
...
func (m *Fido2AuthenticationMethodConfiguration) SetIncludeTargets(
...
func (m *Fido2AuthenticationMethodConfiguration) SetKeyRestrictions(
	value Fido2KeyRestrictionsable,
) {

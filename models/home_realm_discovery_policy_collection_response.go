...
func CreateHomeRealmDiscoveryPolicyCollectionResponseFromDiscriminatorValue(
...
func (m *HomeRealmDiscoveryPolicyCollectionResponse) Serialize(
...
func (m *HomeRealmDiscoveryPolicyCollectionResponse) SetValue(
	value []HomeRealmDiscoveryPolicyable,
) {
	m.value = value
}

...
func CreateIdentityApiConnectorFromDiscriminatorValue(
...
func (m *IdentityApiConnector) Serialize(
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetAuthenticationConfiguration(),
		)
		if err != nil {
			return err
		}
...
func (m *IdentityApiConnector) SetAuthenticationConfiguration(
	value ApiAuthenticationConfigurationBaseable,
) {

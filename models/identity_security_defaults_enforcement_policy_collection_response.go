...
func CreateIdentitySecurityDefaultsEnforcementPolicyCollectionResponseFromDiscriminatorValue(
...
func (m *IdentitySecurityDefaultsEnforcementPolicyCollectionResponse) Serialize(
...
func (m *IdentitySecurityDefaultsEnforcementPolicyCollectionResponse) SetValue(
	value []IdentitySecurityDefaultsEnforcementPolicyable,
) {
	m.value = value
}

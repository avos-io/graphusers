...
func CreateIdentityUserFlowAttributeAssignmentFromDiscriminatorValue(
...
func (m *IdentityUserFlowAttributeAssignment) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["userAttributeValues"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateUserAttributeValuesItemFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *IdentityUserFlowAttributeAssignment) Serialize(
...
func (m *IdentityUserFlowAttributeAssignment) SetUserAttribute(
...
func (m *IdentityUserFlowAttributeAssignment) SetUserAttributeValues(
...
func (m *IdentityUserFlowAttributeAssignment) SetUserInputType(
	value *IdentityUserFlowAttributeInputType,
) {

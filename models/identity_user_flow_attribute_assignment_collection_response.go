...
func CreateIdentityUserFlowAttributeAssignmentCollectionResponseFromDiscriminatorValue(
...
func (m *IdentityUserFlowAttributeAssignmentCollectionResponse) Serialize(
...
func (m *IdentityUserFlowAttributeAssignmentCollectionResponse) SetValue(
	value []IdentityUserFlowAttributeAssignmentable,
) {
	m.value = value
}

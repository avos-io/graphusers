...
func CreateImportedWindowsAutopilotDeviceIdentityFromDiscriminatorValue(
...
func (m *ImportedWindowsAutopilotDeviceIdentity) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["state"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateImportedWindowsAutopilotDeviceIdentityStateFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *ImportedWindowsAutopilotDeviceIdentity) Serialize(
...
func (m *ImportedWindowsAutopilotDeviceIdentity) SetState(
	value ImportedWindowsAutopilotDeviceIdentityStateable,
) {
	m.state = value
}

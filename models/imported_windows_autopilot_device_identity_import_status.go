...
func ParseImportedWindowsAutopilotDeviceIdentityImportStatus(v string) (any, error) {
	...
	default:
		return 0, errors.New(
			"Unknown ImportedWindowsAutopilotDeviceIdentityImportStatus value: " + v,
		)
	}
	return &result, nil
}

func SerializeImportedWindowsAutopilotDeviceIdentityImportStatus(
	values []ImportedWindowsAutopilotDeviceIdentityImportStatus,
) []string {

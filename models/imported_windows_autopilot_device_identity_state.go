...
func CreateImportedWindowsAutopilotDeviceIdentityStateFromDiscriminatorValue(
...
func (m *ImportedWindowsAutopilotDeviceIdentityState) Serialize(
...
func (m *ImportedWindowsAutopilotDeviceIdentityState) SetDeviceImportStatus(
	value *ImportedWindowsAutopilotDeviceIdentityImportStatus,
) {

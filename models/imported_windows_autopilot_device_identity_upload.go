...
func CreateImportedWindowsAutopilotDeviceIdentityUploadFromDiscriminatorValue(
...
func (m *ImportedWindowsAutopilotDeviceIdentityUpload) Serialize(
...
func (m *ImportedWindowsAutopilotDeviceIdentityUpload) SetCreatedDateTimeUtc(
...
func (m *ImportedWindowsAutopilotDeviceIdentityUpload) SetDeviceIdentities(
...
func (m *ImportedWindowsAutopilotDeviceIdentityUpload) SetStatus(
	value *ImportedWindowsAutopilotDeviceIdentityUploadStatus,
) {
	m.status = value
}

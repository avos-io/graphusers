...
func ParseImportedWindowsAutopilotDeviceIdentityUploadStatus(v string) (any, error) {
	...
	default:
		return 0, errors.New(
			"Unknown ImportedWindowsAutopilotDeviceIdentityUploadStatus value: " + v,
		)
	}
	return &result, nil
}

func SerializeImportedWindowsAutopilotDeviceIdentityUploadStatus(
	values []ImportedWindowsAutopilotDeviceIdentityUploadStatus,
) []string {

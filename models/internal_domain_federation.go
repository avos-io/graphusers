...
func CreateInternalDomainFederationFromDiscriminatorValue(
...
func (m *InternalDomainFederation) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetIsSignedAuthenticationRequestRequired(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetSigningCertificateUpdateStatus(),
		)
		if err != nil {
			return err
		}
...
func (m *InternalDomainFederation) SetSigningCertificateUpdateStatus(
	value SigningCertificateUpdateStatusable,
) {

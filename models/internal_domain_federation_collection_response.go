...
func CreateInternalDomainFederationCollectionResponseFromDiscriminatorValue(
...
func (m *InternalDomainFederationCollectionResponse) Serialize(
...
func (m *InternalDomainFederationCollectionResponse) SetValue(
	value []InternalDomainFederationable,
) {
	m.value = value
}

// InternalDomainFederationCollectionResponseable

...
func CreateIosCompliancePolicyFromDiscriminatorValue(
...
func (m *IosCompliancePolicy) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetManagedEmailProfileRequired(),
		)
		if err != nil {
			return err
		}
...
func (m *IosCompliancePolicy) SetDeviceThreatProtectionRequiredSecurityLevel(

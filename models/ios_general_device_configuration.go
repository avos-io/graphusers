...
func CreateIosGeneralDeviceConfigurationFromDiscriminatorValue(
...
func (m *IosGeneralDeviceConfiguration) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetActivationLockAllowWhenSupervised(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAirDropForceUnmanagedDropTarget(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAirPlayForcePairingPasswordForOutgoingRequests(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAppleWatchForceWristDetection(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetAppsSingleAppModeList() != nil {
		cast := make(
			...
			len(m.GetAppsSingleAppModeList()),
		)
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAppStoreBlockAutomaticDownloads(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAppStoreBlockInAppPurchases(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAppStoreBlockUIAppInstallation(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetCellularBlockGlobalBackgroundFetchWhileRoaming(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetCellularBlockPersonalHotspot(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetCertificatesBlockUntrustedTlsCertificates(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetClassroomAppBlockRemoteScreenObservation(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetClassroomAppForceUnpromptedScreenObservation(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetConfigurationProfileBlockChanges(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDeviceBlockEnableRestrictions(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDeviceBlockNameModification(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDiagnosticDataBlockSubmission(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDiagnosticDataBlockSubmissionModification(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDocumentsBlockManagedDocumentsInUnmanagedApps(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDocumentsBlockUnmanagedDocumentsInManagedApps(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEnterpriseAppBlockTrustModification(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetGamingBlockGameCenterFriends(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetICloudBlockActivityContinuation(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetICloudBlockSharedPhotoStream(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetICloudRequireEncryptedBackup(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetKioskModeAllowAssistiveSpeak(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetKioskModeAllowAssistiveTouchSettings(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetKioskModeAllowColorInversionSettings(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetKioskModeAllowScreenRotation(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetKioskModeAllowVoiceOverSettings(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetKioskModeAllowVolumeButtons(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetKioskModeRequireColorInversion(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetLockScreenBlockControlCenter(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetLockScreenBlockNotificationView(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetMediaContentRatingAustralia(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetMediaContentRatingNewZealand(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetMediaContentRatingUnitedKingdom(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetMediaContentRatingUnitedStates(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetNotificationsBlockSettingsModification(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetPasscodeBlockFingerprintModification(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetPasscodeBlockFingerprintUnlock(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetPasscodeMinimumCharacterSetCount(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetPasscodeMinutesOfInactivityBeforeLock(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetPasscodeMinutesOfInactivityBeforeScreenTimeout(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetPasscodeSignInFailureCountBeforeWipe(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetSafariPasswordAutoFillDomains() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetSafariPasswordAutoFillDomains(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSiriBlockUserGeneratedContent(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSpotlightBlockInternetResults(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWiFiConnectOnlyToConfiguredNetworks(),
		)
		if err != nil {
			return err
		}
...
func (m *IosGeneralDeviceConfiguration) SetAirPlayForcePairingPasswordForOutgoingRequests(
	value *bool,
) {
...
func (m *IosGeneralDeviceConfiguration) SetCellularBlockGlobalBackgroundFetchWhileRoaming(
	value *bool,
) {
...
func (m *IosGeneralDeviceConfiguration) SetClassroomAppForceUnpromptedScreenObservation(
	value *bool,
) {
...
func (m *IosGeneralDeviceConfiguration) SetDocumentsBlockManagedDocumentsInUnmanagedApps(
	value *bool,
) {
...
func (m *IosGeneralDeviceConfiguration) SetDocumentsBlockUnmanagedDocumentsInManagedApps(
	value *bool,
) {
...
func (m *IosGeneralDeviceConfiguration) SetMediaContentRatingAustralia(
	value MediaContentRatingAustraliaable,
) {
...
func (m *IosGeneralDeviceConfiguration) SetMediaContentRatingCanada(
	value MediaContentRatingCanadaable,
) {
...
func (m *IosGeneralDeviceConfiguration) SetMediaContentRatingFrance(
	value MediaContentRatingFranceable,
) {
...
func (m *IosGeneralDeviceConfiguration) SetMediaContentRatingGermany(
	value MediaContentRatingGermanyable,
) {
...
func (m *IosGeneralDeviceConfiguration) SetMediaContentRatingIreland(
	value MediaContentRatingIrelandable,
) {
...
func (m *IosGeneralDeviceConfiguration) SetMediaContentRatingJapan(
	value MediaContentRatingJapanable,
) {
...
func (m *IosGeneralDeviceConfiguration) SetMediaContentRatingNewZealand(
	value MediaContentRatingNewZealandable,
) {
...
func (m *IosGeneralDeviceConfiguration) SetMediaContentRatingUnitedKingdom(
	value MediaContentRatingUnitedKingdomable,
) {
...
func (m *IosGeneralDeviceConfiguration) SetMediaContentRatingUnitedStates(
	value MediaContentRatingUnitedStatesable,
) {
...
func (m *IosGeneralDeviceConfiguration) SetPasscodeMinutesOfInactivityBeforeScreenTimeout(
	value *int32,
) {

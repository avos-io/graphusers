...
func CreateIosGeneralDeviceConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *IosGeneralDeviceConfigurationCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateIosGeneralDeviceConfigurationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *IosGeneralDeviceConfigurationCollectionResponse) Serialize(
...
func (m *IosGeneralDeviceConfigurationCollectionResponse) SetValue(
	value []IosGeneralDeviceConfigurationable,
) {
	m.value = value
}

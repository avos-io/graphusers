...
func CreateIosUpdateConfigurationFromDiscriminatorValue(
...
func (m *IosUpdateConfiguration) Serialize(
	...
	if m.GetScheduledInstallDays() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			SerializeDayOfWeek(m.GetScheduledInstallDays()),
		)
		if err != nil {
			return err
		}
...
func (m *IosUpdateConfiguration) SetActiveHoursEnd(
...
func (m *IosUpdateConfiguration) SetActiveHoursStart(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.TimeOnly,
) {

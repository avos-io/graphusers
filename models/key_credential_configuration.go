...
func CreateKeyCredentialConfigurationFromDiscriminatorValue(
...
func (m *KeyCredentialConfiguration) Serialize(
...
func (m *KeyCredentialConfiguration) SetMaxLifetime(
...
func (m *KeyCredentialConfiguration) SetRestrictForAppsCreatedAfterDateTime(

...
func CreateKeyCredentialConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *KeyCredentialConfigurationCollectionResponse) Serialize(
...
func (m *KeyCredentialConfigurationCollectionResponse) SetValue(
	value []KeyCredentialConfigurationable,
) {
	m.value = value
}

// KeyCredentialConfigurationCollectionResponseable
type KeyCredentialConfigurationCollectionResponseable interface {

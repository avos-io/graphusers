...
func CreateLearningProviderFromDiscriminatorValue(
...
func (m *LearningProvider) Serialize(
	...
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetLongLogoWebUrlForDarkTheme(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetLongLogoWebUrlForLightTheme(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetSquareLogoWebUrlForDarkTheme(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetSquareLogoWebUrlForLightTheme(),
		)
		if err != nil {
			return err
		}

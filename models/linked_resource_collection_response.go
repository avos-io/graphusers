...
func CreateLinkedResourceCollectionResponseFromDiscriminatorValue(
...
func (m *LinkedResourceCollectionResponse) Serialize(
...
// LinkedResourceCollectionResponseable

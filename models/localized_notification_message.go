...
func CreateLocalizedNotificationMessageFromDiscriminatorValue(
...
func (m *LocalizedNotificationMessage) Serialize(
...
func (m *LocalizedNotificationMessage) SetLastModifiedDateTime(
...
// LocalizedNotificationMessageable

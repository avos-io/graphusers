...
func CreateLocalizedNotificationMessageCollectionResponseFromDiscriminatorValue(
...
func (m *LocalizedNotificationMessageCollectionResponse) Serialize(
...
func (m *LocalizedNotificationMessageCollectionResponse) SetValue(
	value []LocalizedNotificationMessageable,
) {
	m.value = value
}

...
func CreateLongRunningOperationCollectionResponseFromDiscriminatorValue(
...
func (m *LongRunningOperationCollectionResponse) Serialize(
...
// LongRunningOperationCollectionResponseable

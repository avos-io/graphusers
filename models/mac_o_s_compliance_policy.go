...
func CreateMacOSCompliancePolicyFromDiscriminatorValue(
...
func (m *MacOSCompliancePolicy) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSystemIntegrityProtectionEnabled(),
		)
		if err != nil {
			return err
		}
...
func (m *MacOSCompliancePolicy) SetDeviceThreatProtectionRequiredSecurityLevel(

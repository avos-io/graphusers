...
func CreateMacOSCustomConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *MacOSCustomConfigurationCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateMacOSCustomConfigurationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *MacOSCustomConfigurationCollectionResponse) Serialize(
...
func (m *MacOSCustomConfigurationCollectionResponse) SetValue(
	value []MacOSCustomConfigurationable,
) {
	m.value = value
}

// MacOSCustomConfigurationCollectionResponseable
type MacOSCustomConfigurationCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []MacOSCustomConfigurationable

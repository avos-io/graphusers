...
func CreateMacOSGeneralDeviceConfigurationFromDiscriminatorValue(
...
func (m *MacOSGeneralDeviceConfiguration) Serialize(
...
func (m *MacOSGeneralDeviceConfiguration) SetPasswordMinutesOfInactivityBeforeScreenTimeout(
	value *int32,
) {

...
func CreateManagedAndroidLobAppFromDiscriminatorValue(
...
func (m *ManagedAndroidLobApp) Serialize(
...
func (m *ManagedAndroidLobApp) SetMinimumSupportedOperatingSystem(

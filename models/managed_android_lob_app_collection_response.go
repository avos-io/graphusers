...
func CreateManagedAndroidLobAppCollectionResponseFromDiscriminatorValue(
...
func (m *ManagedAndroidLobAppCollectionResponse) Serialize(
...
// ManagedAndroidLobAppCollectionResponseable

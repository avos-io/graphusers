...
func CreateManagedAndroidStoreAppFromDiscriminatorValue(
...
func (m *ManagedAndroidStoreApp) Serialize(
...
func (m *ManagedAndroidStoreApp) SetMinimumSupportedOperatingSystem(

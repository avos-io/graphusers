...
func CreateManagedAppPolicyCollectionResponseFromDiscriminatorValue(
...
func (m *ManagedAppPolicyCollectionResponse) Serialize(
...
// ManagedAppPolicyCollectionResponseable

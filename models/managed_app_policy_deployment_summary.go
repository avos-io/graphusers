...
func CreateManagedAppPolicyDeploymentSummaryFromDiscriminatorValue(
...
func (m *ManagedAppPolicyDeploymentSummary) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["configurationDeploymentSummaryPerApp"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateManagedAppPolicyDeploymentSummaryPerAppFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *ManagedAppPolicyDeploymentSummary) Serialize(
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetConfigurationDeployedUserCount(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetConfigurationDeploymentSummaryPerApp() != nil {
		cast := make(
			...
			len(m.GetConfigurationDeploymentSummaryPerApp()),
		)
...
func (m *ManagedAppPolicyDeploymentSummary) SetConfigurationDeploymentSummaryPerApp(
...
func (m *ManagedAppPolicyDeploymentSummary) SetLastRefreshTime(

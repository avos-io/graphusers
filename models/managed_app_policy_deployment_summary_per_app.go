...
func CreateManagedAppPolicyDeploymentSummaryPerAppFromDiscriminatorValue(
...
func (m *ManagedAppPolicyDeploymentSummaryPerApp) Serialize(
	writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter,
) error {
	{
		err := writer.WriteInt32Value(
			"configurationAppliedUserCount",
			m.GetConfigurationAppliedUserCount(),
		)
		if err != nil {
			return err
		}
...
func (m *ManagedAppPolicyDeploymentSummaryPerApp) SetMobileAppIdentifier(
	value MobileAppIdentifierable,
) {

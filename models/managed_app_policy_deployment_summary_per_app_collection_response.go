...
func CreateManagedAppPolicyDeploymentSummaryPerAppCollectionResponseFromDiscriminatorValue(
...
func (m *ManagedAppPolicyDeploymentSummaryPerAppCollectionResponse) Serialize(
...
func (m *ManagedAppPolicyDeploymentSummaryPerAppCollectionResponse) SetValue(
	value []ManagedAppPolicyDeploymentSummaryPerAppable,
) {
	m.value = value
}

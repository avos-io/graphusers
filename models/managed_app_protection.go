...
func CreateManagedAppProtectionFromDiscriminatorValue(
...
func (m *ManagedAppProtection) Serialize(
	...
	if m.GetAllowedDataStorageLocations() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			SerializeManagedAppDataStorageLocation(m.GetAllowedDataStorageLocations()),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDisableAppPinIfDevicePinIsSet(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetManagedBrowserToOpenLinksRequired(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetOrganizationalCredentialsRequired(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteISODurationValue(
			...
			m.GetPeriodOfflineBeforeAccessCheck(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteISODurationValue(
			...
			m.GetPeriodOfflineBeforeWipeIsEnforced(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteISODurationValue(
			...
			m.GetPeriodOnlineBeforeAccessCheck(),
		)
		if err != nil {
			return err
		}
...
func (m *ManagedAppProtection) SetAllowedDataStorageLocations(
	value []ManagedAppDataStorageLocation,
) {
...
func (m *ManagedAppProtection) SetAllowedInboundDataTransferSources(
...
func (m *ManagedAppProtection) SetAllowedOutboundClipboardSharingLevel(
	value *ManagedAppClipboardSharingLevel,
) {
...
func (m *ManagedAppProtection) SetAllowedOutboundDataTransferDestinations(
	value *ManagedAppDataTransferLevel,
) {
...
func (m *ManagedAppProtection) SetPeriodBeforePinReset(
...
func (m *ManagedAppProtection) SetPeriodOfflineBeforeAccessCheck(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {
...
func (m *ManagedAppProtection) SetPeriodOfflineBeforeWipeIsEnforced(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {
...
func (m *ManagedAppProtection) SetPeriodOnlineBeforeAccessCheck(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {

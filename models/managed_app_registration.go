...
func (m *ManagedAppRegistration) Serialize(
	...
	if m.GetFlaggedReasons() != nil {
		err = writer.WriteCollectionOfStringValues(
			"flaggedReasons",
			SerializeManagedAppFlaggedReason(m.GetFlaggedReasons()),
		)
		if err != nil {
			return err
		}
...
func (m *ManagedAppRegistration) SetCreatedDateTime(
...
func (m *ManagedAppRegistration) SetLastSyncDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

...
func CreateManagedDeviceMobileAppConfigurationAssignmentFromDiscriminatorValue(
...
func (m *ManagedDeviceMobileAppConfigurationAssignment) Serialize(
...
func (m *ManagedDeviceMobileAppConfigurationAssignment) SetTarget(

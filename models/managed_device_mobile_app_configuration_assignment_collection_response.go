...
func CreateManagedDeviceMobileAppConfigurationAssignmentCollectionResponseFromDiscriminatorValue(
...
func (m *ManagedDeviceMobileAppConfigurationAssignmentCollectionResponse) Serialize(
...
func (m *ManagedDeviceMobileAppConfigurationAssignmentCollectionResponse) SetValue(
	value []ManagedDeviceMobileAppConfigurationAssignmentable,
) {
	m.value = value
}

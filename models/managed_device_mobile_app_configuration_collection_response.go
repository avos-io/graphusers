...
func CreateManagedDeviceMobileAppConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *ManagedDeviceMobileAppConfigurationCollectionResponse) Serialize(
...
func (m *ManagedDeviceMobileAppConfigurationCollectionResponse) SetValue(
	value []ManagedDeviceMobileAppConfigurationable,
) {
	m.value = value
}

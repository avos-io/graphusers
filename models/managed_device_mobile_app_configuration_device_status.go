...
func CreateManagedDeviceMobileAppConfigurationDeviceStatusFromDiscriminatorValue(
...
func (m *ManagedDeviceMobileAppConfigurationDeviceStatus) Serialize(
	...
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetComplianceGracePeriodExpirationDateTime(),
		)
		if err != nil {
			return err
		}
...
func (m *ManagedDeviceMobileAppConfigurationDeviceStatus) SetComplianceGracePeriodExpirationDateTime(
...
func (m *ManagedDeviceMobileAppConfigurationDeviceStatus) SetLastReportedDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

...
func CreateManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponseFromDiscriminatorValue(
...
func (m *ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse) Serialize(
...
func (m *ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse) SetValue(
	value []ManagedDeviceMobileAppConfigurationDeviceStatusable,
) {
	m.value = value
}
...
type ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []ManagedDeviceMobileAppConfigurationDeviceStatusable
	SetValue(value []ManagedDeviceMobileAppConfigurationDeviceStatusable)
}

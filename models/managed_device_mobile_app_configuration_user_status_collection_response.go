...
func CreateManagedDeviceMobileAppConfigurationUserStatusCollectionResponseFromDiscriminatorValue(
...
func (m *ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse) Serialize(
...
func (m *ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse) SetValue(
	value []ManagedDeviceMobileAppConfigurationUserStatusable,
) {
	m.value = value
}

...
func CreateManagedDeviceMobileAppConfigurationUserSummaryFromDiscriminatorValue(
...
func (m *ManagedDeviceMobileAppConfigurationUserSummary) Serialize(
...
func (m *ManagedDeviceMobileAppConfigurationUserSummary) SetLastUpdateDateTime(

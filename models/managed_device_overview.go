...
func CreateManagedDeviceOverviewFromDiscriminatorValue(
...
func (m *ManagedDeviceOverview) Serialize(
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetDeviceExchangeAccessStateSummary(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetDeviceOperatingSystemSummary(),
		)
		if err != nil {
			return err
		}
...
func (m *ManagedDeviceOverview) SetDeviceExchangeAccessStateSummary(
	value DeviceExchangeAccessStateSummaryable,
) {
...
func (m *ManagedDeviceOverview) SetDeviceOperatingSystemSummary(
	value DeviceOperatingSystemSummaryable,
) {

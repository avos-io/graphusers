...
func CreateManagedIOSLobAppCollectionResponseFromDiscriminatorValue(
...
func (m *ManagedIOSLobAppCollectionResponse) Serialize(
...
// ManagedIOSLobAppCollectionResponseable

...
func CreateMdmWindowsInformationProtectionPolicyCollectionResponseFromDiscriminatorValue(
...
func (m *MdmWindowsInformationProtectionPolicyCollectionResponse) Serialize(
...
func (m *MdmWindowsInformationProtectionPolicyCollectionResponse) SetValue(
	value []MdmWindowsInformationProtectionPolicyable,
) {
	m.value = value
}

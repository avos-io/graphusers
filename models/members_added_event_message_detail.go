...
func CreateMembersAddedEventMessageDetailFromDiscriminatorValue(
...
func (m *MembersAddedEventMessageDetail) Serialize(
	...
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetVisibleHistoryStartDateTime(),
		)
		if err != nil {
			return err
		}
...
func (m *MembersAddedEventMessageDetail) SetVisibleHistoryStartDateTime(

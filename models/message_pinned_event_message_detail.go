...
func CreateMessagePinnedEventMessageDetailFromDiscriminatorValue(
...
func (m *MessagePinnedEventMessageDetail) Serialize(
...
func (m *MessagePinnedEventMessageDetail) SetEventDateTime(
...
// MessagePinnedEventMessageDetailable

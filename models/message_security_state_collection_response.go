...
func CreateMessageSecurityStateCollectionResponseFromDiscriminatorValue(
...
func (m *MessageSecurityStateCollectionResponse) Serialize(
...
// MessageSecurityStateCollectionResponseable
type MessageSecurityStateCollectionResponseable interface {

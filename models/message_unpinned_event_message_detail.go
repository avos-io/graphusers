...
func CreateMessageUnpinnedEventMessageDetailFromDiscriminatorValue(
...
func (m *MessageUnpinnedEventMessageDetail) Serialize(
...
func (m *MessageUnpinnedEventMessageDetail) SetEventDateTime(

...
func CreateMicrosoftAccountUserConversationMemberCollectionResponseFromDiscriminatorValue(
...
func (m *MicrosoftAccountUserConversationMemberCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateMicrosoftAccountUserConversationMemberFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]MicrosoftAccountUserConversationMemberable, len(val))
			for i, v := range val {
				res[i] = v.(MicrosoftAccountUserConversationMemberable)
			}
			m.SetValue(res)
		}
		return nil
...
func (m *MicrosoftAccountUserConversationMemberCollectionResponse) Serialize(
...
func (m *MicrosoftAccountUserConversationMemberCollectionResponse) SetValue(
	value []MicrosoftAccountUserConversationMemberable,
) {
	m.value = value
}

// MicrosoftAccountUserConversationMemberCollectionResponseable
type MicrosoftAccountUserConversationMemberCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []MicrosoftAccountUserConversationMemberable
	SetValue(value []MicrosoftAccountUserConversationMemberable)
}

...
func CreateMicrosoftAuthenticatorAuthenticationMethodCollectionResponseFromDiscriminatorValue(
...
func (m *MicrosoftAuthenticatorAuthenticationMethodCollectionResponse) Serialize(
...
func (m *MicrosoftAuthenticatorAuthenticationMethodCollectionResponse) SetValue(
	value []MicrosoftAuthenticatorAuthenticationMethodable,
) {
	m.value = value
}

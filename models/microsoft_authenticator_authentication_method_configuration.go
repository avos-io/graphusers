...
func CreateMicrosoftAuthenticatorAuthenticationMethodConfigurationFromDiscriminatorValue(
...
func (m *MicrosoftAuthenticatorAuthenticationMethodConfiguration) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["featureSettings"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateMicrosoftAuthenticatorFeatureSettingsFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *MicrosoftAuthenticatorAuthenticationMethodConfiguration) Serialize(
...
func (m *MicrosoftAuthenticatorAuthenticationMethodConfiguration) SetFeatureSettings(
	value MicrosoftAuthenticatorFeatureSettingsable,
) {
...
func (m *MicrosoftAuthenticatorAuthenticationMethodConfiguration) SetIncludeTargets(

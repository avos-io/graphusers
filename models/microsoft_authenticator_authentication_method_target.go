...
func CreateMicrosoftAuthenticatorAuthenticationMethodTargetFromDiscriminatorValue(
...
func (m *MicrosoftAuthenticatorAuthenticationMethodTarget) Serialize(
...
func (m *MicrosoftAuthenticatorAuthenticationMethodTarget) SetAuthenticationMode(
	value *MicrosoftAuthenticatorAuthenticationMode,
) {

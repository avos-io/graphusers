...
func CreateMicrosoftAuthenticatorFeatureSettingsFromDiscriminatorValue(
...
func (m *MicrosoftAuthenticatorFeatureSettings) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["displayAppInformationRequiredState"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateAuthenticationMethodFeatureConfigurationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetDisplayAppInformationRequiredState(
	...
	res["displayLocationInformationRequiredState"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		...
		if val != nil {
			m.SetDisplayLocationInformationRequiredState(
				val.(AuthenticationMethodFeatureConfigurationable),
			)
		}
		return nil
...
func (m *MicrosoftAuthenticatorFeatureSettings) Serialize(
	writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter,
) error {
	{
		err := writer.WriteObjectValue(
			"displayAppInformationRequiredState",
			m.GetDisplayAppInformationRequiredState(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteObjectValue(
			...
			m.GetDisplayLocationInformationRequiredState(),
		)
		if err != nil {
			return err
		}
...
func (m *MicrosoftAuthenticatorFeatureSettings) SetDisplayAppInformationRequiredState(
	value AuthenticationMethodFeatureConfigurationable,
) {
...
func (m *MicrosoftAuthenticatorFeatureSettings) SetDisplayLocationInformationRequiredState(
	value AuthenticationMethodFeatureConfigurationable,
) {

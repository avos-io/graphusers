...
func CreateMobileAppContentFileFromDiscriminatorValue(
...
func (m *MobileAppContentFile) Serialize(
	...
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetAzureStorageUriExpirationDateTime(),
		)
		if err != nil {
			return err
		}
...
func (m *MobileAppContentFile) SetAzureStorageUriExpirationDateTime(
...
func (m *MobileAppContentFile) SetCreatedDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

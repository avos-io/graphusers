...
type MobileAppContentFileCollectionResponse struct {
	...
	// The value property
	value []MobileAppContentFileable
}
...
func CreateMobileAppContentFileCollectionResponseFromDiscriminatorValue(
...
func (m *MobileAppContentFileCollectionResponse) Serialize(

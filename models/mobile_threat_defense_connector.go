...
func CreateMobileThreatDefenseConnectorFromDiscriminatorValue(
...
func (m *MobileThreatDefenseConnector) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAllowPartnerToCollectIOSApplicationMetadata(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAndroidDeviceBlockedOnMissingPartnerData(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAndroidMobileApplicationManagementEnabled(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetIosDeviceBlockedOnMissingPartnerData(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetIosMobileApplicationManagementEnabled(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetMicrosoftDefenderForEndpointAttachEnabled(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetPartnerUnresponsivenessThresholdInDays(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWindowsDeviceBlockedOnMissingPartnerData(),
		)
		if err != nil {
			return err
		}
...
func (m *MobileThreatDefenseConnector) SetAllowPartnerToCollectIOSPersonalApplicationMetadata(
	value *bool,
) {
...
func (m *MobileThreatDefenseConnector) SetLastHeartbeatDateTime(

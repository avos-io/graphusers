...
func CreateMobileThreatDefenseConnectorCollectionResponseFromDiscriminatorValue(
...
func (m *MobileThreatDefenseConnectorCollectionResponse) Serialize(
...
func (m *MobileThreatDefenseConnectorCollectionResponse) SetValue(
	value []MobileThreatDefenseConnectorable,
) {
	m.value = value
}

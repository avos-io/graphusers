...
func CreateMultiValueLegacyExtendedPropertyCollectionResponseFromDiscriminatorValue(
...
func (m *MultiValueLegacyExtendedPropertyCollectionResponse) Serialize(
...
func (m *MultiValueLegacyExtendedPropertyCollectionResponse) SetValue(
	value []MultiValueLegacyExtendedPropertyable,
) {
	m.value = value
}
...
type MultiValueLegacyExtendedPropertyCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []MultiValueLegacyExtendedPropertyable

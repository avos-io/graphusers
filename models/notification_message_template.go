...
func CreateNotificationMessageTemplateFromDiscriminatorValue(
...
func (m *NotificationMessageTemplate) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["localizedNotificationMessages"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateLocalizedNotificationMessageFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *NotificationMessageTemplate) Serialize(
	...
	if m.GetLocalizedNotificationMessages() != nil {
		cast := make(
			...
			len(m.GetLocalizedNotificationMessages()),
		)
...
func (m *NotificationMessageTemplate) SetBrandingOptions(
	value *NotificationTemplateBrandingOptions,
) {
...
func (m *NotificationMessageTemplate) SetLastModifiedDateTime(
...
func (m *NotificationMessageTemplate) SetLocalizedNotificationMessages(

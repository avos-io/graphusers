...
func CreateNotificationMessageTemplateCollectionResponseFromDiscriminatorValue(
...
func (m *NotificationMessageTemplateCollectionResponse) Serialize(
...
func (m *NotificationMessageTemplateCollectionResponse) SetValue(
	value []NotificationMessageTemplateable,
) {
	m.value = value
}

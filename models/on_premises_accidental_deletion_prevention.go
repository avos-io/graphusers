...
func CreateOnPremisesAccidentalDeletionPreventionFromDiscriminatorValue(
...
func (m *OnPremisesAccidentalDeletionPrevention) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["synchronizationPreventionType"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		...
		if val != nil {
			m.SetSynchronizationPreventionType(
				val.(*OnPremisesDirectorySynchronizationDeletionPreventionType),
			)
		}
		return nil
	}
...
func (m *OnPremisesAccidentalDeletionPrevention) Serialize(
...
func (m *OnPremisesAccidentalDeletionPrevention) SetSynchronizationPreventionType(
...
type OnPremisesAccidentalDeletionPreventionable interface {
	...
	SetSynchronizationPreventionType(
		value *OnPremisesDirectorySynchronizationDeletionPreventionType,
	)
}

...
func CreateOnPremisesDirectorySynchronizationFromDiscriminatorValue(
...
func (m *OnPremisesDirectorySynchronization) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["configuration"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateOnPremisesDirectorySynchronizationConfigurationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
	...
	res["features"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateOnPremisesDirectorySynchronizationFeatureFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *OnPremisesDirectorySynchronization) Serialize(
...
func (m *OnPremisesDirectorySynchronization) SetConfiguration(
...
func (m *OnPremisesDirectorySynchronization) SetFeatures(
	value OnPremisesDirectorySynchronizationFeatureable,
) {
	m.features = value
}

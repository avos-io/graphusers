...
func CreateOnPremisesDirectorySynchronizationCollectionResponseFromDiscriminatorValue(
...
func (m *OnPremisesDirectorySynchronizationCollectionResponse) Serialize(
...
func (m *OnPremisesDirectorySynchronizationCollectionResponse) SetValue(
	value []OnPremisesDirectorySynchronizationable,
) {
	m.value = value
}

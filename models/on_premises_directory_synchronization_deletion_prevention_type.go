...
func ParseOnPremisesDirectorySynchronizationDeletionPreventionType(v string) (any, error) {
	...
	default:
		return 0, errors.New(
			"Unknown OnPremisesDirectorySynchronizationDeletionPreventionType value: " + v,
		)
	}
	return &result, nil
}

func SerializeOnPremisesDirectorySynchronizationDeletionPreventionType(
	values []OnPremisesDirectorySynchronizationDeletionPreventionType,
) []string {

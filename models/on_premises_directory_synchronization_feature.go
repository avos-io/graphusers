...
func CreateOnPremisesDirectorySynchronizationFeatureFromDiscriminatorValue(
...
func (m *OnPremisesDirectorySynchronizationFeature) Serialize(
	writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter,
) error {
	{
		err := writer.WriteBoolValue(
			"blockCloudObjectTakeoverThroughHardMatchEnabled",
			m.GetBlockCloudObjectTakeoverThroughHardMatchEnabled(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetBypassDirSyncOverridesEnabled(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetCloudPasswordPolicyForPasswordSyncedUsersEnabled(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetConcurrentCredentialUpdateEnabled(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetConcurrentOrgIdProvisioningEnabled(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetDirectoryExtensionsEnabled(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetFopeConflictResolutionEnabled(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetQuarantineUponProxyAddressesConflictEnabled(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetQuarantineUponUpnConflictEnabled(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetSynchronizeUpnForManagedUsersEnabled(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetUnifiedGroupWritebackEnabled(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetUserForcePasswordChangeOnLogonEnabled(),
		)
		if err != nil {
			return err
		}
...
func (m *OnPremisesDirectorySynchronizationFeature) SetBlockCloudObjectTakeoverThroughHardMatchEnabled(
	value *bool,
) {
...
func (m *OnPremisesDirectorySynchronizationFeature) SetCloudPasswordPolicyForPasswordSyncedUsersEnabled(
	value *bool,
) {
...
func (m *OnPremisesDirectorySynchronizationFeature) SetConcurrentCredentialUpdateEnabled(
	value *bool,
) {
...
func (m *OnPremisesDirectorySynchronizationFeature) SetConcurrentOrgIdProvisioningEnabled(
	value *bool,
) {
...
func (m *OnPremisesDirectorySynchronizationFeature) SetQuarantineUponProxyAddressesConflictEnabled(
	value *bool,
) {
...
func (m *OnPremisesDirectorySynchronizationFeature) SetQuarantineUponUpnConflictEnabled(
	value *bool,
) {
...
func (m *OnPremisesDirectorySynchronizationFeature) SetSynchronizeUpnForManagedUsersEnabled(
	value *bool,
) {
...
func (m *OnPremisesDirectorySynchronizationFeature) SetUserForcePasswordChangeOnLogonEnabled(
	value *bool,
) {

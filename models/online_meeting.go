...
func (m *OnlineMeeting) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["attendanceReports"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateMeetingAttendanceReportFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *OnlineMeeting) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAllowAttendeeToEnableCamera(),
		)
		if err != nil {
			return err
		}
...
func (m *OnlineMeeting) SetCreationDateTime(
...
func (m *OnlineMeeting) SetEndDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {
	m.endDateTime = value
}
...
func (m *OnlineMeeting) SetStartDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

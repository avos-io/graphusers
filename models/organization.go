...
func CreateOrganizationFromDiscriminatorValue(
...
func (m *Organization) Serialize(
	...
	if m.GetCertificateBasedAuthConfiguration() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetCertificateBasedAuthConfiguration()),
		)
	...
	if m.GetMarketingNotificationEmails() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetMarketingNotificationEmails(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetSecurityComplianceNotificationMails() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetSecurityComplianceNotificationMails(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetSecurityComplianceNotificationPhones() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetSecurityComplianceNotificationPhones(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetTechnicalNotificationMails() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetTechnicalNotificationMails(),
		)
		if err != nil {
			return err
		}
...
func (m *Organization) SetCertificateBasedAuthConfiguration(
...
func (m *Organization) SetCreatedDateTime(
...
func (m *Organization) SetOnPremisesLastSyncDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

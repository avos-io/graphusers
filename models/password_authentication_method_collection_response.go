...
func CreatePasswordAuthenticationMethodCollectionResponseFromDiscriminatorValue(
...
func (m *PasswordAuthenticationMethodCollectionResponse) Serialize(
...
func (m *PasswordAuthenticationMethodCollectionResponse) SetValue(
	value []PasswordAuthenticationMethodable,
) {
	m.value = value
}

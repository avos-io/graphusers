...
func CreatePasswordCredentialConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *PasswordCredentialConfigurationCollectionResponse) Serialize(
...
func (m *PasswordCredentialConfigurationCollectionResponse) SetValue(
	value []PasswordCredentialConfigurationable,
) {
	m.value = value
}

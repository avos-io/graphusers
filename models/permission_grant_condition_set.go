...
func CreatePermissionGrantConditionSetFromDiscriminatorValue(
...
func (m *PermissionGrantConditionSet) Serialize(
	...
	if m.GetClientApplicationPublisherIds() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetClientApplicationPublisherIds(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetClientApplicationTenantIds() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetClientApplicationTenantIds(),
		)
		if err != nil {
			return err
		}

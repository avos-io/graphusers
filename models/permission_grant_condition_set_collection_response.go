...
func CreatePermissionGrantConditionSetCollectionResponseFromDiscriminatorValue(
...
func (m *PermissionGrantConditionSetCollectionResponse) Serialize(
...
func (m *PermissionGrantConditionSetCollectionResponse) SetValue(
	value []PermissionGrantConditionSetable,
) {
	m.value = value
}

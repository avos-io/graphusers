...
func CreatePhoneAuthenticationMethodCollectionResponseFromDiscriminatorValue(
...
func (m *PhoneAuthenticationMethodCollectionResponse) Serialize(
...
func (m *PhoneAuthenticationMethodCollectionResponse) SetValue(
	value []PhoneAuthenticationMethodable,
) {
	m.value = value
}

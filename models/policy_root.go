...
func CreatePolicyRootFromDiscriminatorValue(
...
func (m *PolicyRoot) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["activityBasedTimeoutPolicies"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateActivityBasedTimeoutPolicyFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
	...
	res["identitySecurityDefaultsEnforcementPolicy"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateIdentitySecurityDefaultsEnforcementPolicyFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetIdentitySecurityDefaultsEnforcementPolicy(
				val.(IdentitySecurityDefaultsEnforcementPolicyable),
			)
		}
		return nil
	}
	...
	res["roleManagementPolicies"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateUnifiedRoleManagementPolicyFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *PolicyRoot) Serialize(
	...
	if m.GetActivityBasedTimeoutPolicies() != nil {
		cast := make(
			...
			len(m.GetActivityBasedTimeoutPolicies()),
		)
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetAuthenticationMethodsPolicy(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetConditionalAccessPolicies() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetConditionalAccessPolicies()),
		)
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetDefaultAppManagementPolicy(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetFeatureRolloutPolicies() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetFeatureRolloutPolicies()),
		)
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetIdentitySecurityDefaultsEnforcementPolicy(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetPermissionGrantPolicies() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetPermissionGrantPolicies()),
		)
	...
	if m.GetRoleManagementPolicies() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetRoleManagementPolicies()),
		)
	...
	if m.GetRoleManagementPolicyAssignments() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetRoleManagementPolicyAssignments()),
		)
...
func (m *PolicyRoot) SetIdentitySecurityDefaultsEnforcementPolicy(
...
func (m *PolicyRoot) SetRoleManagementPolicyAssignments(

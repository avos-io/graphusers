...
func CreatePreAuthorizedApplicationCollectionResponseFromDiscriminatorValue(
...
func (m *PreAuthorizedApplicationCollectionResponse) Serialize(
...
func (m *PreAuthorizedApplicationCollectionResponse) SetValue(
	value []PreAuthorizedApplicationable,
) {
	m.value = value
}

// PreAuthorizedApplicationCollectionResponseable
type PreAuthorizedApplicationCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []PreAuthorizedApplicationable
	SetValue(value []PreAuthorizedApplicationable)
}

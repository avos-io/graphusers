...
func CreatePrintUsageFromDiscriminatorValue(
...
func (m *PrintUsage) Serialize(
	...
	{
		err = writer.WriteInt64Value(
			"completedBlackAndWhiteJobCount",
			m.GetCompletedBlackAndWhiteJobCount(),
		)
		if err != nil {
			return err
		}
...
func (m *PrintUsage) SetUsageDate(

...
func CreateProcessFromDiscriminatorValue(
...
func (m *Process) Serialize(
	...
	}
	{
		err := writer.WriteTimeValue(
			...
			m.GetParentProcessCreatedDateTime(),
		)
		if err != nil {
			return err
		}
...
func (m *Process) SetCreatedDateTime(
...
func (m *Process) SetParentProcessCreatedDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

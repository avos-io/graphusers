...
func CreateProvisioningObjectSummaryFromDiscriminatorValue(
...
func (m *ProvisioningObjectSummary) Serialize(
...
func (m *ProvisioningObjectSummary) SetActivityDateTime(

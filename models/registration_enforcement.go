...
func CreateRegistrationEnforcementFromDiscriminatorValue(
...
func (m *RegistrationEnforcement) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["authenticationMethodsRegistrationCampaign"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateAuthenticationMethodsRegistrationCampaignFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetAuthenticationMethodsRegistrationCampaign(
				val.(AuthenticationMethodsRegistrationCampaignable),
			)
		}
		return nil
	}
...
func (m *RegistrationEnforcement) Serialize(
	writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter,
) error {
	{
		err := writer.WriteObjectValue(
			"authenticationMethodsRegistrationCampaign",
			m.GetAuthenticationMethodsRegistrationCampaign(),
		)
		if err != nil {
			return err
		}
...
func (m *RegistrationEnforcement) SetAuthenticationMethodsRegistrationCampaign(
	value AuthenticationMethodsRegistrationCampaignable,
) {

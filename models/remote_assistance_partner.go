...
func CreateRemoteAssistancePartnerFromDiscriminatorValue(
...
func (m *RemoteAssistancePartner) Serialize(
...
func (m *RemoteAssistancePartner) SetLastConnectionDateTime(

...
type RemoteAssistancePartnerCollectionResponse struct {
	...
	// The value property
	value []RemoteAssistancePartnerable
}
...
func CreateRemoteAssistancePartnerCollectionResponseFromDiscriminatorValue(
...
func (m *RemoteAssistancePartnerCollectionResponse) Serialize(

...
func CreateRequestScheduleFromDiscriminatorValue(
...
func (m *RequestSchedule) Serialize(
...
func (m *RequestSchedule) SetStartDateTime(
...
// RequestScheduleable
type RequestScheduleable interface {

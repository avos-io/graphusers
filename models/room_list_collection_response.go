...
func CreateRoomListCollectionResponseFromDiscriminatorValue(
...
func (m *RoomListCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateRoomListFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]RoomListable, len(val))
			for i, v := range val {
				res[i] = v.(RoomListable)
			}
			m.SetValue(res)
		}
		return nil
...
func (m *RoomListCollectionResponse) Serialize(
...
// RoomListCollectionResponseable
type RoomListCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []RoomListable
	SetValue(value []RoomListable)
}

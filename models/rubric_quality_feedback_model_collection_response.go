...
func CreateRubricQualityFeedbackModelCollectionResponseFromDiscriminatorValue(
...
func (m *RubricQualityFeedbackModelCollectionResponse) Serialize(
...
func (m *RubricQualityFeedbackModelCollectionResponse) SetValue(
	value []RubricQualityFeedbackModelable,
) {
	m.value = value
}

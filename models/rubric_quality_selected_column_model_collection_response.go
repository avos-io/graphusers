...
func CreateRubricQualitySelectedColumnModelCollectionResponseFromDiscriminatorValue(
...
func (m *RubricQualitySelectedColumnModelCollectionResponse) Serialize(
...
func (m *RubricQualitySelectedColumnModelCollectionResponse) SetValue(
	value []RubricQualitySelectedColumnModelable,
) {
	m.value = value
}

// RubricQualitySelectedColumnModelCollectionResponseable
type RubricQualitySelectedColumnModelCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []RubricQualitySelectedColumnModelable
	SetValue(value []RubricQualitySelectedColumnModelable)
}

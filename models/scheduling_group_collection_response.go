...
func CreateSchedulingGroupCollectionResponseFromDiscriminatorValue(
...
func (m *SchedulingGroupCollectionResponse) Serialize(
...
// SchedulingGroupCollectionResponseable

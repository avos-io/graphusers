...
func CreateSecureScoreFromDiscriminatorValue(
...
func (m *SecureScore) Serialize(
	...
	if m.GetAverageComparativeScores() != nil {
		cast := make(
			...
			len(m.GetAverageComparativeScores()),
		)
...
func (m *SecureScore) SetCreatedDateTime(

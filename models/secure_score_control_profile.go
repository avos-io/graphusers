...
func CreateSecureScoreControlProfileFromDiscriminatorValue(
...
func (m *SecureScoreControlProfile) Serialize(
	...
	if m.GetComplianceInformation() != nil {
		cast := make(
			...
			len(m.GetComplianceInformation()),
		)
...
func (m *SecureScoreControlProfile) SetControlStateUpdates(
...
func (m *SecureScoreControlProfile) SetLastModifiedDateTime(

...
func CreateSecureScoreControlStateUpdateFromDiscriminatorValue(
...
func (m *SecureScoreControlStateUpdate) Serialize(
...
func (m *SecureScoreControlStateUpdate) SetUpdatedDateTime(

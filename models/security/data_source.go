...
// DataSource provides operations to manage the collection of user entities.
...
func (m *DataSource) SetCreatedBy(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.IdentitySetable)() {
    m.createdBy = value
}

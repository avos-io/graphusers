...
func (m *EdiscoverySearch) Serialize(
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetLastEstimateStatisticsOperation(),
		)
		if err != nil {
			return err
		}
...
func (m *EdiscoverySearch) SetLastEstimateStatisticsOperation(

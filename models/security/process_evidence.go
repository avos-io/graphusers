...
func (m *ProcessEvidence) Serialize(
	...
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetParentProcessCreationDateTime(),
		)
		if err != nil {
			return err
		}
...
func (m *ProcessEvidence) SetParentProcessCreationDateTime(
...
func (m *ProcessEvidence) SetProcessCreationDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

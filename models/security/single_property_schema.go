...
func CreateSinglePropertySchemaFromDiscriminatorValue(
...
func (m *SinglePropertySchema) Serialize(
...
// SinglePropertySchemaable
type SinglePropertySchemaable interface {

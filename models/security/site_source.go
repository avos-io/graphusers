...
func (m *SiteSource) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["site"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.CreateSiteFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetSite(
				val.(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Siteable),
			)
		}
		return nil
	}

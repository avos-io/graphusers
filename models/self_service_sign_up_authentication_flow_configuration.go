...
func CreateSelfServiceSignUpAuthenticationFlowConfigurationFromDiscriminatorValue(
...
func (m *SelfServiceSignUpAuthenticationFlowConfiguration) Serialize(
...
// SelfServiceSignUpAuthenticationFlowConfigurationable

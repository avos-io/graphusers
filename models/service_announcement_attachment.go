...
func CreateServiceAnnouncementAttachmentFromDiscriminatorValue(
...
func (m *ServiceAnnouncementAttachment) Serialize(
...
func (m *ServiceAnnouncementAttachment) SetLastModifiedDateTime(
...
type ServiceAnnouncementAttachmentable interface {
	Entityable

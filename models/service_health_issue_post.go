...
func CreateServiceHealthIssuePostFromDiscriminatorValue(
...
func (m *ServiceHealthIssuePost) Serialize(
...
func (m *ServiceHealthIssuePost) SetCreatedDateTime(
...
// ServiceHealthIssuePostable
type ServiceHealthIssuePostable interface {

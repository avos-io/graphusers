...
func CreateServicePrincipalRiskDetectionFromDiscriminatorValue(
...
func (m *ServicePrincipalRiskDetection) Serialize(
	...
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetServicePrincipalDisplayName(),
		)
		if err != nil {
			return err
		}
...
func (m *ServicePrincipalRiskDetection) SetActivityDateTime(
...
func (m *ServicePrincipalRiskDetection) SetDetectedDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {

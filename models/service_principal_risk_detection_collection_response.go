...
func CreateServicePrincipalRiskDetectionCollectionResponseFromDiscriminatorValue(
...
func (m *ServicePrincipalRiskDetectionCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateServicePrincipalRiskDetectionFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *ServicePrincipalRiskDetectionCollectionResponse) Serialize(
...
func (m *ServicePrincipalRiskDetectionCollectionResponse) SetValue(
	value []ServicePrincipalRiskDetectionable,
) {
	m.value = value
}

...
func CreateSettingStateDeviceSummaryCollectionResponseFromDiscriminatorValue(
...
func (m *SettingStateDeviceSummaryCollectionResponse) Serialize(
...
func (m *SettingStateDeviceSummaryCollectionResponse) SetValue(
	value []SettingStateDeviceSummaryable,
) {
	m.value = value
}

// SettingStateDeviceSummaryCollectionResponseable

...
func CreateSharedDriveItemCollectionResponseFromDiscriminatorValue(
...
func (m *SharedDriveItemCollectionResponse) Serialize(
...
// SharedDriveItemCollectionResponseable

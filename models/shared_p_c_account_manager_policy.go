...
func CreateSharedPCAccountManagerPolicyFromDiscriminatorValue(
...
func (m *SharedPCAccountManagerPolicy) Serialize(
	...
	}
	{
		err := writer.WriteInt32Value(
			...
			m.GetCacheAccountsAboveDiskFreePercentage(),
		)
		if err != nil {
			return err
		}
...
func (m *SharedPCAccountManagerPolicy) SetAccountDeletionPolicy(
	value *SharedPCAccountDeletionPolicyType,
) {

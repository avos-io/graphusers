...
func CreateSharedPCConfigurationFromDiscriminatorValue(
...
func (m *SharedPCConfiguration) Serialize(
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetIdleTimeBeforeSleepInSeconds(),
		)
		if err != nil {
			return err
		}
...
func (m *SharedPCConfiguration) SetMaintenanceStartTime(

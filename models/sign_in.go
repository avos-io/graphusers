...
func CreateSignInFromDiscriminatorValue(
...
func (m *SignIn) Serialize(
	...
	if m.GetAppliedConditionalAccessPolicies() != nil {
		cast := make(
			...
			len(m.GetAppliedConditionalAccessPolicies()),
		)
	...
	if m.GetRiskEventTypes() != nil {
		err = writer.WriteCollectionOfStringValues(
			"riskEventTypes",
			SerializeRiskEventType(m.GetRiskEventTypes()),
		)
		if err != nil {
			return err
		}
...
func (m *SignIn) SetCreatedDateTime(

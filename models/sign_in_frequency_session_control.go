...
func CreateSignInFrequencySessionControlFromDiscriminatorValue(
...
func (m *SignInFrequencySessionControl) Serialize(
...
func (m *SignInFrequencySessionControl) SetAuthenticationType(
	value *SignInFrequencyAuthenticationType,
) {

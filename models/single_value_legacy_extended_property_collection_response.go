...
func CreateSingleValueLegacyExtendedPropertyCollectionResponseFromDiscriminatorValue(
...
func (m *SingleValueLegacyExtendedPropertyCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateSingleValueLegacyExtendedPropertyFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *SingleValueLegacyExtendedPropertyCollectionResponse) Serialize(
...
func (m *SingleValueLegacyExtendedPropertyCollectionResponse) SetValue(
	value []SingleValueLegacyExtendedPropertyable,
) {
	m.value = value
}
...
type SingleValueLegacyExtendedPropertyCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []SingleValueLegacyExtendedPropertyable
	SetValue(value []SingleValueLegacyExtendedPropertyable)
}

...
func CreateSoftwareOathAuthenticationMethodCollectionResponseFromDiscriminatorValue(
...
func (m *SoftwareOathAuthenticationMethodCollectionResponse) Serialize(
...
func (m *SoftwareOathAuthenticationMethodCollectionResponse) SetValue(
	value []SoftwareOathAuthenticationMethodable,
) {
	m.value = value
}

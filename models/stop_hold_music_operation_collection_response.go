...
func CreateStopHoldMusicOperationCollectionResponseFromDiscriminatorValue(
...
func (m *StopHoldMusicOperationCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateStopHoldMusicOperationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]StopHoldMusicOperationable, len(val))
			for i, v := range val {
				res[i] = v.(StopHoldMusicOperationable)
			}
			m.SetValue(res)
		}
		return nil
...
func (m *StopHoldMusicOperationCollectionResponse) Serialize(
...
// StopHoldMusicOperationCollectionResponseable
type StopHoldMusicOperationCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []StopHoldMusicOperationable
	SetValue(value []StopHoldMusicOperationable)
}

...
func CreateSubjectRightsRequestHistoryFromDiscriminatorValue(
...
func (m *SubjectRightsRequestHistory) Serialize(
...
func (m *SubjectRightsRequestHistory) SetEventDateTime(

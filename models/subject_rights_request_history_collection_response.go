...
func CreateSubjectRightsRequestHistoryCollectionResponseFromDiscriminatorValue(
...
func (m *SubjectRightsRequestHistoryCollectionResponse) Serialize(
...
func (m *SubjectRightsRequestHistoryCollectionResponse) SetValue(
	value []SubjectRightsRequestHistoryable,
) {
	m.value = value
}

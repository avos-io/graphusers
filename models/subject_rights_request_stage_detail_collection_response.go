...
func CreateSubjectRightsRequestStageDetailCollectionResponseFromDiscriminatorValue(
...
func (m *SubjectRightsRequestStageDetailCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateSubjectRightsRequestStageDetailFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *SubjectRightsRequestStageDetailCollectionResponse) Serialize(
...
func (m *SubjectRightsRequestStageDetailCollectionResponse) SetValue(
	value []SubjectRightsRequestStageDetailable,
) {
	m.value = value
}

// SubjectRightsRequestStageDetailCollectionResponseable
type SubjectRightsRequestStageDetailCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []SubjectRightsRequestStageDetailable
	SetValue(value []SubjectRightsRequestStageDetailable)
}

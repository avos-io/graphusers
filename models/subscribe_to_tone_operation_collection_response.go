...
type SubscribeToToneOperationCollectionResponse struct {
	...
	// The value property
	value []SubscribeToToneOperationable
}
...
func CreateSubscribeToToneOperationCollectionResponseFromDiscriminatorValue(
...
func (m *SubscribeToToneOperationCollectionResponse) Serialize(
...
func (m *SubscribeToToneOperationCollectionResponse) SetValue(
	value []SubscribeToToneOperationable,
) {
	m.value = value
}

...
func CreateSwapShiftsChangeRequestCollectionResponseFromDiscriminatorValue(
...
func (m *SwapShiftsChangeRequestCollectionResponse) Serialize(
...
// SwapShiftsChangeRequestCollectionResponseable

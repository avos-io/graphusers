...
func CreateTargetedManagedAppConfigurationFromDiscriminatorValue(
...
func (m *TargetedManagedAppConfiguration) Serialize(
...
func (m *TargetedManagedAppConfiguration) SetAssignments(
...
func (m *TargetedManagedAppConfiguration) SetDeploymentSummary(

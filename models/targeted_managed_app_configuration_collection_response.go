...
func CreateTargetedManagedAppConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *TargetedManagedAppConfigurationCollectionResponse) Serialize(
...
func (m *TargetedManagedAppConfigurationCollectionResponse) SetValue(
	value []TargetedManagedAppConfigurationable,
) {
	m.value = value
}
...
type TargetedManagedAppConfigurationCollectionResponseable interface {
	...
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []TargetedManagedAppConfigurationable
	SetValue(value []TargetedManagedAppConfigurationable)
}

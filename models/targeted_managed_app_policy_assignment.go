...
func CreateTargetedManagedAppPolicyAssignmentFromDiscriminatorValue(
...
func (m *TargetedManagedAppPolicyAssignment) Serialize(
...
func (m *TargetedManagedAppPolicyAssignment) SetTarget(

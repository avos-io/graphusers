...
func CreateTargetedManagedAppPolicyAssignmentCollectionResponseFromDiscriminatorValue(
...
func (m *TargetedManagedAppPolicyAssignmentCollectionResponse) Serialize(
...
func (m *TargetedManagedAppPolicyAssignmentCollectionResponse) SetValue(
	value []TargetedManagedAppPolicyAssignmentable,
) {
	m.value = value
}

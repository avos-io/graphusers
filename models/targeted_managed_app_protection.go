...
func CreateTargetedManagedAppProtectionFromDiscriminatorValue(
...
func (m *TargetedManagedAppProtection) Serialize(
...
func (m *TargetedManagedAppProtection) SetAssignments(

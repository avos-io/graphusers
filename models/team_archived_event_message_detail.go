...
func CreateTeamArchivedEventMessageDetailFromDiscriminatorValue(
...
func (m *TeamArchivedEventMessageDetail) Serialize(
...
// TeamArchivedEventMessageDetailable
type TeamArchivedEventMessageDetailable interface {

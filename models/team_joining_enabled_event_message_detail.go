...
func CreateTeamJoiningEnabledEventMessageDetailFromDiscriminatorValue(
...
func (m *TeamJoiningEnabledEventMessageDetail) Serialize(
...
// TeamJoiningEnabledEventMessageDetailable

...
func CreateTeamUnarchivedEventMessageDetailFromDiscriminatorValue(
...
func (m *TeamUnarchivedEventMessageDetail) Serialize(
...
// TeamUnarchivedEventMessageDetailable

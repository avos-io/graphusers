...
func CreateTelecomExpenseManagementPartnerFromDiscriminatorValue(
...
func (m *TelecomExpenseManagementPartner) Serialize(
...
func (m *TelecomExpenseManagementPartner) SetLastConnectionDateTime(

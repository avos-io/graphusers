...
func CreateTelecomExpenseManagementPartnerCollectionResponseFromDiscriminatorValue(
...
func (m *TelecomExpenseManagementPartnerCollectionResponse) Serialize(
...
func (m *TelecomExpenseManagementPartnerCollectionResponse) SetValue(
	value []TelecomExpenseManagementPartnerable,
) {
	m.value = value
}

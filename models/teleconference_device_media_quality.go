...
func CreateTeleconferenceDeviceMediaQualityFromDiscriminatorValue(
...
func (m *TeleconferenceDeviceMediaQuality) Serialize(
	...
	{
		err := writer.WriteFloat64Value(
			"averageInboundPacketLossRateInPercentage",
			m.GetAverageInboundPacketLossRateInPercentage(),
		)
		if err != nil {
			return err
		}
	...
	{
		err := writer.WriteISODurationValue(
			"averageInboundRoundTripDelay",
			m.GetAverageInboundRoundTripDelay(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteISODurationValue(
			...
			m.GetAverageOutboundRoundTripDelay(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteFloat64Value(
			...
			m.GetMaximumInboundPacketLossRateInPercentage(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteISODurationValue(
			...
			m.GetMaximumInboundRoundTripDelay(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteFloat64Value(
			...
			m.GetMaximumOutboundPacketLossRateInPercentage(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteISODurationValue(
			...
			m.GetMaximumOutboundRoundTripDelay(),
		)
		if err != nil {
			return err
		}
...
func (m *TeleconferenceDeviceMediaQuality) SetAverageInboundJitter(
...
func (m *TeleconferenceDeviceMediaQuality) SetAverageInboundPacketLossRateInPercentage(
	value *float64,
) {
...
func (m *TeleconferenceDeviceMediaQuality) SetAverageInboundRoundTripDelay(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {
...
func (m *TeleconferenceDeviceMediaQuality) SetAverageOutboundJitter(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {
...
func (m *TeleconferenceDeviceMediaQuality) SetAverageOutboundPacketLossRateInPercentage(
	value *float64,
) {
...
func (m *TeleconferenceDeviceMediaQuality) SetAverageOutboundRoundTripDelay(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {
...
func (m *TeleconferenceDeviceMediaQuality) SetMaximumInboundJitter(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {
...
func (m *TeleconferenceDeviceMediaQuality) SetMaximumInboundPacketLossRateInPercentage(
	value *float64,
) {
...
func (m *TeleconferenceDeviceMediaQuality) SetMaximumInboundRoundTripDelay(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {
...
func (m *TeleconferenceDeviceMediaQuality) SetMaximumOutboundJitter(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {
...
func (m *TeleconferenceDeviceMediaQuality) SetMaximumOutboundPacketLossRateInPercentage(
	value *float64,
) {
...
func (m *TeleconferenceDeviceMediaQuality) SetMaximumOutboundRoundTripDelay(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {
...
func (m *TeleconferenceDeviceMediaQuality) SetMediaDuration(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration,
) {

...
func CreateTemporaryAccessPassAuthenticationMethodCollectionResponseFromDiscriminatorValue(
...
func (m *TemporaryAccessPassAuthenticationMethodCollectionResponse) Serialize(
...
func (m *TemporaryAccessPassAuthenticationMethodCollectionResponse) SetValue(
	value []TemporaryAccessPassAuthenticationMethodable,
) {
	m.value = value
}

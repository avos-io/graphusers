...
func CreateTemporaryAccessPassAuthenticationMethodConfigurationFromDiscriminatorValue(
...
func (m *TemporaryAccessPassAuthenticationMethodConfiguration) Serialize(
...
func (m *TemporaryAccessPassAuthenticationMethodConfiguration) SetDefaultLifetimeInMinutes(
	value *int32,
) {
...
func (m *TemporaryAccessPassAuthenticationMethodConfiguration) SetIncludeTargets(
...
func (m *TemporaryAccessPassAuthenticationMethodConfiguration) SetMaximumLifetimeInMinutes(
	value *int32,
) {
...
func (m *TemporaryAccessPassAuthenticationMethodConfiguration) SetMinimumLifetimeInMinutes(
	value *int32,
) {

...
func CreateTenantAppManagementPolicyFromDiscriminatorValue(
...
func (m *TenantAppManagementPolicy) Serialize(
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetServicePrincipalRestrictions(),
		)
		if err != nil {
			return err
		}
...
func (m *TenantAppManagementPolicy) SetApplicationRestrictions(
	value AppManagementConfigurationable,
) {
...
func (m *TenantAppManagementPolicy) SetServicePrincipalRestrictions(
	value AppManagementConfigurationable,
) {

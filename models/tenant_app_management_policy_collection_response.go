...
func CreateTenantAppManagementPolicyCollectionResponseFromDiscriminatorValue(
...
func (m *TenantAppManagementPolicyCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateTenantAppManagementPolicyFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]TenantAppManagementPolicyable, len(val))
			for i, v := range val {
				res[i] = v.(TenantAppManagementPolicyable)
			}
			m.SetValue(res)
		}
		return nil
...
func (m *TenantAppManagementPolicyCollectionResponse) Serialize(
...
func (m *TenantAppManagementPolicyCollectionResponse) SetValue(
	value []TenantAppManagementPolicyable,
) {
	m.value = value
}

// TenantAppManagementPolicyCollectionResponseable
type TenantAppManagementPolicyCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []TenantAppManagementPolicyable
	SetValue(value []TenantAppManagementPolicyable)
}

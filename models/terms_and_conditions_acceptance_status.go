...
func CreateTermsAndConditionsAcceptanceStatusFromDiscriminatorValue(
...
func (m *TermsAndConditionsAcceptanceStatus) Serialize(
...
func (m *TermsAndConditionsAcceptanceStatus) SetAcceptedDateTime(

...
func CreateTermsAndConditionsAcceptanceStatusCollectionResponseFromDiscriminatorValue(
...
func (m *TermsAndConditionsAcceptanceStatusCollectionResponse) Serialize(
...
func (m *TermsAndConditionsAcceptanceStatusCollectionResponse) SetValue(
	value []TermsAndConditionsAcceptanceStatusable,
) {
	m.value = value
}

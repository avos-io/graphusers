...
func CreateTermsAndConditionsAssignmentCollectionResponseFromDiscriminatorValue(
...
func (m *TermsAndConditionsAssignmentCollectionResponse) Serialize(
...
func (m *TermsAndConditionsAssignmentCollectionResponse) SetValue(
	value []TermsAndConditionsAssignmentable,
) {
	m.value = value
}

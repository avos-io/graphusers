...
func CreateTermsAndConditionsCollectionResponseFromDiscriminatorValue(
...
func (m *TermsAndConditionsCollectionResponse) Serialize(
...
// TermsAndConditionsCollectionResponseable

...
func CreateTermsExpirationFromDiscriminatorValue(
...
func (m *TermsExpiration) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	res := make(
...
func (m *TermsExpiration) Serialize(
...
func (m *TermsExpiration) SetFrequency(
...
func (m *TermsExpiration) SetStartDateTime(
...
// TermsExpirationable
type TermsExpirationable interface {

...
func (m *Set) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["properties"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.CreateKeyValueFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
		if val != nil {
			res := make(
				[]i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.KeyValueable,
				len(val),
			)
			for i, v := range val {
...
func (m *Set) GetProperties() []i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.KeyValueable {
	return m.properties
}
...
func (m *Set) SetProperties(
	value []i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.KeyValueable,
) {
	m.properties = value
}

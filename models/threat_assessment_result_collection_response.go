...
func CreateThreatAssessmentResultCollectionResponseFromDiscriminatorValue(
...
func (m *ThreatAssessmentResultCollectionResponse) Serialize(
...
// ThreatAssessmentResultCollectionResponseable

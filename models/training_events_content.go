...
func CreateTrainingEventsContentFromDiscriminatorValue(
...
func (m *TrainingEventsContent) Serialize(
	writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter,
) error {
	if m.GetAssignedTrainingsInfos() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetAssignedTrainingsInfos()),
		)
	...
	}
	{
		err := writer.WriteInt32Value(
			...
			m.GetTrainingsAssignedUserCount(),
		)
		if err != nil {
			return err
		}
...
// TrainingEventsContentable
type TrainingEventsContentable interface {
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetAssignedTrainingsInfos() []AssignedTrainingInfoable
	GetOdataType() *string
	GetTrainingsAssignedUserCount() *int32
	SetAssignedTrainingsInfos(value []AssignedTrainingInfoable)
	SetOdataType(value *string)
	SetTrainingsAssignedUserCount(value *int32)
}

...
func CreateUnifiedRoleAssignmentScheduleCollectionResponseFromDiscriminatorValue(
...
func (m *UnifiedRoleAssignmentScheduleCollectionResponse) Serialize(
...
func (m *UnifiedRoleAssignmentScheduleCollectionResponse) SetValue(
	value []UnifiedRoleAssignmentScheduleable,
) {
	m.value = value
}

...
func CreateUnifiedRoleAssignmentScheduleInstanceCollectionResponseFromDiscriminatorValue(
...
func (m *UnifiedRoleAssignmentScheduleInstanceCollectionResponse) Serialize(
...
func (m *UnifiedRoleAssignmentScheduleInstanceCollectionResponse) SetValue(
	value []UnifiedRoleAssignmentScheduleInstanceable,
) {
	m.value = value
}

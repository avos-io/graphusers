...
func CreateUnifiedRoleAssignmentScheduleRequestCollectionResponseFromDiscriminatorValue(
...
func (m *UnifiedRoleAssignmentScheduleRequestCollectionResponse) Serialize(
...
func (m *UnifiedRoleAssignmentScheduleRequestCollectionResponse) SetValue(
	value []UnifiedRoleAssignmentScheduleRequestable,
) {
	m.value = value
}

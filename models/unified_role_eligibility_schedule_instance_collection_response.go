...
func CreateUnifiedRoleEligibilityScheduleInstanceCollectionResponseFromDiscriminatorValue(
...
func (m *UnifiedRoleEligibilityScheduleInstanceCollectionResponse) Serialize(
...
func (m *UnifiedRoleEligibilityScheduleInstanceCollectionResponse) SetValue(
	value []UnifiedRoleEligibilityScheduleInstanceable,
) {
	m.value = value
}

...
func CreateUnifiedRoleEligibilityScheduleRequestCollectionResponseFromDiscriminatorValue(
...
func (m *UnifiedRoleEligibilityScheduleRequestCollectionResponse) Serialize(
...
func (m *UnifiedRoleEligibilityScheduleRequestCollectionResponse) SetValue(
	value []UnifiedRoleEligibilityScheduleRequestable,
) {
	m.value = value
}

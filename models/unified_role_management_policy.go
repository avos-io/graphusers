...
func CreateUnifiedRoleManagementPolicyFromDiscriminatorValue(
...
func (m *UnifiedRoleManagementPolicy) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["effectiveRules"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateUnifiedRoleManagementPolicyRuleFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *UnifiedRoleManagementPolicy) Serialize(
...
func (m *UnifiedRoleManagementPolicy) SetEffectiveRules(
...
func (m *UnifiedRoleManagementPolicy) SetLastModifiedDateTime(

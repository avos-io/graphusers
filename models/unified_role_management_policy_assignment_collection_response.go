...
func CreateUnifiedRoleManagementPolicyAssignmentCollectionResponseFromDiscriminatorValue(
...
func (m *UnifiedRoleManagementPolicyAssignmentCollectionResponse) Serialize(
...
func (m *UnifiedRoleManagementPolicyAssignmentCollectionResponse) SetValue(
	value []UnifiedRoleManagementPolicyAssignmentable,
) {
	m.value = value
}

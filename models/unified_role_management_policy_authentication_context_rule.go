...
func CreateUnifiedRoleManagementPolicyAuthenticationContextRuleFromDiscriminatorValue(
...
func (m *UnifiedRoleManagementPolicyAuthenticationContextRule) Serialize(

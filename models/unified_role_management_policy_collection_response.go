...
func CreateUnifiedRoleManagementPolicyCollectionResponseFromDiscriminatorValue(
...
func (m *UnifiedRoleManagementPolicyCollectionResponse) Serialize(
...
func (m *UnifiedRoleManagementPolicyCollectionResponse) SetValue(
	value []UnifiedRoleManagementPolicyable,
) {
	m.value = value
}

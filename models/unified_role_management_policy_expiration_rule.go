...
func CreateUnifiedRoleManagementPolicyExpirationRuleFromDiscriminatorValue(
...
func (m *UnifiedRoleManagementPolicyExpirationRule) Serialize(
...
func (m *UnifiedRoleManagementPolicyExpirationRule) SetMaximumDuration(

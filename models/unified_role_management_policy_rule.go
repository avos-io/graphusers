...
func CreateUnifiedRoleManagementPolicyRuleFromDiscriminatorValue(
...
func (m *UnifiedRoleManagementPolicyRule) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["target"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateUnifiedRoleManagementPolicyRuleTargetFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *UnifiedRoleManagementPolicyRule) Serialize(
...
func (m *UnifiedRoleManagementPolicyRule) SetTarget(
	value UnifiedRoleManagementPolicyRuleTargetable,
) {
	m.target = value
}

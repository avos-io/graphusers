...
func CreateUnifiedRoleManagementPolicyRuleCollectionResponseFromDiscriminatorValue(
...
func (m *UnifiedRoleManagementPolicyRuleCollectionResponse) Serialize(
...
func (m *UnifiedRoleManagementPolicyRuleCollectionResponse) SetValue(
	value []UnifiedRoleManagementPolicyRuleable,
) {
	m.value = value
}

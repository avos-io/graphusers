...
func CreateUnifiedRoleManagementPolicyRuleTargetFromDiscriminatorValue(
...
func (m *UnifiedRoleManagementPolicyRuleTarget) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["operations"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfEnumValues(
			ParseUnifiedRoleManagementPolicyRuleTargetOperations,
		)
		if err != nil {
			return err
		}
...
func (m *UnifiedRoleManagementPolicyRuleTarget) Serialize(
	...
	if m.GetOperations() != nil {
		err := writer.WriteCollectionOfStringValues(
			"operations",
			SerializeUnifiedRoleManagementPolicyRuleTargetOperations(m.GetOperations()),
		)
		if err != nil {
			return err
		}
...
func (m *UnifiedRoleManagementPolicyRuleTarget) SetOperations(
	value []UnifiedRoleManagementPolicyRuleTargetOperations,
) {
	m.operations = value
}

...
func CreateUpdateRecordingStatusOperationCollectionResponseFromDiscriminatorValue(
...
func (m *UpdateRecordingStatusOperationCollectionResponse) Serialize(
...
func (m *UpdateRecordingStatusOperationCollectionResponse) SetValue(
	value []UpdateRecordingStatusOperationable,
) {
	m.value = value
}

...
func CreateUserExperienceAnalyticsDevicePerformanceFromDiscriminatorValue(
...
func (m *UserExperienceAnalyticsDevicePerformance) Serialize(
	...
	}
	{
		err = writer.WriteFloat64Value(
			...
			m.GetModelStartupPerformanceScore(),
		)
		if err != nil {
			return err
		}
...
func (m *UserExperienceAnalyticsDevicePerformance) SetHealthStatus(

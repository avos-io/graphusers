...
func (m *UserExperienceAnalyticsInsightValue) GetOdataType()(*string) {
    return m.odataType
}
...
func (m *UserExperienceAnalyticsInsightValue) SetOdataType(value *string)() {
    m.odataType = value
}
// UserExperienceAnalyticsInsightValueable 
type UserExperienceAnalyticsInsightValueable interface {

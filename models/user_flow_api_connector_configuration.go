...
func CreateUserFlowApiConnectorConfigurationFromDiscriminatorValue(
...
func (m *UserFlowApiConnectorConfiguration) Serialize(
...
func (m *UserFlowApiConnectorConfiguration) SetPostAttributeCollection(
...
func (m *UserFlowApiConnectorConfiguration) SetPostFederationSignup(
	value IdentityApiConnectorable,
) {

...
func CreateUserFlowLanguageConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *UserFlowLanguageConfigurationCollectionResponse) Serialize(
...
func (m *UserFlowLanguageConfigurationCollectionResponse) SetValue(
	value []UserFlowLanguageConfigurationable,
) {
	m.value = value
}

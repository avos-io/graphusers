...
func CreateUserFlowLanguagePageFromDiscriminatorValue(
...
func (m *UserFlowLanguagePage) Serialize(
...
// UserFlowLanguagePageable
type UserFlowLanguagePageable interface {
	Entityable

...
func CreateUserScopeTeamsAppInstallationCollectionResponseFromDiscriminatorValue(
...
func (m *UserScopeTeamsAppInstallationCollectionResponse) Serialize(
...
func (m *UserScopeTeamsAppInstallationCollectionResponse) SetValue(
	value []UserScopeTeamsAppInstallationable,
) {
	m.value = value
}

// UserScopeTeamsAppInstallationCollectionResponseable

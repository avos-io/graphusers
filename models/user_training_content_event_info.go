...
func CreateUserTrainingContentEventInfoFromDiscriminatorValue(
...
func (m *UserTrainingContentEventInfo) Serialize(
...
func (m *UserTrainingContentEventInfo) SetContentDateTime(

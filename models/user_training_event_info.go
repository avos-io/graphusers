...
func CreateUserTrainingEventInfoFromDiscriminatorValue(
...
func (m *UserTrainingEventInfo) Serialize(
	...
	}
	{
		err := writer.WriteObjectValue(
			...
			m.GetTrainingAssignedProperties(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteObjectValue(
			...
			m.GetTrainingCompletedProperties(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteObjectValue(
			...
			m.GetTrainingUpdatedProperties(),
		)
		if err != nil {
			return err
		}
...
func (m *UserTrainingEventInfo) SetTrainingAssignedProperties(
	value UserTrainingContentEventInfoable,
) {
...
func (m *UserTrainingEventInfo) SetTrainingCompletedProperties(
	value UserTrainingContentEventInfoable,
) {
...
func (m *UserTrainingEventInfo) SetTrainingUpdatedProperties(
	value UserTrainingContentEventInfoable,
) {

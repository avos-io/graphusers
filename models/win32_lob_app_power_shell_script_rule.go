...
func CreateWin32LobAppPowerShellScriptRuleFromDiscriminatorValue(
...
func (m *Win32LobAppPowerShellScriptRule) Serialize(
...
func (m *Win32LobAppPowerShellScriptRule) SetOperationType(
	value *Win32LobAppPowerShellScriptRuleOperationType,
) {

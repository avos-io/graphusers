...
func CreateWindows10CompliancePolicyCollectionResponseFromDiscriminatorValue(
...
func (m *Windows10CompliancePolicyCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateWindows10CompliancePolicyFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *Windows10CompliancePolicyCollectionResponse) Serialize(
...
func (m *Windows10CompliancePolicyCollectionResponse) SetValue(
	value []Windows10CompliancePolicyable,
) {
	m.value = value
}

// Windows10CompliancePolicyCollectionResponseable
type Windows10CompliancePolicyCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []Windows10CompliancePolicyable
	SetValue(value []Windows10CompliancePolicyable)
}

...
func CreateWindows10CustomConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *Windows10CustomConfigurationCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateWindows10CustomConfigurationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]Windows10CustomConfigurationable, len(val))
			for i, v := range val {
				res[i] = v.(Windows10CustomConfigurationable)
			}
			m.SetValue(res)
		}
		return nil
...
func (m *Windows10CustomConfigurationCollectionResponse) Serialize(
...
func (m *Windows10CustomConfigurationCollectionResponse) SetValue(
	value []Windows10CustomConfigurationable,
) {
	m.value = value
}

...
func CreateWindows10EndpointProtectionConfigurationFromDiscriminatorValue(
...
func (m *Windows10EndpointProtectionConfiguration) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["applicationGuardBlockClipboardSharing"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		...
		if val != nil {
			m.SetApplicationGuardBlockClipboardSharing(
				val.(*ApplicationGuardBlockClipboardSharingType),
			)
		}
		return nil
	}
	...
	res["firewallCertificateRevocationListCheckMethod"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		...
		if val != nil {
			m.SetFirewallCertificateRevocationListCheckMethod(
				val.(*FirewallCertificateRevocationListCheckMethodType),
			)
		}
		return nil
	}
...
func (m *Windows10EndpointProtectionConfiguration) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetApplicationGuardAllowPersistence(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetApplicationGuardAllowPrintToLocalPrinters(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetApplicationGuardAllowPrintToNetworkPrinters(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetApplicationGuardAllowPrintToPDF(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetApplicationGuardAllowPrintToXPS(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetApplicationGuardBlockNonEnterpriseContent(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetApplicationGuardForceAuditing(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetBitLockerDisableWarningForOtherDiskEncryption(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetBitLockerEnableStorageCardEncryptionOnMobile(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetBitLockerRemovableDrivePolicy(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetDefenderAdditionalGuardedFolders() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetDefenderAdditionalGuardedFolders(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetDefenderAttackSurfaceReductionExcludedPaths() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetDefenderAttackSurfaceReductionExcludedPaths(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteByteArrayValue(
			...
			m.GetDefenderExploitProtectionXml(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetDefenderExploitProtectionXmlFileName(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetDefenderGuardedFoldersAllowedAppPaths() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetDefenderGuardedFoldersAllowedAppPaths(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDefenderSecurityCenterBlockExploitProtectionOverride(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetFirewallIdleTimeoutForSecurityAssociationInSeconds(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetFirewallIPSecExemptionsAllowDHCP(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetFirewallIPSecExemptionsAllowICMP(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetFirewallIPSecExemptionsAllowNeighborDiscovery(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetFirewallIPSecExemptionsAllowRouterDiscovery(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetFirewallMergeKeyingModuleSettings(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSmartScreenBlockOverrideForFiles(),
		)
		if err != nil {
			return err
		}
...
func (m *Windows10EndpointProtectionConfiguration) SetApplicationGuardAllowPersistence(
	value *bool,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetApplicationGuardAllowPrintToLocalPrinters(
	value *bool,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetApplicationGuardAllowPrintToNetworkPrinters(
	value *bool,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetApplicationGuardBlockClipboardSharing(
	value *ApplicationGuardBlockClipboardSharingType,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetApplicationGuardBlockFileTransfer(
	value *ApplicationGuardBlockFileTransferType,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetApplicationGuardBlockNonEnterpriseContent(
	value *bool,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetAppLockerApplicationControl(
	value *AppLockerApplicationControlType,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetBitLockerDisableWarningForOtherDiskEncryption(
	value *bool,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetBitLockerEnableStorageCardEncryptionOnMobile(
	value *bool,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetBitLockerRemovableDrivePolicy(
	value BitLockerRemovableDrivePolicyable,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetDefenderAdditionalGuardedFolders(
	value []string,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetDefenderAttackSurfaceReductionExcludedPaths(
	value []string,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetDefenderExploitProtectionXmlFileName(
	value *string,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetDefenderGuardedFoldersAllowedAppPaths(
	value []string,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetDefenderSecurityCenterBlockExploitProtectionOverride(
	value *bool,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetFirewallCertificateRevocationListCheckMethod(
	value *FirewallCertificateRevocationListCheckMethodType,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetFirewallIdleTimeoutForSecurityAssociationInSeconds(
	value *int32,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetFirewallIPSecExemptionsAllowDHCP(
	value *bool,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetFirewallIPSecExemptionsAllowICMP(
	value *bool,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetFirewallIPSecExemptionsAllowNeighborDiscovery(
	value *bool,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetFirewallIPSecExemptionsAllowRouterDiscovery(
	value *bool,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetFirewallMergeKeyingModuleSettings(
	value *bool,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetFirewallPacketQueueingMethod(
	value *FirewallPacketQueueingMethodType,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetFirewallPreSharedKeyEncodingMethod(
	value *FirewallPreSharedKeyEncodingMethodType,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetFirewallProfileDomain(
	value WindowsFirewallNetworkProfileable,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetFirewallProfilePrivate(
	value WindowsFirewallNetworkProfileable,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetFirewallProfilePublic(
	value WindowsFirewallNetworkProfileable,
) {
...
func (m *Windows10EndpointProtectionConfiguration) SetSmartScreenBlockOverrideForFiles(
	value *bool,
) {

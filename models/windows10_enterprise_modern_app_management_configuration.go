...
func CreateWindows10EnterpriseModernAppManagementConfigurationFromDiscriminatorValue(
...
func (m *Windows10EnterpriseModernAppManagementConfiguration) Serialize(

...
func CreateWindows10GeneralConfigurationFromDiscriminatorValue(
...
func (m *Windows10GeneralConfiguration) Serialize(
	...
	{
		err = writer.WriteBoolValue(
			"accountsBlockAddingNonMicrosoftAccountEmail",
			m.GetAccountsBlockAddingNonMicrosoftAccountEmail(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAppsBlockWindowsStoreOriginatedApps(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetBluetoothAllowedServices() != nil {
		err = writer.WriteCollectionOfStringValues(
			"bluetoothAllowedServices",
			m.GetBluetoothAllowedServices(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetBluetoothBlockDiscoverableMode(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetCellularBlockDataWhenRoaming(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetCellularBlockVpnWhenRoaming(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetCertificatesBlockManualRootCertificateInstallation(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetConnectedDevicesServiceBlocked(),
		)
		if err != nil {
			return err
		}
	...
	{
		err = writer.WriteInt32Value(
			"defenderDaysBeforeDeletingQuarantinedMalware",
			m.GetDefenderDaysBeforeDeletingQuarantinedMalware(),
		)
		if err != nil {
			return err
		}
	...
	{
		err = writer.WriteObjectValue(
			"defenderDetectedMalwareActions",
			m.GetDefenderDetectedMalwareActions(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetDefenderFileExtensionsToExclude() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetDefenderFileExtensionsToExclude(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetDefenderFilesAndFoldersToExclude() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetDefenderFilesAndFoldersToExclude(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetDefenderProcessesToExclude() != nil {
		err = writer.WriteCollectionOfStringValues(
			...
			m.GetDefenderProcessesToExclude(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDefenderRequireBehaviorMonitoring(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDefenderRequireCloudProtection(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDefenderRequireNetworkInspectionSystem(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDefenderRequireRealTimeMonitoring(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDefenderScanMappedNetworkDrivesDuringFullScan(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDefenderScanRemovableDrivesDuringFullScan(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDefenderScanScriptsLoadedInInternetExplorer(),
		)
		if err != nil {
			return err
		}
	...
	{
		err = writer.WriteTimeOnlyValue(
			"defenderScheduledQuickScanTime",
			m.GetDefenderScheduledQuickScanTime(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteTimeOnlyValue(
			...
			m.GetDefenderScheduledScanTime(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetDefenderSignatureUpdateIntervalInHours(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDeviceManagementBlockFactoryResetOnMobile(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDeviceManagementBlockManualUnenroll(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEdgeAllowStartPagesModification(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEdgeBlockAccessToAboutFlags(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEdgeBlockAddressBarDropdown(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEdgeBlockLiveTileDataCollection(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEdgeBlockSendingDoNotTrackHeader(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEdgeBlockSendingIntranetTrafficToInternetExplorer(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEdgeClearBrowsingDataOnExit(),
		)
		if err != nil {
			return err
		}
	...
	{
		err = writer.WriteStringValue(
			"edgeEnterpriseModeSiteListLocation",
			m.GetEdgeEnterpriseModeSiteListLocation(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEdgeSendIntranetTrafficToInternetExplorer(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEdgeSyncFavoritesWithInternetExplorer(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetEnterpriseCloudPrintDiscoveryEndPoint(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetEnterpriseCloudPrintDiscoveryMaxLimit(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetEnterpriseCloudPrintMopriaDiscoveryResourceIdentifier(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetEnterpriseCloudPrintOAuthAuthority(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetEnterpriseCloudPrintOAuthClientIdentifier(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetEnterpriseCloudPrintResourceIdentifier(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetExperienceBlockDeviceDiscovery(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetExperienceBlockErrorDialogWhenNoSIM(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetExperienceBlockTaskSwitcher(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetLockScreenAllowTimeoutConfiguration(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetLockScreenBlockActionCenterNotifications(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetLockScreenBlockToastNotifications(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			"lockScreenTimeoutInSeconds",
			m.GetLockScreenTimeoutInSeconds(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetLogonBlockFastUserSwitching(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetMicrosoftAccountBlockSettingsSync(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetNetworkProxyApplySettingsDeviceWide(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetNetworkProxyAutomaticConfigurationUrl(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetNetworkProxyDisableAutoDetect(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetPasswordMinimumCharacterSetCount(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetPasswordMinutesOfInactivityBeforeScreenTimeout(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetPasswordPreviousPasswordBlockCount(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetPasswordRequireWhenResumeFromIdleState(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetPasswordSignInFailureCountBeforeFactoryReset(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetPersonalizationDesktopImageUrl(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetPersonalizationLockScreenImageUrl(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetPrivacyAutoAcceptPairingAndConsentPrompts(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetPrivacyBlockInputPersonalization(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSearchDisableAutoLanguageDetection(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSearchDisableIndexerBackoff(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSearchDisableIndexingEncryptedItems(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSearchDisableIndexingRemovableDrive(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSearchEnableAutomaticIndexSizeManangement(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSettingsBlockAddProvisioningPackage(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSettingsBlockChangeLanguage(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSettingsBlockChangePowerSleep(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSettingsBlockChangeSystemTime(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSettingsBlockEaseOfAccessPage(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSettingsBlockEditDeviceName(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSettingsBlockNetworkInternetPage(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSettingsBlockPersonalizationPage(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSettingsBlockRemoveProvisioningPackage(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSettingsBlockTimeLanguagePage(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSettingsBlockUpdateSecurityPage(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSmartScreenBlockPromptOverride(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSmartScreenBlockPromptOverrideForFiles(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSmartScreenEnableAppInstallControl(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetStartBlockUnpinningAppsFromTaskbar(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetStartMenuHideChangeAccountSettings(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetStartMenuHideFrequentlyUsedApps(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetStartMenuHideRecentJumpLists(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetStartMenuHideRecentlyAddedApps(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetStartMenuHideRestartOptions(),
		)
		if err != nil {
			return err
		}
	...
	{
		err = writer.WriteByteArrayValue(
			"startMenuLayoutEdgeAssetsXml",
			m.GetStartMenuLayoutEdgeAssetsXml(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetStorageBlockRemovableStorage(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetStorageRequireMobileDeviceEncryption(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetStorageRestrictAppDataToSystemVolume(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetStorageRestrictAppInstallToSystemVolume(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetTenantLockdownRequireNetworkDuringOutOfBoxExperience(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWebRtcBlockLocalhostIpAddress(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWiFiBlockAutomaticConnectHotspots(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWiFiBlockManualConfiguration(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWindowsSpotlightBlockConsumerSpecificFeatures(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWindowsSpotlightBlockOnActionCenter(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWindowsSpotlightBlockTailoredExperiences(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWindowsSpotlightBlockThirdPartyNotifications(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWindowsSpotlightBlockWelcomeExperience(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWindowsSpotlightBlockWindowsTips(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWindowsStoreBlockAutoUpdate(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWindowsStoreEnablePrivateStoreOnly(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWirelessDisplayBlockProjectionToThisDevice(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWirelessDisplayBlockUserInputFromReceiver(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWirelessDisplayRequirePinForPairing(),
		)
		if err != nil {
			return err
		}
...
func (m *Windows10GeneralConfiguration) SetAccountsBlockAddingNonMicrosoftAccountEmail(
	value *bool,
) {
...
func (m *Windows10GeneralConfiguration) SetAppsAllowTrustedAppsSideloading(
	value *StateManagementSetting,
) {
...
func (m *Windows10GeneralConfiguration) SetCertificatesBlockManualRootCertificateInstallation(
	value *bool,
) {
...
func (m *Windows10GeneralConfiguration) SetDefenderCloudBlockLevel(
	value *DefenderCloudBlockLevelType,
) {
...
func (m *Windows10GeneralConfiguration) SetDefenderDaysBeforeDeletingQuarantinedMalware(
	value *int32,
) {
...
func (m *Windows10GeneralConfiguration) SetDefenderDetectedMalwareActions(
	value DefenderDetectedMalwareActionsable,
) {
...
func (m *Windows10GeneralConfiguration) SetDefenderMonitorFileActivity(
	value *DefenderMonitorFileActivity,
) {
...
func (m *Windows10GeneralConfiguration) SetDefenderPromptForSampleSubmission(
	value *DefenderPromptForSampleSubmission,
) {
...
func (m *Windows10GeneralConfiguration) SetDefenderScanMappedNetworkDrivesDuringFullScan(
	value *bool,
) {
...
func (m *Windows10GeneralConfiguration) SetDefenderScanScriptsLoadedInInternetExplorer(
	value *bool,
) {
...
func (m *Windows10GeneralConfiguration) SetDefenderScheduledQuickScanTime(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.TimeOnly,
) {
...
func (m *Windows10GeneralConfiguration) SetDefenderScheduledScanTime(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.TimeOnly,
) {
...
func (m *Windows10GeneralConfiguration) SetDiagnosticsDataSubmissionMode(
	value *DiagnosticDataSubmissionMode,
) {
...
func (m *Windows10GeneralConfiguration) SetEdgeBlockSendingIntranetTrafficToInternetExplorer(
	value *bool,
) {
...
func (m *Windows10GeneralConfiguration) SetEnterpriseCloudPrintMopriaDiscoveryResourceIdentifier(
	value *string,
) {
...
func (m *Windows10GeneralConfiguration) SetEnterpriseCloudPrintOAuthClientIdentifier(
	value *string,
) {
...
func (m *Windows10GeneralConfiguration) SetNetworkProxyServer(
	value Windows10NetworkProxyServerable,
) {
...
func (m *Windows10GeneralConfiguration) SetPasswordMinutesOfInactivityBeforeScreenTimeout(
	value *int32,
) {
...
func (m *Windows10GeneralConfiguration) SetPasswordSignInFailureCountBeforeFactoryReset(
	value *int32,
) {
...
func (m *Windows10GeneralConfiguration) SetStartMenuAppListVisibility(
	value *WindowsStartMenuAppListVisibilityType,
) {
...
func (m *Windows10GeneralConfiguration) SetStartMenuPinnedFolderDocuments(
...
func (m *Windows10GeneralConfiguration) SetStartMenuPinnedFolderDownloads(
	value *VisibilitySetting,
) {
...
func (m *Windows10GeneralConfiguration) SetStartMenuPinnedFolderFileExplorer(
	value *VisibilitySetting,
) {
...
func (m *Windows10GeneralConfiguration) SetStartMenuPinnedFolderHomeGroup(
	value *VisibilitySetting,
) {
...
func (m *Windows10GeneralConfiguration) SetStartMenuPinnedFolderPersonalFolder(
	value *VisibilitySetting,
) {
...
func (m *Windows10GeneralConfiguration) SetTenantLockdownRequireNetworkDuringOutOfBoxExperience(
	value *bool,
) {
...
func (m *Windows10GeneralConfiguration) SetWindowsSpotlightBlockConsumerSpecificFeatures(
	value *bool,
) {
...
func (m *Windows10GeneralConfiguration) SetWindowsSpotlightBlockThirdPartyNotifications(
	value *bool,
) {
...
func (m *Windows10GeneralConfiguration) SetWindowsSpotlightConfigureOnLockScreen(
	value *WindowsSpotlightEnablementSettings,
) {

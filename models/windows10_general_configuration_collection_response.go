...
func CreateWindows10GeneralConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *Windows10GeneralConfigurationCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateWindows10GeneralConfigurationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *Windows10GeneralConfigurationCollectionResponse) Serialize(
...
func (m *Windows10GeneralConfigurationCollectionResponse) SetValue(
	value []Windows10GeneralConfigurationable,
) {
	m.value = value
}

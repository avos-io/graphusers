...
func CreateWindows10MobileCompliancePolicyFromDiscriminatorValue(
...
func (m *Windows10MobileCompliancePolicy) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEarlyLaunchAntiMalwareDriverEnabled(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetPasswordRequireToUnlockFromIdle(),
		)
		if err != nil {
			return err
		}

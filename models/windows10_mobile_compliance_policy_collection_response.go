...
func CreateWindows10MobileCompliancePolicyCollectionResponseFromDiscriminatorValue(
...
func (m *Windows10MobileCompliancePolicyCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateWindows10MobileCompliancePolicyFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *Windows10MobileCompliancePolicyCollectionResponse) Serialize(
...
func (m *Windows10MobileCompliancePolicyCollectionResponse) SetValue(
	value []Windows10MobileCompliancePolicyable,
) {
	m.value = value
}

// Windows10MobileCompliancePolicyCollectionResponseable
type Windows10MobileCompliancePolicyCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []Windows10MobileCompliancePolicyable
	SetValue(value []Windows10MobileCompliancePolicyable)
}

...
func CreateWindows10TeamGeneralConfigurationFromDiscriminatorValue(
...
func (m *Windows10TeamGeneralConfiguration) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAzureOperationalInsightsBlockTelemetry(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetAzureOperationalInsightsWorkspaceId(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetAzureOperationalInsightsWorkspaceKey(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetMaintenanceWindowDurationInHours(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteTimeOnlyValue(
			...
			m.GetMaintenanceWindowStartTime(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSettingsBlockMyMeetingsAndFiles(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetSettingsBlockSigninSuggestions(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetSettingsScreenTimeoutInMinutes(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetSettingsSessionTimeoutInMinutes(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetSettingsSleepTimeoutInMinutes(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetWelcomeScreenBackgroundImageUrl(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWelcomeScreenBlockAutomaticWakeUp(),
		)
		if err != nil {
			return err
		}
...
func (m *Windows10TeamGeneralConfiguration) SetMaintenanceWindowStartTime(
...
func (m *Windows10TeamGeneralConfiguration) SetWelcomeScreenMeetingInformation(
	value *WelcomeScreenMeetingInformation,
) {

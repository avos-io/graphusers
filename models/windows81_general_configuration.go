...
func CreateWindows81GeneralConfigurationFromDiscriminatorValue(
...
func (m *Windows81GeneralConfiguration) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetBrowserBlockAutomaticDetectionOfIntranetSites(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetBrowserBlockEnterpriseModeAccess(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetBrowserBlockSendingDoNotTrackHeader(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetBrowserBlockSingleWordEntryOnIntranetSites(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetBrowserEnterpriseModeSiteListLocation(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetBrowserLoggingReportLocation(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetBrowserRequireHighSecurityForRestrictedSites(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetDiagnosticsBlockDataSubmission(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetPasswordBlockPicturePasswordAndPin(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetStorageRequireDeviceEncryption(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetUpdatesRequireAutomaticUpdates(),
		)
		if err != nil {
			return err
		}
...
func (m *Windows81GeneralConfiguration) SetAccountsBlockAddingNonMicrosoftAccountEmail(
	value *bool,
) {
...
func (m *Windows81GeneralConfiguration) SetBrowserBlockAutomaticDetectionOfIntranetSites(
	value *bool,
) {
...
func (m *Windows81GeneralConfiguration) SetBrowserInternetSecurityLevel(
	value *InternetSiteSecurityLevel,
) {
...
func (m *Windows81GeneralConfiguration) SetBrowserRequireHighSecurityForRestrictedSites(
	value *bool,
) {
...
func (m *Windows81GeneralConfiguration) SetBrowserTrustedSitesSecurityLevel(
	value *SiteSecurityLevel,
) {
...
func (m *Windows81GeneralConfiguration) SetPasswordMinutesOfInactivityBeforeScreenTimeout(
	value *int32,
) {
...
func (m *Windows81GeneralConfiguration) SetPasswordSignInFailureCountBeforeFactoryReset(
	value *int32,
) {
...
func (m *Windows81GeneralConfiguration) SetUserAccountControlSettings(
	value *WindowsUserAccountControlSettings,
) {

...
func CreateWindowsAutopilotDeviceIdentityFromDiscriminatorValue(
...
func (m *WindowsAutopilotDeviceIdentity) Serialize(
	...
	}
	{
		err = writer.WriteStringValue(
			...
			m.GetAzureActiveDirectoryDeviceId(),
		)
		if err != nil {
			return err
		}
...
func (m *WindowsAutopilotDeviceIdentity) SetLastContactedDateTime(

...
func CreateWindowsAutopilotDeviceIdentityCollectionResponseFromDiscriminatorValue(
...
func (m *WindowsAutopilotDeviceIdentityCollectionResponse) Serialize(
...
func (m *WindowsAutopilotDeviceIdentityCollectionResponse) SetValue(
	value []WindowsAutopilotDeviceIdentityable,
) {
	m.value = value
}

...
func CreateWindowsDefenderAdvancedThreatProtectionConfigurationFromDiscriminatorValue(
...
func (m *WindowsDefenderAdvancedThreatProtectionConfiguration) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEnableExpeditedTelemetryReporting(),
		)
		if err != nil {
			return err
		}
...
func (m *WindowsDefenderAdvancedThreatProtectionConfiguration) SetEnableExpeditedTelemetryReporting(
	value *bool,
) {

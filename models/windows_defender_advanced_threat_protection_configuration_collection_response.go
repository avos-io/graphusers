...
func CreateWindowsDefenderAdvancedThreatProtectionConfigurationCollectionResponseFromDiscriminatorValue(
...
func (m *WindowsDefenderAdvancedThreatProtectionConfigurationCollectionResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["value"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateWindowsDefenderAdvancedThreatProtectionConfigurationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *WindowsDefenderAdvancedThreatProtectionConfigurationCollectionResponse) Serialize(
...
func (m *WindowsDefenderAdvancedThreatProtectionConfigurationCollectionResponse) SetValue(
	value []WindowsDefenderAdvancedThreatProtectionConfigurationable,
) {
	m.value = value
}

// WindowsDefenderAdvancedThreatProtectionConfigurationCollectionResponseable
type WindowsDefenderAdvancedThreatProtectionConfigurationCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []WindowsDefenderAdvancedThreatProtectionConfigurationable
	SetValue(value []WindowsDefenderAdvancedThreatProtectionConfigurationable)
}

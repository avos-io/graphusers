...
func CreateWindowsFirewallNetworkProfileFromDiscriminatorValue(
...
func (m *WindowsFirewallNetworkProfile) Serialize(
	writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter,
) error {
	{
		err := writer.WriteBoolValue(
			"authorizedApplicationRulesFromGroupPolicyMerged",
			m.GetAuthorizedApplicationRulesFromGroupPolicyMerged(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetConnectionSecurityRulesFromGroupPolicyMerged(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetGlobalPortRulesFromGroupPolicyMerged(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetInboundNotificationsBlocked(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetOutboundConnectionsBlocked(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetPolicyRulesFromGroupPolicyMerged(),
		)
		if err != nil {
			return err
		}
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetSecuredPacketExemptionAllowed(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err := writer.WriteBoolValue(
			...
			m.GetUnicastResponsesToMulticastBroadcastsBlocked(),
		)
		if err != nil {
			return err
		}
...
func (m *WindowsFirewallNetworkProfile) SetAuthorizedApplicationRulesFromGroupPolicyMerged(
	value *bool,
) {
...
func (m *WindowsFirewallNetworkProfile) SetConnectionSecurityRulesFromGroupPolicyMerged(
	value *bool,
) {
...
func (m *WindowsFirewallNetworkProfile) SetUnicastResponsesToMulticastBroadcastsBlocked(
	value *bool,
) {

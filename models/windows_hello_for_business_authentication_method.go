...
func (m *WindowsHelloForBusinessAuthenticationMethod) Serialize(
...
func (m *WindowsHelloForBusinessAuthenticationMethod) SetCreatedDateTime(
...
func (m *WindowsHelloForBusinessAuthenticationMethod) SetKeyStrength(
	value *AuthenticationMethodKeyStrength,
) {
	m.keyStrength = value
}

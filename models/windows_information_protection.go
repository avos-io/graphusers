...
func CreateWindowsInformationProtectionFromDiscriminatorValue(
...
func (m *WindowsInformationProtection) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["dataRecoveryCertificate"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateWindowsInformationProtectionDataRecoveryCertificateFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetDataRecoveryCertificate(
				val.(WindowsInformationProtectionDataRecoveryCertificateable),
			)
		}
		return nil
	}
	...
	res["enterpriseIPRanges"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateWindowsInformationProtectionIPRangeCollectionFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
	...
	res["enterpriseProxiedDomains"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateWindowsInformationProtectionProxiedDomainCollectionFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
	...
	res["exemptAppLockerFiles"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateWindowsInformationProtectionAppLockerFileFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
	...
	res["exemptApps"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateWindowsInformationProtectionAppFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *WindowsInformationProtection) Serialize(
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetAzureRightsManagementServicesAllowed(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetEnterpriseInternalProxyServers() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetEnterpriseInternalProxyServers()),
		)
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEnterpriseIPRangesAreAuthoritative(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetEnterpriseNetworkDomainNames() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetEnterpriseNetworkDomainNames()),
		)
	...
	if m.GetEnterpriseProtectedDomainNames() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetEnterpriseProtectedDomainNames()),
		)
	...
	if m.GetEnterpriseProxiedDomains() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetEnterpriseProxiedDomains()),
		)
	...
	if m.GetEnterpriseProxyServers() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetEnterpriseProxyServers()),
		)
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetEnterpriseProxyServersAreAuthoritative(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetIndexingEncryptedStoresOrItemsBlocked(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetNeutralDomainResources() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetNeutralDomainResources()),
		)
	...
	if m.GetProtectedAppLockerFiles() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetProtectedAppLockerFiles()),
		)
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetProtectionUnderLockConfigRequired(),
		)
		if err != nil {
			return err
		}
	...
	{
		err = writer.WriteUUIDValue(
			"rightsManagementServicesTemplateId",
			m.GetRightsManagementServicesTemplateId(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetSmbAutoEncryptedFileExtensions() != nil {
		cast := make(
			[]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable,
			len(m.GetSmbAutoEncryptedFileExtensions()),
		)
...
func (m *WindowsInformationProtection) SetAssignments(
...
func (m *WindowsInformationProtection) SetDataRecoveryCertificate(
	value WindowsInformationProtectionDataRecoveryCertificateable,
) {
...
func (m *WindowsInformationProtection) SetEnforcementLevel(
	value *WindowsInformationProtectionEnforcementLevel,
) {
...
func (m *WindowsInformationProtection) SetEnterpriseInternalProxyServers(
...
func (m *WindowsInformationProtection) SetEnterpriseIPRanges(
	value []WindowsInformationProtectionIPRangeCollectionable,
) {
...
func (m *WindowsInformationProtection) SetEnterpriseNetworkDomainNames(
	value []WindowsInformationProtectionResourceCollectionable,
) {
...
func (m *WindowsInformationProtection) SetEnterpriseProtectedDomainNames(
	value []WindowsInformationProtectionResourceCollectionable,
) {
...
func (m *WindowsInformationProtection) SetEnterpriseProxiedDomains(
...
func (m *WindowsInformationProtection) SetEnterpriseProxyServers(
	value []WindowsInformationProtectionResourceCollectionable,
) {
...
func (m *WindowsInformationProtection) SetExemptAppLockerFiles(
...
func (m *WindowsInformationProtection) SetNeutralDomainResources(
	value []WindowsInformationProtectionResourceCollectionable,
) {
...
func (m *WindowsInformationProtection) SetProtectedAppLockerFiles(
	value []WindowsInformationProtectionAppLockerFileable,
) {
...
func (m *WindowsInformationProtection) SetProtectedApps(
...
func (m *WindowsInformationProtection) SetRightsManagementServicesTemplateId(
...
func (m *WindowsInformationProtection) SetSmbAutoEncryptedFileExtensions(
	value []WindowsInformationProtectionResourceCollectionable,
) {

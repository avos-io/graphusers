...
func CreateWindowsInformationProtectionAppLearningSummaryFromDiscriminatorValue(
...
func (m *WindowsInformationProtectionAppLearningSummary) Serialize(
...
func (m *WindowsInformationProtectionAppLearningSummary) SetApplicationType(

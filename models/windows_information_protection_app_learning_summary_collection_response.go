...
func CreateWindowsInformationProtectionAppLearningSummaryCollectionResponseFromDiscriminatorValue(
...
func (m *WindowsInformationProtectionAppLearningSummaryCollectionResponse) Serialize(
...
func (m *WindowsInformationProtectionAppLearningSummaryCollectionResponse) SetValue(
	value []WindowsInformationProtectionAppLearningSummaryable,
) {
	m.value = value
}

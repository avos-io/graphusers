...
func CreateWindowsInformationProtectionAppLockerFileCollectionResponseFromDiscriminatorValue(
...
func (m *WindowsInformationProtectionAppLockerFileCollectionResponse) Serialize(
...
func (m *WindowsInformationProtectionAppLockerFileCollectionResponse) SetValue(
	value []WindowsInformationProtectionAppLockerFileable,
) {
	m.value = value
}

// WindowsInformationProtectionAppLockerFileCollectionResponseable
type WindowsInformationProtectionAppLockerFileCollectionResponseable interface {
	BaseCollectionPaginationCountResponseable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetValue() []WindowsInformationProtectionAppLockerFileable
	SetValue(value []WindowsInformationProtectionAppLockerFileable)
}

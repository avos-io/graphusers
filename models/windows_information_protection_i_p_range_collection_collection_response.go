...
func CreateWindowsInformationProtectionIPRangeCollectionCollectionResponseFromDiscriminatorValue(
...
func (m *WindowsInformationProtectionIPRangeCollectionCollectionResponse) Serialize(
...
func (m *WindowsInformationProtectionIPRangeCollectionCollectionResponse) SetValue(
	value []WindowsInformationProtectionIPRangeCollectionable,
) {
	m.value = value
}

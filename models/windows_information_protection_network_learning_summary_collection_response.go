...
func CreateWindowsInformationProtectionNetworkLearningSummaryCollectionResponseFromDiscriminatorValue(
...
func (m *WindowsInformationProtectionNetworkLearningSummaryCollectionResponse) Serialize(
...
func (m *WindowsInformationProtectionNetworkLearningSummaryCollectionResponse) SetValue(
	value []WindowsInformationProtectionNetworkLearningSummaryable,
) {
	m.value = value
}

...
func ParseWindowsInformationProtectionPinCharacterRequirements(v string) (any, error) {
	...
	default:
		return 0, errors.New(
			"Unknown WindowsInformationProtectionPinCharacterRequirements value: " + v,
		)
	}
	return &result, nil
}

func SerializeWindowsInformationProtectionPinCharacterRequirements(
	values []WindowsInformationProtectionPinCharacterRequirements,
) []string {

...
func CreateWindowsInformationProtectionPolicyFromDiscriminatorValue(
...
func (m *WindowsInformationProtectionPolicy) Serialize(
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetDaysWithoutContactBeforeUnenroll(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetMinutesOfInactivityBeforeDeviceLock(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetNumberOfPastPinsRemembered(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetPasswordMaximumAttemptCount(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetWindowsHelloForBusinessBlocked(),
		)
		if err != nil {
			return err
		}
...
func (m *WindowsInformationProtectionPolicy) SetPinLowercaseLetters(
	value *WindowsInformationProtectionPinCharacterRequirements,
) {
...
func (m *WindowsInformationProtectionPolicy) SetPinSpecialCharacters(
	value *WindowsInformationProtectionPinCharacterRequirements,
) {
...
func (m *WindowsInformationProtectionPolicy) SetPinUppercaseLetters(
	value *WindowsInformationProtectionPinCharacterRequirements,
) {

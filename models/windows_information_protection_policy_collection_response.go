...
func CreateWindowsInformationProtectionPolicyCollectionResponseFromDiscriminatorValue(
...
func (m *WindowsInformationProtectionPolicyCollectionResponse) Serialize(
...
func (m *WindowsInformationProtectionPolicyCollectionResponse) SetValue(
	value []WindowsInformationProtectionPolicyable,
) {
	m.value = value
}

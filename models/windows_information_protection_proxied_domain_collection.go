...
func CreateWindowsInformationProtectionProxiedDomainCollectionFromDiscriminatorValue(
...
func (m *WindowsInformationProtectionProxiedDomainCollection) Serialize(
...
func (m *WindowsInformationProtectionProxiedDomainCollection) SetAdditionalData(
...
func (m *WindowsInformationProtectionProxiedDomainCollection) SetProxiedDomains(

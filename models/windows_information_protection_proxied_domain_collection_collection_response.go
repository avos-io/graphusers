...
func CreateWindowsInformationProtectionProxiedDomainCollectionCollectionResponseFromDiscriminatorValue(
...
func (m *WindowsInformationProtectionProxiedDomainCollectionCollectionResponse) Serialize(
...
func (m *WindowsInformationProtectionProxiedDomainCollectionCollectionResponse) SetValue(
	value []WindowsInformationProtectionProxiedDomainCollectionable,
) {
	m.value = value
}

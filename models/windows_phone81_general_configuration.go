...
func CreateWindowsPhone81GeneralConfigurationFromDiscriminatorValue(
...
func (m *WindowsPhone81GeneralConfiguration) Serialize(
...
func (m *WindowsPhone81GeneralConfiguration) SetPasswordMinutesOfInactivityBeforeScreenTimeout(
	value *int32,
) {
...
func (m *WindowsPhone81GeneralConfiguration) SetPasswordSignInFailureCountBeforeFactoryReset(
	value *int32,
) {

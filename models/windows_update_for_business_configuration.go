...
func CreateWindowsUpdateForBusinessConfigurationFromDiscriminatorValue(
...
func (m *WindowsUpdateForBusinessConfiguration) Serialize(
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetDeadlineForFeatureUpdatesInDays(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetDeadlineForQualityUpdatesInDays(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetEngagedRestartDeadlineInDays(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetEngagedRestartSnoozeScheduleInDays(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetEngagedRestartTransitionScheduleInDays(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetFeatureUpdatesDeferralPeriodInDays(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetFeatureUpdatesPauseExpiryDateTime(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetFeatureUpdatesRollbackStartDateTime(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetFeatureUpdatesRollbackWindowInDays(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetFeatureUpdatesWillBeRolledBack(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetMicrosoftUpdateServiceAllowed(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetPostponeRebootUntilAfterDeadline(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetQualityUpdatesDeferralPeriodInDays(),
		)
		if err != nil {
			return err
		}
	...
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetQualityUpdatesPauseExpiryDateTime(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteTimeValue(
			...
			m.GetQualityUpdatesRollbackStartDateTime(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteBoolValue(
			...
			m.GetQualityUpdatesWillBeRolledBack(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetScheduleImminentRestartWarningInMinutes(),
		)
		if err != nil {
			return err
		}
	}
	{
		err = writer.WriteInt32Value(
			...
			m.GetScheduleRestartWarningInHours(),
		)
		if err != nil {
			return err
		}
...
func (m *WindowsUpdateForBusinessConfiguration) SetAutoRestartNotificationDismissal(
...
func (m *WindowsUpdateForBusinessConfiguration) SetBusinessReadyUpdatesOnly(
	value *WindowsUpdateType,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetDeliveryOptimizationMode(
	value *WindowsDeliveryOptimizationMode,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetEngagedRestartSnoozeScheduleInDays(
	value *int32,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetEngagedRestartTransitionScheduleInDays(
	value *int32,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetFeatureUpdatesDeferralPeriodInDays(
	value *int32,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetFeatureUpdatesPauseExpiryDateTime(
...
func (m *WindowsUpdateForBusinessConfiguration) SetFeatureUpdatesPauseStartDate(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetFeatureUpdatesRollbackStartDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetFeatureUpdatesRollbackWindowInDays(
	value *int32,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetInstallationSchedule(
	value WindowsUpdateInstallScheduleTypeable,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetQualityUpdatesDeferralPeriodInDays(
	value *int32,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetQualityUpdatesPauseExpiryDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetQualityUpdatesPauseStartDate(
	value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetQualityUpdatesRollbackStartDateTime(
	value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetScheduleImminentRestartWarningInMinutes(
	value *int32,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetUpdateNotificationLevel(
	value *WindowsUpdateNotificationDisplayOption,
) {
...
func (m *WindowsUpdateForBusinessConfiguration) SetUpdateWeeks(

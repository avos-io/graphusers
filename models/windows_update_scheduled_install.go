...
func CreateWindowsUpdateScheduledInstallFromDiscriminatorValue(
...
func (m *WindowsUpdateScheduledInstall) Serialize(
...
func (m *WindowsUpdateScheduledInstall) SetScheduledInstallTime(

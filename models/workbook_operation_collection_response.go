...
func CreateWorkbookOperationCollectionResponseFromDiscriminatorValue(
...
func (m *WorkbookOperationCollectionResponse) Serialize(
...
// WorkbookOperationCollectionResponseable

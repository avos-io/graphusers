...
func CreateX509CertificateAuthenticationMethodConfigurationFromDiscriminatorValue(
...
func (m *X509CertificateAuthenticationMethodConfiguration) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["authenticationModeConfiguration"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(
			CreateX509CertificateAuthenticationModeConfigurationFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetAuthenticationModeConfiguration(
				val.(X509CertificateAuthenticationModeConfigurationable),
			)
		}
		return nil
	}
	res["certificateUserBindings"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateX509CertificateUserBindingFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
	...
	res["includeTargets"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(
			CreateAuthenticationMethodTargetFromDiscriminatorValue,
		)
		if err != nil {
			return err
		}
...
func (m *X509CertificateAuthenticationMethodConfiguration) Serialize(
	...
	}
	{
		err = writer.WriteObjectValue(
			...
			m.GetAuthenticationModeConfiguration(),
		)
		if err != nil {
			return err
		}
	...
	if m.GetCertificateUserBindings() != nil {
		cast := make(
			...
			len(m.GetCertificateUserBindings()),
		)
...
func (m *X509CertificateAuthenticationMethodConfiguration) SetAuthenticationModeConfiguration(
	value X509CertificateAuthenticationModeConfigurationable,
) {
...
func (m *X509CertificateAuthenticationMethodConfiguration) SetCertificateUserBindings(
...
func (m *X509CertificateAuthenticationMethodConfiguration) SetIncludeTargets(

...
func CreateX509CertificateAuthenticationModeConfigurationFromDiscriminatorValue(
...
func (m *X509CertificateAuthenticationModeConfiguration) Serialize(
...
func (m *X509CertificateAuthenticationModeConfiguration) SetX509CertificateAuthenticationDefaultMode(
	value *X509CertificateAuthenticationMode,
) {

...
func CreateX509CertificateRuleFromDiscriminatorValue(
...
func (m *X509CertificateRule) Serialize(
...
func (m *X509CertificateRule) SetX509CertificateAuthenticationMode(

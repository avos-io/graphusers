...
// NewItemActivitiesItemHistoryItemsItemActivityRequestBuilderInternal instantiates a new ActivityRequestBuilder and sets the default values.
func NewItemActivitiesItemHistoryItemsItemActivityRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemActivitiesItemHistoryItemsItemActivityRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/activities/{userActivity%2Did}/historyItems/{activityHistoryItem%2Did}/activity{?%24select,%24expand}";
...
// NewItemActivitiesItemHistoryItemsItemActivityRequestBuilder instantiates a new ActivityRequestBuilder and sets the default values.
...
func (m *ItemActivitiesItemHistoryItemsItemActivityRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemActivitiesItemHistoryItemsItemActivityRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.UserActivityable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.CreateUserActivityFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {

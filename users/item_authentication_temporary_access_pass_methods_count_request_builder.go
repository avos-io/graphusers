...
// NewItemAuthenticationTemporaryAccessPassMethodsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemAuthenticationTemporaryAccessPassMethodsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAuthenticationTemporaryAccessPassMethodsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/temporaryAccessPassMethods/$count{?%24search,%24filter}";
...
// NewItemAuthenticationTemporaryAccessPassMethodsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.

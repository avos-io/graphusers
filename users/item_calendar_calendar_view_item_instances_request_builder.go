...
func (m *ItemCalendarCalendarViewItemInstancesRequestBuilder) Delta()(*ItemCalendarCalendarViewItemInstancesDeltaRequestBuilder) {
    return NewItemCalendarCalendarViewItemInstancesDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemCalendarCalendarViewItemInstancesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCalendarCalendarViewItemInstancesRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.EventCollectionResponseable, error) {

...
// ItemCalendarCalendarViewItemTentativelyAcceptPostRequestBody 
type ItemCalendarCalendarViewItemTentativelyAcceptPostRequestBody struct {
...
// NewItemCalendarCalendarViewItemTentativelyAcceptPostRequestBody instantiates a new ItemCalendarCalendarViewItemTentativelyAcceptPostRequestBody and sets the default values.
func NewItemCalendarCalendarViewItemTentativelyAcceptPostRequestBody()(*ItemCalendarCalendarViewItemTentativelyAcceptPostRequestBody) {
    m := &ItemCalendarCalendarViewItemTentativelyAcceptPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarCalendarViewItemTentativelyAcceptPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemCalendarCalendarViewItemTentativelyAcceptPostRequestBody) GetProposedNewTime()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable) {
...
func (m *ItemCalendarCalendarViewItemTentativelyAcceptPostRequestBody) SetProposedNewTime(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable)() {
...
// ItemCalendarCalendarViewItemTentativelyAcceptPostRequestBodyable 
type ItemCalendarCalendarViewItemTentativelyAcceptPostRequestBodyable interface {

...
// ItemCalendarGroupsItemCalendarsItemCalendarViewItemAcceptPostRequestBody 
type ItemCalendarGroupsItemCalendarsItemCalendarViewItemAcceptPostRequestBody struct {
...
// NewItemCalendarGroupsItemCalendarsItemCalendarViewItemAcceptPostRequestBody instantiates a new ItemCalendarGroupsItemCalendarsItemCalendarViewItemAcceptPostRequestBody and sets the default values.
func NewItemCalendarGroupsItemCalendarsItemCalendarViewItemAcceptPostRequestBody()(*ItemCalendarGroupsItemCalendarsItemCalendarViewItemAcceptPostRequestBody) {
    m := &ItemCalendarGroupsItemCalendarsItemCalendarViewItemAcceptPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarGroupsItemCalendarsItemCalendarViewItemAcceptPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
// ItemCalendarGroupsItemCalendarsItemCalendarViewItemAcceptPostRequestBodyable 
type ItemCalendarGroupsItemCalendarsItemCalendarViewItemAcceptPostRequestBodyable interface {

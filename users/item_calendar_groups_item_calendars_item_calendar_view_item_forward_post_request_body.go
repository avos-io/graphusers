...
// ItemCalendarGroupsItemCalendarsItemCalendarViewItemForwardPostRequestBody 
type ItemCalendarGroupsItemCalendarsItemCalendarViewItemForwardPostRequestBody struct {
...
// NewItemCalendarGroupsItemCalendarsItemCalendarViewItemForwardPostRequestBody instantiates a new ItemCalendarGroupsItemCalendarsItemCalendarViewItemForwardPostRequestBody and sets the default values.
func NewItemCalendarGroupsItemCalendarsItemCalendarViewItemForwardPostRequestBody()(*ItemCalendarGroupsItemCalendarsItemCalendarViewItemForwardPostRequestBody) {
    m := &ItemCalendarGroupsItemCalendarsItemCalendarViewItemForwardPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarGroupsItemCalendarsItemCalendarViewItemForwardPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemCalendarGroupsItemCalendarsItemCalendarViewItemForwardPostRequestBody) GetToRecipients()([]i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Recipientable) {
...
func (m *ItemCalendarGroupsItemCalendarsItemCalendarViewItemForwardPostRequestBody) SetToRecipients(value []i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Recipientable)() {
    m.toRecipients = value
}
// ItemCalendarGroupsItemCalendarsItemCalendarViewItemForwardPostRequestBodyable 
type ItemCalendarGroupsItemCalendarsItemCalendarViewItemForwardPostRequestBodyable interface {

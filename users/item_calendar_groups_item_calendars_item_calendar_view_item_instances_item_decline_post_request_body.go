...
// ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBody 
type ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBody struct {
...
// NewItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBody instantiates a new ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBody and sets the default values.
func NewItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBody()(*ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBody) {
    m := &ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBody) GetProposedNewTime()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable) {
...
func (m *ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBody) SetProposedNewTime(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable)() {
...
// ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBodyable 
type ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBodyable interface {

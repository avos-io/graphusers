...
// ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody 
type ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody struct {
...
// NewItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody instantiates a new ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody and sets the default values.
func NewItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody()(*ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody) {
    m := &ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody) GetToRecipients()([]i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Recipientable) {
...
func (m *ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody) SetToRecipients(value []i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Recipientable)() {
    m.toRecipients = value
}
// ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBodyable 
type ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBodyable interface {

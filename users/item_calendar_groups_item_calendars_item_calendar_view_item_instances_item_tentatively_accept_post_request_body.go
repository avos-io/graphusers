...
// ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemTentativelyAcceptPostRequestBody 
type ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemTentativelyAcceptPostRequestBody struct {
...
// NewItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemTentativelyAcceptPostRequestBody instantiates a new ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemTentativelyAcceptPostRequestBody and sets the default values.
func NewItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemTentativelyAcceptPostRequestBody()(*ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemTentativelyAcceptPostRequestBody) {
    m := &ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemTentativelyAcceptPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemTentativelyAcceptPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemTentativelyAcceptPostRequestBody) GetProposedNewTime()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable) {
...
func (m *ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemTentativelyAcceptPostRequestBody) SetProposedNewTime(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable)() {
...
type ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemTentativelyAcceptPostRequestBodyable interface {

...
// ItemCalendarGroupsItemCalendarsItemCalendarViewItemTentativelyAcceptPostRequestBody 
type ItemCalendarGroupsItemCalendarsItemCalendarViewItemTentativelyAcceptPostRequestBody struct {
...
// NewItemCalendarGroupsItemCalendarsItemCalendarViewItemTentativelyAcceptPostRequestBody instantiates a new ItemCalendarGroupsItemCalendarsItemCalendarViewItemTentativelyAcceptPostRequestBody and sets the default values.
func NewItemCalendarGroupsItemCalendarsItemCalendarViewItemTentativelyAcceptPostRequestBody()(*ItemCalendarGroupsItemCalendarsItemCalendarViewItemTentativelyAcceptPostRequestBody) {
    m := &ItemCalendarGroupsItemCalendarsItemCalendarViewItemTentativelyAcceptPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarGroupsItemCalendarsItemCalendarViewItemTentativelyAcceptPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemCalendarGroupsItemCalendarsItemCalendarViewItemTentativelyAcceptPostRequestBody) GetProposedNewTime()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable) {
...
func (m *ItemCalendarGroupsItemCalendarsItemCalendarViewItemTentativelyAcceptPostRequestBody) SetProposedNewTime(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable)() {
...
type ItemCalendarGroupsItemCalendarsItemCalendarViewItemTentativelyAcceptPostRequestBodyable interface {

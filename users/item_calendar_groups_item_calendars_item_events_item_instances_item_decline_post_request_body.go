...
// ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBody 
type ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBody struct {
...
// NewItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBody instantiates a new ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBody and sets the default values.
func NewItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBody()(*ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBody) {
    m := &ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBody) GetProposedNewTime()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable) {
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBody) SetProposedNewTime(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable)() {
...
type ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBodyable interface {

...
// ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody 
type ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody struct {
...
// NewItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody instantiates a new ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody and sets the default values.
func NewItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody()(*ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody) {
    m := &ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody) GetProposedNewTime()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable) {
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody) SetProposedNewTime(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable)() {
...
// ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBodyable 
type ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBodyable interface {

...
// ItemCalendarsItemCalendarViewItemAcceptPostRequestBody 
type ItemCalendarsItemCalendarViewItemAcceptPostRequestBody struct {
...
// NewItemCalendarsItemCalendarViewItemAcceptPostRequestBody instantiates a new ItemCalendarsItemCalendarViewItemAcceptPostRequestBody and sets the default values.
func NewItemCalendarsItemCalendarViewItemAcceptPostRequestBody()(*ItemCalendarsItemCalendarViewItemAcceptPostRequestBody) {
    m := &ItemCalendarsItemCalendarViewItemAcceptPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarsItemCalendarViewItemAcceptPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
// ItemCalendarsItemCalendarViewItemAcceptPostRequestBodyable 
type ItemCalendarsItemCalendarViewItemAcceptPostRequestBodyable interface {

...
// ItemCalendarsItemCalendarViewItemDeclinePostRequestBody 
type ItemCalendarsItemCalendarViewItemDeclinePostRequestBody struct {
...
// NewItemCalendarsItemCalendarViewItemDeclinePostRequestBody instantiates a new ItemCalendarsItemCalendarViewItemDeclinePostRequestBody and sets the default values.
func NewItemCalendarsItemCalendarViewItemDeclinePostRequestBody()(*ItemCalendarsItemCalendarViewItemDeclinePostRequestBody) {
    m := &ItemCalendarsItemCalendarViewItemDeclinePostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarsItemCalendarViewItemDeclinePostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemCalendarsItemCalendarViewItemDeclinePostRequestBody) GetProposedNewTime()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable) {
...
func (m *ItemCalendarsItemCalendarViewItemDeclinePostRequestBody) SetProposedNewTime(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable)() {
...
// ItemCalendarsItemCalendarViewItemDeclinePostRequestBodyable 
type ItemCalendarsItemCalendarViewItemDeclinePostRequestBodyable interface {

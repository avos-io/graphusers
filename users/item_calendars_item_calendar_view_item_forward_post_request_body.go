...
// ItemCalendarsItemCalendarViewItemForwardPostRequestBody 
type ItemCalendarsItemCalendarViewItemForwardPostRequestBody struct {
...
// NewItemCalendarsItemCalendarViewItemForwardPostRequestBody instantiates a new ItemCalendarsItemCalendarViewItemForwardPostRequestBody and sets the default values.
func NewItemCalendarsItemCalendarViewItemForwardPostRequestBody()(*ItemCalendarsItemCalendarViewItemForwardPostRequestBody) {
    m := &ItemCalendarsItemCalendarViewItemForwardPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarsItemCalendarViewItemForwardPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemCalendarsItemCalendarViewItemForwardPostRequestBody) GetToRecipients()([]i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Recipientable) {
...
func (m *ItemCalendarsItemCalendarViewItemForwardPostRequestBody) SetToRecipients(value []i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Recipientable)() {
    m.toRecipients = value
}
// ItemCalendarsItemCalendarViewItemForwardPostRequestBodyable 
type ItemCalendarsItemCalendarViewItemForwardPostRequestBodyable interface {

...
// ItemCalendarsItemCalendarViewItemInstancesItemCancelPostRequestBody 
type ItemCalendarsItemCalendarViewItemInstancesItemCancelPostRequestBody struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]any
    // The Comment property
    comment *string
}
// NewItemCalendarsItemCalendarViewItemInstancesItemCancelPostRequestBody instantiates a new ItemCalendarsItemCalendarViewItemInstancesItemCancelPostRequestBody and sets the default values.
func NewItemCalendarsItemCalendarViewItemInstancesItemCancelPostRequestBody()(*ItemCalendarsItemCalendarViewItemInstancesItemCancelPostRequestBody) {
    m := &ItemCalendarsItemCalendarViewItemInstancesItemCancelPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarsItemCalendarViewItemInstancesItemCancelPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
type ItemCalendarsItemCalendarViewItemInstancesItemCancelPostRequestBodyable interface {

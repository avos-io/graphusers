...
// ItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody 
type ItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody struct {
...
// NewItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody instantiates a new ItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody and sets the default values.
func NewItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody()(*ItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody) {
    m := &ItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody) GetToRecipients()([]i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Recipientable) {
...
func (m *ItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBody) SetToRecipients(value []i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Recipientable)() {
    m.toRecipients = value
}
// ItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBodyable 
type ItemCalendarsItemCalendarViewItemInstancesItemForwardPostRequestBodyable interface {

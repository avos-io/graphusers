...
// ItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBody 
type ItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBody struct {
...
// NewItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBody instantiates a new ItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBody and sets the default values.
func NewItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBody()(*ItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBody) {
    m := &ItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBody) GetNewReminderTime()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.DateTimeTimeZoneable) {
...
func (m *ItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBody) SetNewReminderTime(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.DateTimeTimeZoneable)() {
    m.newReminderTime = value
}
// ItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBodyable 
type ItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBodyable interface {

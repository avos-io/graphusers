...
// ItemCalendarsItemEventsItemInstancesDeltaRequestBuilder provides operations to call the delta method.
...
type ItemCalendarsItemEventsItemInstancesDeltaRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemCalendarsItemEventsItemInstancesDeltaRequestBuilderGetQueryParameters
}
// NewItemCalendarsItemEventsItemInstancesDeltaRequestBuilderInternal instantiates a new DeltaRequestBuilder and sets the default values.
func NewItemCalendarsItemEventsItemInstancesDeltaRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarsItemEventsItemInstancesDeltaRequestBuilder) {
    m := &ItemCalendarsItemEventsItemInstancesDeltaRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
...
// NewItemCalendarsItemEventsItemInstancesDeltaRequestBuilder instantiates a new DeltaRequestBuilder and sets the default values.
func NewItemCalendarsItemEventsItemInstancesDeltaRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarsItemEventsItemInstancesDeltaRequestBuilder) {
...
func (m *ItemCalendarsItemEventsItemInstancesDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCalendarsItemEventsItemInstancesDeltaRequestBuilderGetRequestConfiguration)(ItemCalendarsItemEventsItemInstancesDeltaResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateItemCalendarsItemEventsItemInstancesDeltaResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {

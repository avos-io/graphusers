...
// ItemCalendarsItemEventsItemInstancesItemAcceptPostRequestBody 
type ItemCalendarsItemEventsItemInstancesItemAcceptPostRequestBody struct {
...
// NewItemCalendarsItemEventsItemInstancesItemAcceptPostRequestBody instantiates a new ItemCalendarsItemEventsItemInstancesItemAcceptPostRequestBody and sets the default values.
func NewItemCalendarsItemEventsItemInstancesItemAcceptPostRequestBody()(*ItemCalendarsItemEventsItemInstancesItemAcceptPostRequestBody) {
    m := &ItemCalendarsItemEventsItemInstancesItemAcceptPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarsItemEventsItemInstancesItemAcceptPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value

...
// NewItemChatsItemMembersAddPostRequestBody instantiates a new ItemChatsItemMembersAddPostRequestBody and sets the default values.
...
func (m *ItemChatsItemMembersAddPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemChatsItemMembersAddPostRequestBody) GetValues()([]i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ConversationMemberable) {
    return m.values
}
// Serialize serializes information the current object
func (m *ItemChatsItemMembersAddPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetValues() != nil {
...
func (m *ItemChatsItemMembersAddPostRequestBody) SetValues(value []i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ConversationMemberable)() {
    m.values = value
}
// ItemChatsItemMembersAddPostRequestBodyable 
type ItemChatsItemMembersAddPostRequestBodyable interface {

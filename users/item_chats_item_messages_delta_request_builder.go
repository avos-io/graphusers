...
// ItemChatsItemMessagesDeltaRequestBuilderGetQueryParameters invoke function delta
...
// NewItemChatsItemMessagesDeltaRequestBuilderInternal instantiates a new DeltaRequestBuilder and sets the default values.
func NewItemChatsItemMessagesDeltaRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemChatsItemMessagesDeltaRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
...
// NewItemChatsItemMessagesDeltaRequestBuilder instantiates a new DeltaRequestBuilder and sets the default values.
...
func (m *ItemChatsItemMessagesDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemChatsItemMessagesDeltaRequestBuilderGetRequestConfiguration)(ItemChatsItemMessagesDeltaResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateItemChatsItemMessagesDeltaResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {

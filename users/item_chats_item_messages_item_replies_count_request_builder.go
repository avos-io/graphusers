...
// ItemChatsItemMessagesItemRepliesCountRequestBuilder provides operations to count the resources in the collection.
type ItemChatsItemMessagesItemRepliesCountRequestBuilder struct {
...
// ItemChatsItemMessagesItemRepliesCountRequestBuilderGetQueryParameters get the number of the resource
type ItemChatsItemMessagesItemRepliesCountRequestBuilderGetQueryParameters struct {
    // Filter items by property values
    Filter *string `uriparametername:"%24filter"`
    // Search items by search phrases
    Search *string `uriparametername:"%24search"`
}
// ItemChatsItemMessagesItemRepliesCountRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemChatsItemMessagesItemRepliesCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
func NewItemChatsItemMessagesItemRepliesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemChatsItemMessagesItemRepliesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/$count{?%24search,%24filter}";

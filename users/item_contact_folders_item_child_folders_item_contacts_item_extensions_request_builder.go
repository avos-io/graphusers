...
// NewItemContactFoldersItemChildFoldersItemContactsItemExtensionsRequestBuilderInternal instantiates a new ExtensionsRequestBuilder and sets the default values.
func NewItemContactFoldersItemChildFoldersItemContactsItemExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemContactFoldersItemChildFoldersItemContactsItemExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/childFolders/{contactFolder%2Did1}/contacts/{contact%2Did}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemContactFoldersItemChildFoldersItemContactsItemExtensionsRequestBuilder instantiates a new ExtensionsRequestBuilder and sets the default values.
...
func (m *ItemContactFoldersItemChildFoldersItemContactsItemExtensionsRequestBuilder) Count()(*ItemContactFoldersItemChildFoldersItemContactsItemExtensionsCountRequestBuilder) {
    return NewItemContactFoldersItemChildFoldersItemContactsItemExtensionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemContactFoldersItemChildFoldersItemContactsItemExtensionsRequestBuilder) Post(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Extensionable, requestConfiguration *ItemContactFoldersItemChildFoldersItemContactsItemExtensionsRequestBuilderPostRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Extensionable, error) {
...
func (m *ItemContactFoldersItemChildFoldersItemContactsItemExtensionsRequestBuilder) ToPostRequestInformation(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Extensionable, requestConfiguration *ItemContactFoldersItemChildFoldersItemContactsItemExtensionsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters

...
func NewItemContactsItemPhotoValueContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemContactsItemPhotoValueContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/contacts/{contact%2Did}/photo/$value";
...
func (m *ItemContactsItemPhotoValueContentRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *ItemContactsItemPhotoValueContentRequestBuilderPutRequestConfiguration)(error) {

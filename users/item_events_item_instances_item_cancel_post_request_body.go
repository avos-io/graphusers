...
// ItemEventsItemInstancesItemCancelPostRequestBody 
type ItemEventsItemInstancesItemCancelPostRequestBody struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]any
    // The Comment property
    comment *string
}
// NewItemEventsItemInstancesItemCancelPostRequestBody instantiates a new ItemEventsItemInstancesItemCancelPostRequestBody and sets the default values.
func NewItemEventsItemInstancesItemCancelPostRequestBody()(*ItemEventsItemInstancesItemCancelPostRequestBody) {
    m := &ItemEventsItemInstancesItemCancelPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemEventsItemInstancesItemCancelPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
// ItemEventsItemInstancesItemCancelPostRequestBodyable 
type ItemEventsItemInstancesItemCancelPostRequestBodyable interface {

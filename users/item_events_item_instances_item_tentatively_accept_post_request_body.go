...
// ItemEventsItemInstancesItemTentativelyAcceptPostRequestBody 
type ItemEventsItemInstancesItemTentativelyAcceptPostRequestBody struct {
...
// NewItemEventsItemInstancesItemTentativelyAcceptPostRequestBody instantiates a new ItemEventsItemInstancesItemTentativelyAcceptPostRequestBody and sets the default values.
func NewItemEventsItemInstancesItemTentativelyAcceptPostRequestBody()(*ItemEventsItemInstancesItemTentativelyAcceptPostRequestBody) {
    m := &ItemEventsItemInstancesItemTentativelyAcceptPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemEventsItemInstancesItemTentativelyAcceptPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemEventsItemInstancesItemTentativelyAcceptPostRequestBody) GetProposedNewTime()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable) {
...
func (m *ItemEventsItemInstancesItemTentativelyAcceptPostRequestBody) SetProposedNewTime(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TimeSlotable)() {
...
type ItemEventsItemInstancesItemTentativelyAcceptPostRequestBodyable interface {

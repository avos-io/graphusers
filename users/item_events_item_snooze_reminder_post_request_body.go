...
// ItemEventsItemSnoozeReminderPostRequestBody 
type ItemEventsItemSnoozeReminderPostRequestBody struct {
...
// NewItemEventsItemSnoozeReminderPostRequestBody instantiates a new ItemEventsItemSnoozeReminderPostRequestBody and sets the default values.
func NewItemEventsItemSnoozeReminderPostRequestBody()(*ItemEventsItemSnoozeReminderPostRequestBody) {
    m := &ItemEventsItemSnoozeReminderPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemEventsItemSnoozeReminderPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemEventsItemSnoozeReminderPostRequestBody) GetNewReminderTime()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.DateTimeTimeZoneable) {
...
func (m *ItemEventsItemSnoozeReminderPostRequestBody) SetNewReminderTime(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.DateTimeTimeZoneable)() {
    m.newReminderTime = value
}
// ItemEventsItemSnoozeReminderPostRequestBodyable 
type ItemEventsItemSnoozeReminderPostRequestBodyable interface {

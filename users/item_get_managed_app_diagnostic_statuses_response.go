...
type ItemGetManagedAppDiagnosticStatusesResponse struct {
    ...
    // The value property
    value []i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ManagedAppDiagnosticStatusable
}
...
func (m *ItemGetManagedAppDiagnosticStatusesResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["value"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.CreateManagedAppDiagnosticStatusFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ManagedAppDiagnosticStatusable, len(val))
            for i, v := range val {
                res[i] = v.(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ManagedAppDiagnosticStatusable)
            }
            m.SetValue(res)
        }
        return nil
...
func (m *ItemGetManagedAppDiagnosticStatusesResponse) GetValue()([]i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ManagedAppDiagnosticStatusable) {
    return m.value
}
...
func (m *ItemGetManagedAppDiagnosticStatusesResponse) SetValue(value []i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ManagedAppDiagnosticStatusable)() {
    m.value = value
}
...
type ItemGetManagedAppDiagnosticStatusesResponseable interface {
    ...
    GetValue()([]i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ManagedAppDiagnosticStatusable)
    SetValue(value []i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ManagedAppDiagnosticStatusable)()
}

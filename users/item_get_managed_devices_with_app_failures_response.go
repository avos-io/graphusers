...
func (m *ItemGetManagedDevicesWithAppFailuresResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemGetManagedDevicesWithAppFailuresResponse) GetValue()([]string) {
    return m.value
}
// Serialize serializes information the current object
func (m *ItemGetManagedDevicesWithAppFailuresResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *ItemGetManagedDevicesWithAppFailuresResponse) SetValue(value []string)() {
    m.value = value
}

...
// ItemInferenceClassificationOverridesCountRequestBuilder provides operations to count the resources in the collection.
type ItemInferenceClassificationOverridesCountRequestBuilder struct {
...
// ItemInferenceClassificationOverridesCountRequestBuilderGetQueryParameters get the number of the resource
...
func NewItemInferenceClassificationOverridesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInferenceClassificationOverridesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/inferenceClassification/overrides/$count{?%24filter}";
...
func NewItemInferenceClassificationOverridesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInferenceClassificationOverridesCountRequestBuilder) {
    ...
    return NewItemInferenceClassificationOverridesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemInferenceClassificationOverridesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemInferenceClassificationOverridesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemInferenceClassificationOverridesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemInferenceClassificationOverridesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {

...
func NewItemInsightsTrendingItemResourceRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInsightsTrendingItemResourceRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/insights/trending/{trending%2Did}/resource{?%24select,%24expand}";
...
func (m *ItemInsightsTrendingItemResourceRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemInsightsTrendingItemResourceRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Entityable, error) {

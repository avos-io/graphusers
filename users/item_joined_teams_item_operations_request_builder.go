...
func NewItemJoinedTeamsItemOperationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemJoinedTeamsItemOperationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemJoinedTeamsItemOperationsRequestBuilder instantiates a new OperationsRequestBuilder and sets the default values.
...
func (m *ItemJoinedTeamsItemOperationsRequestBuilder) Count()(*ItemJoinedTeamsItemOperationsCountRequestBuilder) {
    return NewItemJoinedTeamsItemOperationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get the async operations that ran or are running on this team.
func (m *ItemJoinedTeamsItemOperationsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemOperationsRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TeamsAsyncOperationCollectionResponseable, error) {
...
func (m *ItemJoinedTeamsItemOperationsRequestBuilder) Post(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TeamsAsyncOperationable, requestConfiguration *ItemJoinedTeamsItemOperationsRequestBuilderPostRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TeamsAsyncOperationable, error) {
...
func (m *ItemJoinedTeamsItemOperationsRequestBuilder) ToPostRequestInformation(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TeamsAsyncOperationable, requestConfiguration *ItemJoinedTeamsItemOperationsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters

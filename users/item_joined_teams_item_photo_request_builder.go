...
// ItemJoinedTeamsItemPhotoRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemJoinedTeamsItemPhotoRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
// NewItemJoinedTeamsItemPhotoRequestBuilderInternal instantiates a new PhotoRequestBuilder and sets the default values.
func NewItemJoinedTeamsItemPhotoRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemJoinedTeamsItemPhotoRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/photo{?%24select,%24expand}";
...
// NewItemJoinedTeamsItemPhotoRequestBuilder instantiates a new PhotoRequestBuilder and sets the default values.
...
func (m *ItemJoinedTeamsItemPhotoRequestBuilder) Content()(*ItemJoinedTeamsItemPhotoValueContentRequestBuilder) {
    return NewItemJoinedTeamsItemPhotoValueContentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Delete delete navigation property photo for users
func (m *ItemJoinedTeamsItemPhotoRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemPhotoRequestBuilderDeleteRequestConfiguration)(error) {
...
func (m *ItemJoinedTeamsItemPhotoRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemPhotoRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ProfilePhotoable, error) {
...
// ToDeleteRequestInformation delete navigation property photo for users
func (m *ItemJoinedTeamsItemPhotoRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemPhotoRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {

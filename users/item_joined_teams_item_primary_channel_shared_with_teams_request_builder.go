...
// ItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilderGetQueryParameters get the list of teams that has been shared a specified channel. This operation is allowed only for channels with a **membershipType** value of `shared`.
...
func NewItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilder) Count()(*ItemJoinedTeamsItemPrimaryChannelSharedWithTeamsCountRequestBuilder) {
    return NewItemJoinedTeamsItemPrimaryChannelSharedWithTeamsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilder) Post(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.SharedWithChannelTeamInfoable, requestConfiguration *ItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilderPostRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.SharedWithChannelTeamInfoable, error) {

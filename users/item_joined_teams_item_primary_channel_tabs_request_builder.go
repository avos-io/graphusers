...
// ItemJoinedTeamsItemPrimaryChannelTabsRequestBuilderGetQueryParameters retrieve the list of tabs in the specified channel within a team. 
...
// NewItemJoinedTeamsItemPrimaryChannelTabsRequestBuilderInternal instantiates a new TabsRequestBuilder and sets the default values.
func NewItemJoinedTeamsItemPrimaryChannelTabsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemJoinedTeamsItemPrimaryChannelTabsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/tabs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemJoinedTeamsItemPrimaryChannelTabsRequestBuilder instantiates a new TabsRequestBuilder and sets the default values.
...
func (m *ItemJoinedTeamsItemPrimaryChannelTabsRequestBuilder) Count()(*ItemJoinedTeamsItemPrimaryChannelTabsCountRequestBuilder) {
    return NewItemJoinedTeamsItemPrimaryChannelTabsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemJoinedTeamsItemPrimaryChannelTabsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemPrimaryChannelTabsRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TeamsTabCollectionResponseable, error) {

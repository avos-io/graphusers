...
// NewItemJoinedTeamsItemScheduleSchedulingGroupsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemJoinedTeamsItemScheduleSchedulingGroupsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemJoinedTeamsItemScheduleSchedulingGroupsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/schedulingGroups/$count{?%24search,%24filter}";
...
// NewItemJoinedTeamsItemScheduleSchedulingGroupsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.

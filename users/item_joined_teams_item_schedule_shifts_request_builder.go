...
func NewItemJoinedTeamsItemScheduleShiftsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemJoinedTeamsItemScheduleShiftsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/shifts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}";
...
func (m *ItemJoinedTeamsItemScheduleShiftsRequestBuilder) Count()(*ItemJoinedTeamsItemScheduleShiftsCountRequestBuilder) {
    return NewItemJoinedTeamsItemScheduleShiftsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemJoinedTeamsItemScheduleShiftsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemScheduleShiftsRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ShiftCollectionResponseable, error) {

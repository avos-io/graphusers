...
// NewItemJoinedTeamsItemTagsTeamworkTagItemRequestBuilderInternal instantiates a new TeamworkTagItemRequestBuilder and sets the default values.
...
// NewItemJoinedTeamsItemTagsTeamworkTagItemRequestBuilder instantiates a new TeamworkTagItemRequestBuilder and sets the default values.
...
func (m *ItemJoinedTeamsItemTagsTeamworkTagItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemTagsTeamworkTagItemRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TeamworkTagable, error) {
...
func (m *ItemJoinedTeamsItemTagsTeamworkTagItemRequestBuilder) Members()(*ItemJoinedTeamsItemTagsItemMembersRequestBuilder) {
    return NewItemJoinedTeamsItemTagsItemMembersRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MembersById provides operations to manage the members property of the microsoft.graph.teamworkTag entity.
func (m *ItemJoinedTeamsItemTagsTeamworkTagItemRequestBuilder) MembersById(id string)(*ItemJoinedTeamsItemTagsItemMembersTeamworkTagMemberItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return NewItemJoinedTeamsItemTagsItemMembersTeamworkTagMemberItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
// Patch update the navigation property tags in users
func (m *ItemJoinedTeamsItemTagsTeamworkTagItemRequestBuilder) Patch(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TeamworkTagable, requestConfiguration *ItemJoinedTeamsItemTagsTeamworkTagItemRequestBuilderPatchRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TeamworkTagable, error) {
...
func (m *ItemJoinedTeamsItemTagsTeamworkTagItemRequestBuilder) ToPatchRequestInformation(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.TeamworkTagable, requestConfiguration *ItemJoinedTeamsItemTagsTeamworkTagItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters

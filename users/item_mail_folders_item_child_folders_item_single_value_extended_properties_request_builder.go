...
// ItemMailFoldersItemChildFoldersItemSingleValueExtendedPropertiesRequestBuilder provides operations to manage the singleValueExtendedProperties property of the microsoft.graph.mailFolder entity.
...
func NewItemMailFoldersItemChildFoldersItemSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMailFoldersItemChildFoldersItemSingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ItemMailFoldersItemChildFoldersItemSingleValueExtendedPropertiesRequestBuilder) Count()(*ItemMailFoldersItemChildFoldersItemSingleValueExtendedPropertiesCountRequestBuilder) {
    return NewItemMailFoldersItemChildFoldersItemSingleValueExtendedPropertiesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemMailFoldersItemChildFoldersItemSingleValueExtendedPropertiesRequestBuilder) Post(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.SingleValueLegacyExtendedPropertyable, requestConfiguration *ItemMailFoldersItemChildFoldersItemSingleValueExtendedPropertiesRequestBuilderPostRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.SingleValueLegacyExtendedPropertyable, error) {

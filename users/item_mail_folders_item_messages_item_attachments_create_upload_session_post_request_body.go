...
// ItemMailFoldersItemMessagesItemAttachmentsCreateUploadSessionPostRequestBody 
type ItemMailFoldersItemMessagesItemAttachmentsCreateUploadSessionPostRequestBody struct {
...
// NewItemMailFoldersItemMessagesItemAttachmentsCreateUploadSessionPostRequestBody instantiates a new ItemMailFoldersItemMessagesItemAttachmentsCreateUploadSessionPostRequestBody and sets the default values.
func NewItemMailFoldersItemMessagesItemAttachmentsCreateUploadSessionPostRequestBody()(*ItemMailFoldersItemMessagesItemAttachmentsCreateUploadSessionPostRequestBody) {
    m := &ItemMailFoldersItemMessagesItemAttachmentsCreateUploadSessionPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemMailFoldersItemMessagesItemAttachmentsCreateUploadSessionPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemMailFoldersItemMessagesItemAttachmentsCreateUploadSessionPostRequestBody) GetAttachmentItem()(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.AttachmentItemable) {
...
func (m *ItemMailFoldersItemMessagesItemAttachmentsCreateUploadSessionPostRequestBody) SetAttachmentItem(value i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.AttachmentItemable)() {
    m.attachmentItem = value
}
// ItemMailFoldersItemMessagesItemAttachmentsCreateUploadSessionPostRequestBodyable 
type ItemMailFoldersItemMessagesItemAttachmentsCreateUploadSessionPostRequestBodyable interface {

...
// ItemMailFoldersItemMessagesItemMultiValueExtendedPropertiesRequestBuilder provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.message entity.
...
func (m *ItemMailFoldersItemMessagesItemMultiValueExtendedPropertiesRequestBuilder) Count()(*ItemMailFoldersItemMessagesItemMultiValueExtendedPropertiesCountRequestBuilder) {
    return NewItemMailFoldersItemMessagesItemMultiValueExtendedPropertiesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get the collection of multi-value extended properties defined for the message. Nullable.
func (m *ItemMailFoldersItemMessagesItemMultiValueExtendedPropertiesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMailFoldersItemMessagesItemMultiValueExtendedPropertiesRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.MultiValueLegacyExtendedPropertyCollectionResponseable, error) {

...
// ItemMailFoldersItemSingleValueExtendedPropertiesRequestBuilder provides operations to manage the singleValueExtendedProperties property of the microsoft.graph.mailFolder entity.
...
func (m *ItemMailFoldersItemSingleValueExtendedPropertiesRequestBuilder) Count()(*ItemMailFoldersItemSingleValueExtendedPropertiesCountRequestBuilder) {
    return NewItemMailFoldersItemSingleValueExtendedPropertiesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get the collection of single-value extended properties defined for the mailFolder. Read-only. Nullable.
func (m *ItemMailFoldersItemSingleValueExtendedPropertiesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMailFoldersItemSingleValueExtendedPropertiesRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.SingleValueLegacyExtendedPropertyCollectionResponseable, error) {
...
func (m *ItemMailFoldersItemSingleValueExtendedPropertiesRequestBuilder) Post(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.SingleValueLegacyExtendedPropertyable, requestConfiguration *ItemMailFoldersItemSingleValueExtendedPropertiesRequestBuilderPostRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.SingleValueLegacyExtendedPropertyable, error) {

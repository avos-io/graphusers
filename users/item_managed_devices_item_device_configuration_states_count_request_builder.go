...
// NewItemManagedDevicesItemDeviceConfigurationStatesCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemManagedDevicesItemDeviceConfigurationStatesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemManagedDevicesItemDeviceConfigurationStatesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceConfigurationStates/$count{?%24search,%24filter}";
...
// NewItemManagedDevicesItemDeviceConfigurationStatesCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.

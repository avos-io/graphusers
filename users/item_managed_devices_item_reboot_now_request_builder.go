...
// NewItemManagedDevicesItemRebootNowRequestBuilderInternal instantiates a new RebootNowRequestBuilder and sets the default values.
func NewItemManagedDevicesItemRebootNowRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemManagedDevicesItemRebootNowRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/rebootNow";
...
// NewItemManagedDevicesItemRebootNowRequestBuilder instantiates a new RebootNowRequestBuilder and sets the default values.

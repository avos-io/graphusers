...
// ItemManagedDevicesItemRetireRequestBuilder provides operations to call the retire method.
type ItemManagedDevicesItemRetireRequestBuilder struct {
...
// ItemManagedDevicesItemRetireRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemManagedDevicesItemRetireRequestBuilderPostRequestConfiguration struct {
    // Request headers
...
func NewItemManagedDevicesItemRetireRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemManagedDevicesItemRetireRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/retire";

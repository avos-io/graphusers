...
// NewItemManagedDevicesItemWipeRequestBuilderInternal instantiates a new WipeRequestBuilder and sets the default values.
func NewItemManagedDevicesItemWipeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemManagedDevicesItemWipeRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/wipe";
...
// NewItemManagedDevicesItemWipeRequestBuilder instantiates a new WipeRequestBuilder and sets the default values.

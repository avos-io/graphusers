...
func NewItemMemberOfGraphGroupCountRequestBuilderInternal(
	pathParameters map[string]string,
	requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter,
) *ItemMemberOfGraphGroupCountRequestBuilder {
	m := &ItemMemberOfGraphGroupCountRequestBuilder{}
	m.urlTemplate = "{+baseurl}/users/{user%2Did}/memberOf/graph.group/$count{?%24search,%24filter}"
...
func NewItemMemberOfGraphGroupCountRequestBuilder(
	rawUrl string,
	requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter,
) *ItemMemberOfGraphGroupCountRequestBuilder {
...
func (m *ItemMemberOfGraphGroupCountRequestBuilder) Get(
	ctx context.Context,
	requestConfiguration *ItemMemberOfGraphGroupCountRequestBuilderGetRequestConfiguration,
) (*int32, error) {
...
func (m *ItemMemberOfGraphGroupCountRequestBuilder) ToGetRequestInformation(
	ctx context.Context,
	requestConfiguration *ItemMemberOfGraphGroupCountRequestBuilderGetRequestConfiguration,

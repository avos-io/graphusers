...
// NewItemMessagesItemExtensionsRequestBuilder instantiates a new ExtensionsRequestBuilder and sets the default values.
...
func (m *ItemMessagesItemExtensionsRequestBuilder) Count()(*ItemMessagesItemExtensionsCountRequestBuilder) {
    return NewItemMessagesItemExtensionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get the collection of open extensions defined for the message. Nullable.
func (m *ItemMessagesItemExtensionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMessagesItemExtensionsRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ExtensionCollectionResponseable, error) {

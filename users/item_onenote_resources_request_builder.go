...
// ItemOnenoteResourcesRequestBuilderGetQueryParameters the image and other file resources in OneNote pages. Getting a resources collection is not supported, but you can get the binary content of a specific resource. Read-only. Nullable.
...
func NewItemOnenoteResourcesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnenoteResourcesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/onenote/resources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemOnenoteResourcesRequestBuilder instantiates a new ResourcesRequestBuilder and sets the default values.
...
func (m *ItemOnenoteResourcesRequestBuilder) Count()(*ItemOnenoteResourcesCountRequestBuilder) {
    return NewItemOnenoteResourcesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemOnenoteResourcesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOnenoteResourcesRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.OnenoteResourceCollectionResponseable, error) {
...
// Post create new navigation property to resources for users
func (m *ItemOnenoteResourcesRequestBuilder) Post(ctx context.Context, body i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.OnenoteResourceable, requestConfiguration *ItemOnenoteResourcesRequestBuilderPostRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.OnenoteResourceable, error) {
...
// ToPostRequestInformation create new navigation property to resources for users

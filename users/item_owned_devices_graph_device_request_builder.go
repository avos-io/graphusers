...
func NewItemOwnedDevicesGraphDeviceRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedDevicesGraphDeviceRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/ownedDevices/graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ItemOwnedDevicesGraphDeviceRequestBuilder) Count()(*ItemOwnedDevicesGraphDeviceCountRequestBuilder) {
    return NewItemOwnedDevicesGraphDeviceCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get get the items of type microsoft.graph.device in the microsoft.graph.directoryObject collection
func (m *ItemOwnedDevicesGraphDeviceRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnedDevicesGraphDeviceRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.DeviceCollectionResponseable, error) {

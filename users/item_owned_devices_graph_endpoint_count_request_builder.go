...
// NewItemOwnedDevicesGraphEndpointCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemOwnedDevicesGraphEndpointCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedDevicesGraphEndpointCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/ownedDevices/graph.endpoint/$count{?%24search,%24filter}";
...
// NewItemOwnedDevicesGraphEndpointCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.

...
func NewItemOwnedDevicesGraphEndpointRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedDevicesGraphEndpointRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/ownedDevices/graph.endpoint{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ItemOwnedDevicesGraphEndpointRequestBuilder) Count()(*ItemOwnedDevicesGraphEndpointCountRequestBuilder) {
    return NewItemOwnedDevicesGraphEndpointCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get get the items of type microsoft.graph.endpoint in the microsoft.graph.directoryObject collection
func (m *ItemOwnedDevicesGraphEndpointRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnedDevicesGraphEndpointRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.EndpointCollectionResponseable, error) {

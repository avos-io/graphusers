...
func NewItemOwnedObjectsItemGraphServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedObjectsItemGraphServicePrincipalRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/ownedObjects/{directoryObject%2Did}/graph.servicePrincipal{?%24select,%24expand}";
...
func (m *ItemOwnedObjectsItemGraphServicePrincipalRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnedObjectsItemGraphServicePrincipalRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.ServicePrincipalable, error) {

...
// NewItemPlannerPlansItemTasksRequestBuilderInternal instantiates a new TasksRequestBuilder and sets the default values.
func NewItemPlannerPlansItemTasksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPlannerPlansItemTasksRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemPlannerPlansItemTasksRequestBuilder instantiates a new TasksRequestBuilder and sets the default values.
...
func (m *ItemPlannerPlansItemTasksRequestBuilder) Count()(*ItemPlannerPlansItemTasksCountRequestBuilder) {
    return NewItemPlannerPlansItemTasksCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get retrieve a list of plannerTask objects associated with a plannerPlan object.
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/plannerplan-list-tasks?view=graph-rest-1.0
func (m *ItemPlannerPlansItemTasksRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemPlannerPlansItemTasksRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.PlannerTaskCollectionResponseable, error) {

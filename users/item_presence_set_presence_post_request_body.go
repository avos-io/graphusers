...
// NewItemPresenceSetPresencePostRequestBody instantiates a new ItemPresenceSetPresencePostRequestBody and sets the default values.
func NewItemPresenceSetPresencePostRequestBody()(*ItemPresenceSetPresencePostRequestBody) {
    m := &ItemPresenceSetPresencePostRequestBody{
    }
...
func (m *ItemPresenceSetPresencePostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemPresenceSetPresencePostRequestBody) SetActivity(value *string)() {
    m.activity = value
}
...
func (m *ItemPresenceSetPresencePostRequestBody) SetAvailability(value *string)() {
    m.availability = value
}
// SetExpirationDuration sets the expirationDuration property value. The expirationDuration property
func (m *ItemPresenceSetPresencePostRequestBody) SetExpirationDuration(value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration)() {
    m.expirationDuration = value
}
// SetSessionId sets the sessionId property value. The sessionId property
func (m *ItemPresenceSetPresencePostRequestBody) SetSessionId(value *string)() {
    m.sessionId = value
}

...
// NewItemTeamworkSendActivityNotificationRequestBuilderInternal instantiates a new SendActivityNotificationRequestBuilder and sets the default values.
func NewItemTeamworkSendActivityNotificationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamworkSendActivityNotificationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/teamwork/sendActivityNotification";
...
// NewItemTeamworkSendActivityNotificationRequestBuilder instantiates a new SendActivityNotificationRequestBuilder and sets the default values.

...
// NewItemTodoListsDeltaRequestBuilderInternal instantiates a new DeltaRequestBuilder and sets the default values.
func NewItemTodoListsDeltaRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTodoListsDeltaRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/todo/lists/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
...
// NewItemTodoListsDeltaRequestBuilder instantiates a new DeltaRequestBuilder and sets the default values.
...
func (m *ItemTodoListsDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTodoListsDeltaRequestBuilderGetRequestConfiguration)(ItemTodoListsDeltaResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateItemTodoListsDeltaResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {

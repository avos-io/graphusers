...
// NewItemTodoRequestBuilderInternal instantiates a new TodoRequestBuilder and sets the default values.
...
// NewItemTodoRequestBuilder instantiates a new TodoRequestBuilder and sets the default values.
...
func (m *ItemTodoRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTodoRequestBuilderGetRequestConfiguration)(i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.Todoable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, i43734bed85aefb0f6a3d313be76230963d1e26491f666899a105a0936ec1d390.CreateTodoFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
